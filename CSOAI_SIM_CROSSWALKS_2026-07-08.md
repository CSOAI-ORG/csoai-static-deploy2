...
- **Need themes (per-dossier freq):** audit 572, compliance 554, governance 481, privacy 480,
  transparency 456, risk 444. These five ARE the product surface the market asks for.

## DATA-SUPPORTED — new crosswalk candidates (charter ↔ framework, by dossier support)
- `05-accountabilityof` ↔ **iso-42001**  (supported by 109 leads)
- `05-accountabilityof` ↔ **iso-42001 / nist-ai-rmf**  (supported by 105 leads)
- `05-accountabilityof` ↔ **nist-ai-rmf**  (supported by 98 leads)
- `09-dataprivacyof` ↔ **eu-ai-act Art.13**  (supported by 87 leads)
- `09-dataprivacyof` ↔ **gdpr**  (supported by 87 leads)
- `38-sovereignstandards` ↔ **iso-42001**  (supported by 82 leads)
- `09-dataprivacyof` ↔ **iso-42001 / nist-ai-rmf**  (supported by 82 leads)
- `08-biasdetectionof` ↔ **iso-42001 / nist-ai-rmf**  (supported by 73 leads)
- `10-asisecurity` ↔ **iso-42001 / nist-ai-rmf**  (supported by 67 leads)
- `08-biasdetectionof` ↔ **gdpr**  (supported by 66 leads)
- `10-asisecurity` ↔ **nist-ai-rmf**  (supported by 62 leads)
- `10-asisecurity` ↔ **iso-42001**  (supported by 61 leads)
- `08-biasdetectionof` ↔ **nist-ai-rmf**  (supported by 61 leads)
- `04-safetyof` ↔ **iso-42001**  (supported by 52 leads)
- `04-safetyof` ↔ **iso-42001 / nist-ai-rmf**  (supported by 52 leads)
...
## CHARTER-IMPROVEMENT NOTES
1. **Consolidate/retire zero-demand charters** or fold them under the top 5 (accountability,
   data-privacy, asi-security, bias-detection, safety) that absorb 64% of demand (422/655 matched leads).
2. **Add explicit framework crosswalks** to the top-5 charters for iso-42001, nist-ai-rmf, gdpr,
