#!/usr/bin/env python3
"""Tick 257 generator: 3 UK regulator/agency deep-dive packs (ORR econ / Ofwat / CAA consumer).

Replicates the tick-255/256 pack format exactly: inline CSS, 12 entry points,
...
PACKS = [
    dict(
        slug="defoneos-orr-office-rail-road-economic-regulation-ai-deep-dive-pack",
        title="Office of Rail & Road Economic Regulation AI Deep-Dive Pack",
        reg="Office of Rail and Road",
        sub_domain="ORR economic regulation of rail access charges, network outputs and franchising",
        laws=("Railways Act 1993 / Office of Rail and Road regulations / "
              "Competition Act 1998 / Enterprise Act 2002"),
        law_primary="Railways Act 1993",
        entry_points=[
            "Track Access Charge Setting",
            "Network Output Specification",
            "Periodic Review & Price Control",
            "Franchise & Concession Oversight",
            "Railway Undertaking Economic Licensing",
            "Network Rail Monitoring & Enforcement",
            "Access Agreement Approval",
            "Competition & Market Structure Oversight",
            "Efficiency & Cost Benchmarking",
            "Consumer & Passenger Protection",
            "Investment & Capacity Planning",
            "Governance & Parliamentary Accountability",
        ],
        ts="2026-08-11T03:10:00+00:00",
    ),
    dict(
        slug="defoneos-ofwat-water-services-regulation-authority-ai-deep-dive-pack",
        title="Water Services Regulation Authority Price Review AI Deep-Dive Pack",
        reg="Ofwat (Water Services Regulation Authority)",
        sub_domain="Ofwat economic regulation of water and sewerage companies, price reviews and consumer protection",
        laws=("Water Industry Act 1991 / Water Act 2014 / "
              "Competition Act 1998 / Flood and Water Management Act 2010"),
        law_primary="Water Industry Act 1991",
        entry_points=[
            "Price Review & Price Control Setting",
            "Water & Sewerage Company Licence Regulation",
            "Outcome Delivery Incentives",
            "Cost Assessment & Efficiency Benchmarking",
            "Service Delivery & Leakage Reporting",
            "Capital Investment & Asset Management",
            "Affordability & Social Tariff Oversight",
            "Customer & Retail Market Oversight",
            "Environmental Performance Monitoring",
            "Competition & Market Reform",
            "Financial Resilience & Gearing Oversight",
            "Governance & Parliamentary Accountability",
        ],
        ts="2026-08-11T03:10:00+00:00",
    ),
    dict(
        slug="defoneos-caa-civil-aviation-consumer-protection-ai-deep-dive-pack",
        title="Civil Aviation Authority Consumer Protection AI Deep-Dive Pack",
        reg="Civil Aviation Authority",
        sub_domain="CAA consumer protection, ATOL licensing, passenger rights and aviation regulation",
        laws=("Civil Aviation Act 1982 / ATOL Regulations 2012 / "
              "Air Navigation Order 2016 / Consumer Rights Act 2015"),
        law_primary="Civil Aviation Act 1982",
        entry_points=[
            "ATOL Licence Administration",
            "Holiday & Package Travel Protection",
            "Passenger Rights & Repatriation",
            "Airline Financial Failure Response",
            "Denied Boarding & Delay Compensation",
            "Consumer Complaint Handling",
            "Aviation Safety & Airworthiness Oversight",
            "Air Operator Certification",
            "Drone & Unmanned Aircraft Regulation",
            "Airspace & Aerodrome Licensing",
