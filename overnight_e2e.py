...
PLAN = {
    ...
    "steps": [
        ...
        },
        {
            ...
            "expected_pass_regex": r"RECALL\s*:\s*1\.000\s*\(49/49",
        ...
        },
        {
            ...
            "expected_pass_regex": r"headline:\s+0 of 20 assets survived",
        ...
        },
        {
            ...
            "expected_pass_regex": r"alg_agility\s+8/8",
