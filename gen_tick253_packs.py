#!/usr/bin/env python3
"""Tick 253 generator: 3 UK regulator deep-dive packs (DVSA / IPSO / Electoral Commission).

Replicates the tick-252 pack format exactly: inline CSS, 12 entry points,
...
PACKS = [
    dict(
        slug="defoneos-dvsa-driver-vehicle-standards-agency-ai-deep-dive-pack",
        title="Driver & Vehicle Standards Agency Road Safety Regulation AI Deep-Dive Pack",
        reg="Driver & Vehicle Standards Agency",
        sub_domain="Driver & Vehicle Standards Agency road safety regulation",
        laws=("Road Traffic Act 1988 / Road Traffic Offenders Act 1988 / "
              "Road Safety Act 2006 / Motor Vehicles (Approval) Regulations 2020"),
        law_primary="Road Traffic Act 1988",
        entry_points=[
            "Driving Test & Examiner Standards",
            "Driver & Rider Training Regulation",
            "Licence Acquisition & Fitness to Drive",
            "Vehicle Testing (MOT) Oversight",
            "Heavy Goods Vehicle Enforcement",
            "Bus & Coach Safety Regulation",
            "Roadworthiness Standards & Defects",
            "Operator Licence & Compliance Oversight",
            "Enforcement, Examinations & Prosecutions",
            "Digital Services & Data Standards",
    ...
    dict(
        slug="defoneos-ipso-independent-press-standards-organisation-ai-deep-dive-pack",
        title="Independent Press Standards Organisation Press Regulation AI Deep-Dive Pack",
        reg="Independent Press Standards Organisation",
        sub_domain="Independent Press Standards Organisation press regulation",
        laws=("Editors' Code of Practice / Data Protection Act 2018 / "
              "Defamation Act 2013 / Privacy and Electronic Communications Regulations 2003"),
        law_primary="Editors' Code of Practice",
        entry_points=[
            "Editors' Code of Practice Oversight",
            "Complaints Investigation & Adjudication",
            "Accuracy & Corrections Regulation",
            "Privacy & Intrusion Standards",
            "Harassment & Intrusion into Grief",
            "Children & Vulnerable Persons Protection",
            "Discrimination & Reporting Standards",
            "Financial Journalism Standards",
            "Public Interest & Exceptions",
            "Sanctions, Rulings & Remedies",
            "Standards & Regulatory Outreach",
            "Governance & Public Accountability",
        ],
        ts="2026-08-10T16:00:00+00:00",
    ),
    dict(
        slug="defoneos-electoral-commission-election-integrity-ai-deep-dive-pack",
        title="Electoral Commission Election Integrity AI Deep-Dive Pack",
        reg="Electoral Commission",
        sub_domain="Electoral Commission election integrity",
        laws=("Political Parties, Elections and Referendums Act 2000 / "
              "Representation of the People Act 1983 / Elections Act 2022 / "
              "Electoral Registration and Administration Act 2013"),
        law_primary="Political Parties, Elections and Referendums Act 2000",
        entry_points=[
            "Party Registration & Political Finance",
            "Election Spending Limits & Oversight",
            "Donations & Loans Regulation",
            "Electoral Registration Standards",
            "Polling & Voting Administration",
            "Candidate & Agent Compliance",
            "Referendum Regulation & Rules",
            "Digital Campaigning & Imprint Rules",
            "Investigations & Sanctions",
            "Accessibility & Voter Participation",
            "Data & Electoral Integrity",
            "Governance & Parliamentary Accountability",
        ],
        ts="2026-08-10T16:00:00+00:00",
    ),
