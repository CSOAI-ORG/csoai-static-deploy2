---
license: apache-2.0
pretty_name: PQCBench — post-quantum migration (continuity axis, GSPC)
language:
  - en
tags:
  - benchmark
...
# PQCBench — the continuity axis of GSPC

> **post-quantum migration**, scored against frozen, corpus-anchored ground truth. **n = 13 items.**
...
Total **13**. Labels: `NOT_APPLICABLE`, `QUANTUM_SAFE`, `QUANTUM_VULNERABLE`
...
|---|---:|---|
| mean difficulty | 0.321 | fraction of models answering an item correctly |
| spread (max−min) | 0.350 | how far this axis separates the best model from the worst |
| dead items | 2 / 13 | passed by every model or none — zero information |
| negative discrimination | 5 | better-overall models do worse — routed to adjudication, not deleted |
...
**This axis is not saturated.** A spread of 0.350 means it does separate models. But at
