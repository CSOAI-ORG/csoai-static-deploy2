...
export const metadata: Metadata = {
  ...
  title: {
    default: 'AI Fish Disease Diagnosis App | 98% Accuracy | FishKeeper.ai',
    template: `%s | FishKeeper.ai`,
  },
  description:
    'Upload a photo or symptoms and get instant AI fish disease diagnosis in 60 seconds. 95+ diseases detected. Water parameters, species care guides and tank compatibility checks. Verified by CSOAI.',
  keywords: [
    'fish disease diagnosis app',
    'AI fish health checker',
    ...
    'aquarium disease detector',
    'sick fish diagnosis',
    'fish illness treatment',
    'aquarium AI assistant',
    'CSOAI',
    'SOV3',
  ],
  openGraph: {
    ...
    title: '🐠 FishKeeper.ai - AI Expert for Your Tropical Fish & Coral Reef Tank',
    description:
      'Get instant expert AI advice for fish diseases, coral care & marine aquarium problems. 24/7 aquarium assistant that keeps your tropical fish healthy & corals thriving!',
  },
  twitter: {
    card: 'summary_large_image',
    title: '🐠 FishKeeper.ai - AI Expert for Your Aquarium',
    description:
      'Instant AI advice for fish diseases, coral care & marine aquarium problems. Keep your tropical fish healthy & corals thriving!',
  },
