"""Tests for meok-ai-treaty-mcp — auto-generated stub (EAT-44 v3)."""
import os

def test_meok_ai_treaty_pyproject_exists():
...
def test_meok_ai_treaty_license():
