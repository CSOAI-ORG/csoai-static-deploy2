"""Tests for meok-gaming-eve-mcp — auto-generated stub (EAT-44 v3)."""
import os

def test_meok_gaming_eve_pyproject_exists():
...
def test_meok_gaming_eve_license():
