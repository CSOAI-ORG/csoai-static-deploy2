// Cloudflare Pages Function — converted from api/triangle.js
...
export async function onRequest(context) {
  ...
  // DEFONEOS SOV3³ Triangle clan routing endpoint
  //
  // POST /api/triangle
  //
  ...
  function hmacSigil(obj) {
    ...
    const sigil = hmacSigil({ message_hash: createHash('sha256').update(message).digest('hex').slice(0, 16), ruling: shouldEscalate ? 'ESCALATED' : 'COMMITTED_LOCAL', rho: rho.rho, timestamp: ts });
