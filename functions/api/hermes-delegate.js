// Cloudflare Pages Function — converted from api/hermes-delegate.js
...
export async function onRequest(context) {
  ...
  // DEFONEOS Hermes agentic layer DELEGATE endpoint
  ...
  corsHeaders['Cache-Control'] = 'no-store';
    ...
    const jitter = (randomBytes(1)[0] / 255) * 1.5; // 0..1.5s
