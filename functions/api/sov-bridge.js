// Cloudflare Pages Function — converted from api/sov-bridge.js
...
export async function onRequest(context) {
  ...
  // DEFONEOS SOV SPACE ↔ J SPACE bridge endpoint
  // GET /api/sov-bridge
  //
  ...
  function computeBftHealth(jLog, sigilLog) {
    ...
    bridge_state.bridge_sigil = createHmac('sha256', hmac_secret)
