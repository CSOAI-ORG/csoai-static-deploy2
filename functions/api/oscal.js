// Cloudflare Pages Function — converted from api/oscal.js
export async function onRequest(context) {
  ...
  // DEFONEOS DEFONEOS OSCAL 1.1.2 bundle export
  ...
  function buildOSCAL(framework = 'eu-ai-act') {
    ...
    const framework = url.searchParams.get("framework") || 'eu-ai-act';
    const format = url.searchParams.get("format") || 'json';
    const bundle = buildOSCAL(framework);

    if (format === 'yaml') {
    corsHeaders['Content-Type'] = 'application/yaml; charset=utf-8';
    ...
    corsHeaders['Content-Type'] = 'application/oscal+json; charset=utf-8';
