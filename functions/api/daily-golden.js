// Cloudflare Pages Function — converted from api/daily-golden.js
export async function onRequest(context) {
  ...
  function fetch_p(url, method = 'GET', body) {
    ...
    return new Response(JSON.stringify(summary), { status: fail === 0 ? 200 : 503, headers: { ...corsHeaders, 'Content-Type': 'application/json' } });
}
