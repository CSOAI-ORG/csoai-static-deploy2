// Cloudflare Pages Function — converted from api/sovereign-telemetry.js
...
export async function onRequest(context) {
  ...
  // DEFONEOS Sovereign Telemetry aggregator
  ...
  function kpi(label, value, unit, status) {
    ...
    const t0 = Date.now();
    const tick_id = 'tel_' + randomBytes(8).toString('hex');
