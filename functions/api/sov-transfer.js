// Cloudflare Pages Function — converted from api/sov-transfer.js
...
export async function onRequest(context) {
  ...
  // DEFONEOS SOV Space → J-Space data transfer endpoint
  //
  ...
  function generateHiveTransfer(agentId) {
    ...
    return new Response(JSON.stringify(transfer), { status: 200, headers: { ...corsHeaders, 'Content-Type': 'application/json' } });
}
