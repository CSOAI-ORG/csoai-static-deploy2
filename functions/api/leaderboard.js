...
// ─── Measured: official-format lm-eval-harness runs (2026-08-02) ────────────
// Model: csoai/sov33-unified (HF). Harness: lm-eval 0.4.12, llama.cpp server,
// full test splits. Near-random on general-knowledge MC is the specialization
// profile of a governance-tuned 2B model — disclosed, not hidden.
const OFFICIAL_FORMAT = {
  model: 'csoai/sov33-unified',
  harness: 'lm-eval-harness 0.4.12 (official format, reproducible)',
  results: {
    arc_easy: { acc: 0.2508, ci95: 0.0089, n: 'full split' },
    arc_challenge: { acc: 0.227, ci95: 0.0122, n: 'full split' },
  },
  note: 'General-knowledge trivia is not the target domain; see frozen_split_governance for the measured specialization.',
};
...
const FROZEN_SPLIT = {
  ...
  results: [
    ...
    { id: 'sov33-unified', score: 0.246, ci95: [0.217, 0.278], note: 'statistical tie with sonnet-4.5 and gpt-5 on governance scenarios' },
...
const NOT_MEASURED = ['mmlu', 'gsm8k', 'aime', 'ifeval', 'bbh', 'hellaswag'];
