// Cloudflare Pages Function — converted from api/sovereign-corpus.js
...
export async function onRequest(context) {
  ...
  // DEFONEOS SOV33 sovereign training corpus endpoint
  ...
  // Handler ---------------------------------------------------------------------
    ...
    // Parse query params defensively (handle both Vercel's url.searchParams and a URL)
