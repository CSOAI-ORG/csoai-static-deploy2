// Cloudflare Pages Function — converted from api/hermes-lanes.js
...
export async function onRequest(context) {
  ...
  // DEFONEOS Hermes agentic layer LANES endpoint
  ...
  function computeLaneState(regLane, recentByLaneId) {
    ...
    if (request.method !== 'GET') {
      return new Response(JSON.stringify({ status: 'error', error: 'Method not allowed' }), { status: 405, headers: { ...corsHeaders, 'Content-Type': 'application/json' } });
    }
