...
python3 ops/adversarial_review.py >/dev/null 2>&1 || { echo "FAIL: adversarial-evidence review"; FAIL=1; }
python3 arena/grader.py --selftest >/dev/null 2>&1 || { echo "FAIL: arena grader"; FAIL=1; }
python3 bridges/cobol_copybook.py --selftest >/dev/null 2>&1 || { echo "FAIL: COBOL bridge"; FAIL=1; }
