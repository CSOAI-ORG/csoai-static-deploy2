#!/usr/bin/env python3
"""Tick 290 deep-dive pack generator: Creative Scotland, South of Scotland Enterprise, Scottish Parliament Corporate Body.
Reuses tick-289 template (CSS/NAV/FOOTER/engagement identical — only PACKS change).
Writes to _site/ directory. Emits tick-290-sigil.json."""
import os, sys, json, hashlib, datetime

try:
    from _gen_tick290_packs import PACKS
except ImportError:
    print("ERROR: _gen_tick290_packs.py not found in same directory.", file=sys.stderr)
    sys.exit(1)
