#!/usr/bin/env python3
"""Tick 295 generator: 3 genuinely-uncovered Scottish public-body deep-dive packs.
VisitScotland / Historic Environment Scotland / Scottish Sentencing Council.
Probe-verified 0 disk + 0 sitemap BEFORE build (tick-265 pitfall).
Builder: _gen_tick295.py | Data: _gen_tick295_packs.py"""
import json, os, hashlib
from _gen_tick295_packs import PACKS
...
def build_pack(pack):
    ...
    ld_json = json.dumps({
        ...
        "about": {"@type": "GovernmentService", "name": pack["body_name"], "provider": {"@type": "GovernmentOrganization", "name": f"{pack['body_name']} ({pack['body_acronym']})", "url": "https://www.gov.scot"}}
    })
...
sigil = {"tick": TICK, "date": TODAY, "packs": [], "total_bytes": 0, "phase": 263}
