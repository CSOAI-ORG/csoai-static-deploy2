...
| creativity | 215 | 0.154 | 0.145 | ❌ loses to base (6% worse) |
| emotion | 50 | 0.233 | 0.221 | ❌ loses to base (5% worse) |
| intent | 50 | 0.224 | 0.238 | ✅ beats base |
| partnership | 50 | 0.231 | 0.291 | ✅ beats base |
| relationship | 253 | 0.142 | 0.134 | ❌ loses to base (6% worse) |
| sentiment | 50 | 0.233 | 0.248 | ✅ beats base |
| threat | 62 | 0.483 | 0.299 | ❌ loses to base (62% worse) |
...
- ❌ **relationship / creativity / emotion lose to baseline by 5-6%** — the care_weight target is near-constant for these, so the model can't beat predict-the-mean; they need a *task-specific* label, not care_weight.
