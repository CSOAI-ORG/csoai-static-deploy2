...
- **⚠ Two competitor analyses:** Hermes' Intel DB (35 competitors / 21 categories) + Fable's `COMPETITIVE_ANALYSIS_2026-07-12` (6 categories + adopt/avoid + picked-apart flags). **→ Merge into one; Hermes has breadth, Fable has the strategic wedges + the external-red-team recommendation.**
