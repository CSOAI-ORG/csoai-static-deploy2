...
AXIS = 'conformance'
FAMILIES = ["Qwen/Qwen3-14B", "google/gemma-3-12b-it", "nvidia/Llama-3.1-Nemotron-Ultra-253B-v1", "BAAI/bge-m3", "unsloth/Qwen3.5-4B-GGUF", "mradermacher/Qwen3-VL-8B-Instruct-abliterated-GGUF", "unsloth/Qwen3.6-35B-A3B-MTP-GGUF", "audio-cpp/audio.cpp-gguf", "TheBloke/SauerkrautLM-SOLAR-Instruct-GGUF", "ChiKoi7/GPT-5-Distill-Qwen3-4B-Instruct-Heretic-GGUF", "QuantFactory/Neumind-Math-7B-Instruct-GGUF", "mradermacher/Falcon3-3B-Instruct-Heretic-i1-GGUF", "mradermacher/FinMatcha-3B-Instruct-i1-GGUF", "mradermacher/DRT-o1-14B-i1-GGUF", "mradermacher/FinMatcha-3B-Instruct-GGUF", "mradermacher/ArlowGPT-3B-GGUF", "AIFunOver/DRT-o1-7B-openvino-4bit", "openai/gpt-oss-20b", "Qwen/Qwen3-Reranker-4B", "HuggingFaceTB/SmolLM2-135M", "bigscience/bloomz-560m", "Qwen/Qwen3.6-27B", "Qwen/Qwen3.5-35B-A3B", "MaziyarPanahi/Qwen3-32B-GGUF", "MaziyarPanahi/WizardLM-2-7B-GGUF"]
