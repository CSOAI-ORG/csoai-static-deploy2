# OWEM cluster — kaggle — axis conformance × all open-source families
# Runs GSPC measurement for axis 'conformance' against every open-source family.
import json, time, hashlib, os
from pathlib import Path

AXIS = 'conformance'
FAMILIES = ["Qwen/Qwen2.5-14B-Instruct", "mistralai/Mistral-Small-24B-Instruct-2501", "HuggingFaceTB/SmolLM2-1.7B-Instruct", "databricks/dbrx-instruct", "nvidia/nemotron-3.5-asr-streaming-0.6b", "lmstudio-community/Qwen3.8-27B-GGUF", "unsloth/gemma-4-31B-it-GGUF", "AngelSlim/Hy3-GGUF", "Qwen/Qwen3-30B-A3B-GGUF", "mradermacher/Llama-Sentient-3.2-3B-Instruct-i1-GGUF", "mradermacher/Dobby-Unhinged-Llama-3.3-70B-i1-GGUF", "prithivMLmods/Llama-3.2-3B-Instruct-GGUF", "DavidAU/Mistral-Nemo-Instruct-2407-13.35B-BRAINSTORM-5x-FORM-11-GGUF", "mradermacher/LUNA-SOLARkrautLM-Instruct-i1-GGUF", "prithivMLmods/Llama-Magpie-3.2-3B-Instruct-GGUF", "mradermacher/DRT-8B-GGUF", "AIFunOver/DRT-o1-7B-openvino-8bit", "trl-internal-testing/tiny-Qwen2ForCausalLM-2.5", "ornith-ai/Ornith-1.0-35B", "Qwen/Qwen2.5-14B-Instruct-AWQ", "prism-ml/Ternary-Bonsai-27B-mlx-2bit", "Qwen/Qwen2.5-VL-7B-Instruct", "cyankiwi/gemma-4-26B-A4B-it-AWQ-4bit", "MaziyarPanahi/Qwen3-1.7B-GGUF", "MaziyarPanahi/Meta-Llama-3.1-8B-Instruct-GGUF"]
