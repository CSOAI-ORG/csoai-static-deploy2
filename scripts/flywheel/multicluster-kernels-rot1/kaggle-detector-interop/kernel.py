# OWEM cluster — kaggle — axis detector-interop × all open-source families
# Runs GSPC measurement for axis 'detector-interop' against every open-source family.
import json, time, hashlib, os
from pathlib import Path

AXIS = 'detector-interop'
FAMILIES = ["unsloth/Qwen3-Coder-30B-A3B-Instruct-GGUF", "unsloth/gemma-4-26B-A4B-it-GGUF", "allenai/OLMo-2-7B", "mixedbread-ai/mxbai-embed-large-v1", "unsloth/Qwen3.6-27B-GGUF", "prism-ml/Ternary-Bonsai-27B-gguf", "unsloth/gemma-4-26B-A4B-it-qat-GGUF", "Jackrong/Qwopus3.6-35B-A3B-Coder-MTP-GGUF", "QuantFactory/Llama-Sentient-3.2-3B-Instruct-GGUF", "mradermacher/Llama-3-ELYZA-JP-8B-Heretic-i1-GGUF", "ChiKoi7/SmolLM2-1.7B-Instruct-Heretic-GGUF", "mradermacher/KAI-7B-Instruct-i1-GGUF", "mradermacher/Llama-3-ELYZA-JP-8B-Heretic-GGUF", "bartowski/DRT-o1-7B-GGUF", "mradermacher/DRT-o1-14B-GGUF", "Loewolf/GPT_1", "bkbj/Atest", "Qwen/Qwen3-1.7B", "Qwen/Qwen-72B", "zai-org/GLM-4.7-Flash", "Qwen/Qwen3-Coder-Next-FP8", "Qwen/Qwen3-VL-8B-Instruct", "Qwen/Qwen3.5-122B-A10B", "MaziyarPanahi/Meta-Llama-3-8B-Instruct-GGUF", "MaziyarPanahi/gemma-3-12b-it-GGUF"]
