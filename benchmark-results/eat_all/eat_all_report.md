...
**Run ID**: eat_all_1786342517
**Finished**: 2026-08-10T06:15:17.334908+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=1443 |
...
| PHASE_5_HONEY | ran | 1.7s | exit_code=0; events=1453 |
| PHASE_6_DOWNLOADS | ran | 6.4s | exit_code=0; files_mined=169 |
| PHASE_7_PORTAL | ran | 1.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.2s | deck_cards=54; kb_entries=1443; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786342514 |
