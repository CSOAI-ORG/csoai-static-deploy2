...
**Run ID**: eat_all_1786196737
**Finished**: 2026-08-08T13:45:37.494396+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=3; kb_entries=20594 |
...
| PHASE_5_HONEY | ran | 0.4s | exit_code=0; events=85 |
| PHASE_6_DOWNLOADS | ran | 0.5s | exit_code=0; files_mined=158 |
| PHASE_7_PORTAL | ran | 1.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.1s |  |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786196707 |
...
| PHASE_9I_SOV_CAPTURE | failed | 23.1s | Command '['python3', '/Users/nicholas/clawd/csoai-static-deploy2/sov_capture.py', '--status']' timed |
