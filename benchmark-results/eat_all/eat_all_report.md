...
**Run ID**: eat_all_1786363554
**Finished**: 2026-08-10T12:05:54.542696+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=2005 |
...
| PHASE_5_HONEY | ran | 4.7s | exit_code=0; events=1693 |
| PHASE_6_DOWNLOADS | failed | 8.6s | (no error message) |
| PHASE_7_PORTAL | ran | 7.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.6s | deck_cards=54; kb_entries=2005; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786363528 |
...
| PHASE_9I_SOV_CAPTURE | ran | 12.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 3 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 2012 → 2012 entries (+0 new, dedup by normalized question)
