...
**Run ID**: eat_all_1786525532
**Finished**: 2026-08-12T09:05:32.903519+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5237 |
...
| PHASE_5_HONEY | ran | 5.2s | exit_code=0; events=3073 |
| PHASE_6_DOWNLOADS | ran | 2.3s | exit_code=0; files_mined=226 |
| PHASE_7_PORTAL | ran | 1.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=54; kb_entries=5237; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786525523 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 3 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5244 → 5244 entries (+0 new, dedup by normalized question)
