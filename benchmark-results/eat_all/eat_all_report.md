...
**Run ID**: eat_all_1786731016
**Finished**: 2026-08-14T18:10:16.497157+00:00
...
| PHASE_5_HONEY | ran | 0.8s | exit_code=0; events=4736 |
| PHASE_6_DOWNLOADS | ran | 4.5s | exit_code=0; files_mined=296 |
| PHASE_7_PORTAL | ran | 1.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.3s | deck_cards=0 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.6s | events_processed=0; skills_extracted=0 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 1.0s | iwm_records=0; kb_entries_added=0; exit_code=1 |
