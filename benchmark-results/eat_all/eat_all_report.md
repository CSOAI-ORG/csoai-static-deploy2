...
**Run ID**: eat_all_1786426843
**Finished**: 2026-08-11T05:40:43.452618+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 5.1s | sov_local_status=unreachable: timed out; ollama_models=2; kb_entries=3668 |
...
| PHASE_5_HONEY | ran | 0.7s | exit_code=0; events=2393 |
| PHASE_6_DOWNLOADS | failed | 6.4s | (no error message) |
| PHASE_7_PORTAL | ran | 3.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 8.5s | deck_cards=54; kb_entries=3668; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 4.1s | clans_routed=0; swarm_id=owem-clans-1786426831 |
