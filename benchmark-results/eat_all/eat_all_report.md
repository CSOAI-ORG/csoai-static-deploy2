...
**Run ID**: eat_all_1786536936
**Finished**: 2026-08-12T12:15:36.561528+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5544 |
...
| PHASE_5_HONEY | ran | 2.5s | exit_code=0; events=3173 |
| PHASE_6_DOWNLOADS | ran | 1.6s | exit_code=0; files_mined=233 |
| PHASE_7_PORTAL | ran | 3.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.6s | deck_cards=55; kb_entries=5544; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.0s | clans_routed=0; swarm_id=owem-clans-1786536916 |
...
| PHASE_9I_SOV_CAPTURE | ran | 5.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5551 → 5551 entries (+0 new, dedup by normalized question)
