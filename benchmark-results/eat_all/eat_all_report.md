...
**Run ID**: eat_all_1786763038
**Finished**: 2026-08-15T03:03:58.862861+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=9257 |
...
| PHASE_5_HONEY | ran | 1.2s | exit_code=0; events=4856 |
| PHASE_6_DOWNLOADS | ran | 1.9s | exit_code=0; files_mined=298 |
| PHASE_7_PORTAL | ran | 1.6s | exit_code=0 |
| PHASE_8_DEPLOY | ran | 21.3s | deploy_exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.8s | deck_cards=55; kb_entries=9257; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786763031 |
