...
**Run ID**: eat_all_1786699865
**Finished**: 2026-08-14T09:31:05.254240+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 5.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=8762 |
...
| PHASE_5_HONEY | ran | 9.5s | exit_code=0; events=4496 |
| PHASE_6_DOWNLOADS | ran | 6.3s | exit_code=0; files_mined=278 |
| PHASE_7_PORTAL | ran | 6.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 6.6s | deck_cards=55; kb_entries=8762; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.9s | clans_routed=0; swarm_id=owem-clans-1786699851 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 9 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8769 → 8769 entries (+0 new, dedup by normalized question)
