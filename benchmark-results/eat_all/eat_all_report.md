...
**Run ID**: eat_all_1786588522
**Finished**: 2026-08-13T02:35:22.014690+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6840 |
...
| PHASE_5_HONEY | ran | 0.5s | exit_code=0; events=3716 |
| PHASE_6_DOWNLOADS | ran | 0.4s | exit_code=0; files_mined=240 |
| PHASE_7_PORTAL | ran | 3.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.7s | deck_cards=55; kb_entries=6840; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.0s | clans_routed=0; swarm_id=owem-clans-1786588516 |
