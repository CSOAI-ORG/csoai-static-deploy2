...
**Run ID**: eat_all_1786599969
**Finished**: 2026-08-13T05:46:09.327483+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7145 |
...
| PHASE_5_HONEY | ran | 6.4s | exit_code=0; events=3836 |
| PHASE_6_DOWNLOADS | ran | 3.4s | exit_code=0; files_mined=254 |
| PHASE_7_PORTAL | ran | 4.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.1s | deck_cards=55; kb_entries=7145; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.2s | clans_routed=0; swarm_id=owem-clans-1786599936 |
| PHASE_9C_OWEM_CLUSTER | ran | 2.2s | clusters_routed=0 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 17.5s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 4.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7152 → 7152 entries (+0 new, dedup by normalized question)
