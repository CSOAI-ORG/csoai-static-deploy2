...
**Run ID**: eat_all_1786514115
**Finished**: 2026-08-12T05:55:15.001116+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4941 |
...
| PHASE_9_ARTIFACTS | ran | 0.4s | deck_cards=54; kb_entries=4941; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786514110 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 4948 → 4948 entries (+0 new, dedup by normalized question)
