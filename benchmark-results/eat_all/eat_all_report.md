...
**Run ID**: eat_all_1786524630
**Finished**: 2026-08-12T08:50:30.325953+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5213 |
...
| PHASE_5_HONEY | ran | 1.9s | exit_code=0; events=3053 |
| PHASE_6_DOWNLOADS | ran | 2.6s | exit_code=0; files_mined=226 |
| PHASE_7_PORTAL | ran | 4.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.4s | deck_cards=54; kb_entries=5213; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786524619 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 3.4s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 2.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 3 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5220 → 5220 entries (+0 new, dedup by normalized question)
