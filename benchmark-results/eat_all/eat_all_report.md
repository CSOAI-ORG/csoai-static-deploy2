...
**Run ID**: eat_all_1786533917
**Finished**: 2026-08-12T11:25:17.507224+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5462 |
...
| PHASE_9_ARTIFACTS | ran | 0.5s | deck_cards=55; kb_entries=5462; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786533914 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5469 → 5469 entries (+0 new, dedup by normalized question)
