...
**Run ID**: eat_all_1786603236
**Finished**: 2026-08-13T06:40:36.573532+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7233 |
...
| PHASE_5_HONEY | ran | 1.7s | exit_code=0; events=3876 |
| PHASE_6_DOWNLOADS | ran | 7.3s | exit_code=0; files_mined=261 |
| PHASE_7_PORTAL | ran | 5.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.1s | deck_cards=55; kb_entries=7233; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.0s | clans_routed=0; swarm_id=owem-clans-1786603222 |
...
| PHASE_9I_SOV_CAPTURE | ran | 5.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7240 → 7240 entries (+0 new, dedup by normalized question)
