...
**Run ID**: eat_all_1786508135
**Finished**: 2026-08-12T04:15:35.726799+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=4780 |
...
| PHASE_5_HONEY | ran | 2.3s | exit_code=0; events=2893 |
| PHASE_6_DOWNLOADS | ran | 3.9s | exit_code=0; files_mined=219 |
| PHASE_7_PORTAL | ran | 3.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.8s | deck_cards=54; kb_entries=4780; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786508133 |
