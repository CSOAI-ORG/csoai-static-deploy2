...
**Run ID**: eat_all_1786591281
**Finished**: 2026-08-13T03:21:21.336283+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6913 |
...
| PHASE_5_HONEY | ran | 9.3s | exit_code=0; events=3736 |
| PHASE_6_DOWNLOADS | failed | 7.6s | (no error message) |
| PHASE_7_PORTAL | ran | 6.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 4.4s | deck_cards=55; kb_entries=6913; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786591241 |
| PHASE_9C_OWEM_CLUSTER | ran | 1.8s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 1.1s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 1.2s | data_sources_routed=0 |
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 2.6s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 1.7s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 15.9s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 8.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 6920 → 6920 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 6920 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 2.4s | iwm_records=0; kb_entries_added=0; exit_code=0 |
| PHASE_10B_MODEL_ROUTING | ran | 4.0s | models_routed=0; specs_routed=1 |
