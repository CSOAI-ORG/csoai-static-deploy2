...
**Run ID**: eat_all_1786540563
**Finished**: 2026-08-12T13:16:03.587973+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5640 |
| PHASE_1_REBOARD | ran | 2.5s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 3.7s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 9.2s | exit_code=0; events=3213 |
| PHASE_6_DOWNLOADS | failed | 9.7s | (no error message) |
| PHASE_7_PORTAL | ran | 3.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.2s | deck_cards=55; kb_entries=5640; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.6s | clans_routed=0; swarm_id=owem-clans-1786540540 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 7.7s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 7.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 6 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5647 → 5647 entries (+0 new, dedup by normalized question)
