...
**Run ID**: eat_all_1786543256
**Finished**: 2026-08-12T14:00:56.884846+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5704 |
| PHASE_1_REBOARD | ran | 3.6s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 5.2s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 8.0s | exit_code=0; events=3236 |
| PHASE_6_DOWNLOADS | ran | 2.5s | exit_code=0; files_mined=237 |
| PHASE_7_PORTAL | ran | 4.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.2s | deck_cards=55; kb_entries=5704; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.9s | clans_routed=0; swarm_id=owem-clans-1786543235 |
...
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 1.6s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 1.5s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 5.7s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 7.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 6 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5711 → 5711 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 5711 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 1.6s | iwm_records=0; kb_entries_added=0; exit_code=0 |
| PHASE_10B_MODEL_ROUTING | ran | 1.2s | models_routed=0; specs_routed=1 |
