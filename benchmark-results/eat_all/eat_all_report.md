...
**Run ID**: eat_all_1786559414
**Finished**: 2026-08-12T18:30:14.017415+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6064 |
...
| PHASE_5_HONEY | ran | 1.3s | exit_code=0; events=3356 |
| PHASE_6_DOWNLOADS | ran | 0.4s | exit_code=0; files_mined=240 |
| PHASE_7_PORTAL | ran | 2.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.6s | deck_cards=55; kb_entries=6064; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.3s | clans_routed=0; swarm_id=owem-clans-1786559408 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 6071 → 6071 entries (+0 new, dedup by normalized question)
