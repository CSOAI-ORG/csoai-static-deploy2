...
**Run ID**: eat_all_1786631521
**Finished**: 2026-08-13T14:32:01.195869+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7880 |
...
| PHASE_5_HONEY | ran | 2.7s | exit_code=0; events=4116 |
| PHASE_6_DOWNLOADS | ran | 41.9s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 4.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.2s | deck_cards=55; kb_entries=7880; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.8s | clans_routed=0; swarm_id=owem-clans-1786631466 |
| PHASE_9C_OWEM_CLUSTER | ran | 6.0s | clusters_routed=0 |
...
| PHASE_9I_SOV_CAPTURE | ran | 22.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7887 → 7887 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7887 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 7.5s | iwm_records=0; kb_entries_added=0; exit_code=0 |
