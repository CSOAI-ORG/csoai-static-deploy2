...
**Run ID**: eat_all_1786517750
**Finished**: 2026-08-12T06:55:50.680734+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5037 |
| PHASE_1_REBOARD | ran | 6.6s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 8.6s | exit_code=0; events=2973 |
| PHASE_6_DOWNLOADS | failed | 8.0s | (no error message) |
| PHASE_7_PORTAL | ran | 2.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.1s | deck_cards=54; kb_entries=5037; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786517738 |
| PHASE_9C_OWEM_CLUSTER | ran | 0.6s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 0.4s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 0.7s | data_sources_routed=0 |
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 0.6s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 0.9s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 2.3s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 5.9s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5044 → 5044 entries (+0 new, dedup by normalized question)
