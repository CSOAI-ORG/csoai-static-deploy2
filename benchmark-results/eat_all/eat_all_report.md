...
**Run ID**: eat_all_1786467019
**Finished**: 2026-08-11T16:50:19.021533+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4660 |
...
| PHASE_5_HONEY | ran | 0.7s | exit_code=0; events=2833 |
| PHASE_6_DOWNLOADS | failed | 5.9s | (no error message) |
| PHASE_7_PORTAL | ran | 1.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.9s | deck_cards=54; kb_entries=4660; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786467012 |
