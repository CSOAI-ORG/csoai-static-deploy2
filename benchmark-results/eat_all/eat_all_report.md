...
**Run ID**: eat_all_1786590408
**Finished**: 2026-08-13T03:06:48.611359+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 14.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=6888 |
| PHASE_1_REBOARD | ran | 6.8s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 2.6s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 34.4s | exit_code=0; events=3716 |
| PHASE_6_DOWNLOADS | failed | 10.4s | (no error message) |
| PHASE_7_PORTAL | ran | 14.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 5.8s | deck_cards=55; kb_entries=6888; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 3.1s | clans_routed=0; swarm_id=owem-clans-1786590398 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 6895 → 6896 entries (+1 new, dedup by normalized question)
