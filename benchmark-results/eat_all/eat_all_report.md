...
**Run ID**: eat_all_1786535723
**Finished**: 2026-08-12T11:55:23.892280+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5510 |
...
| PHASE_5_HONEY | ran | 0.8s | exit_code=0; events=3173 |
| PHASE_6_DOWNLOADS | failed | 5.9s | (no error message) |
| PHASE_7_PORTAL | ran | 2.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.7s | deck_cards=55; kb_entries=5510; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786535714 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5517 → 5517 entries (+0 new, dedup by normalized question)
