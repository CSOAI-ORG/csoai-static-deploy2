...
**Run ID**: eat_all_1786695624
**Finished**: 2026-08-14T08:20:24.394654+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8666 |
...
| PHASE_5_HONEY | ran | 1.5s | exit_code=0; events=4456 |
| PHASE_6_DOWNLOADS | ran | 0.8s | exit_code=0; files_mined=273 |
| PHASE_7_PORTAL | ran | 1.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.3s | deck_cards=55; kb_entries=8666; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786695608 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 4.9s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 4.9s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8673 → 8673 entries (+0 new, dedup by normalized question)
