...
**Run ID**: eat_all_1786627630
**Finished**: 2026-08-13T13:27:10.107462+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7798 |
...
| PHASE_5_HONEY | ran | 4.6s | exit_code=0; events=4096 |
| PHASE_6_DOWNLOADS | ran | 1.9s | exit_code=0; files_mined=270 |
| PHASE_7_PORTAL | ran | 5.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 5.7s | deck_cards=55; kb_entries=7798; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.7s | clans_routed=0; swarm_id=owem-clans-1786627530 |
...
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 3.5s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 3.3s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 47.0s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 33.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7805 → 7805 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7805 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 3.0s | iwm_records=0; kb_entries_added=0; exit_code=0 |
