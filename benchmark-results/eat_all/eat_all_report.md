...
**Run ID**: eat_all_1786697179
**Finished**: 2026-08-14T08:46:19.976147+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 16.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8706 |
| PHASE_1_REBOARD | ran | 14.8s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 6.1s | exit_code=0; events=4476 |
| PHASE_6_DOWNLOADS | failed | 7.1s | (no error message) |
| PHASE_7_PORTAL | ran | 1.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.2s | deck_cards=55; kb_entries=8706; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 3.8s | clans_routed=0; swarm_id=owem-clans-1786697168 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8713 → 8713 entries (+0 new, dedup by normalized question)
