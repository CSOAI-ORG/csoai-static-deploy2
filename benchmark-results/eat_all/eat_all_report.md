...
**Run ID**: eat_all_1786529730
**Finished**: 2026-08-12T10:15:30.069340+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5349 |
| PHASE_1_REBOARD | ran | 2.0s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 2.9s | exit_code=0; events=3113 |
| PHASE_6_DOWNLOADS | ran | 2.7s | exit_code=0; files_mined=228 |
| PHASE_7_PORTAL | ran | 2.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.9s | deck_cards=54; kb_entries=5349; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786529717 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 3.8s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 2.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5356 → 5356 entries (+0 new, dedup by normalized question)
