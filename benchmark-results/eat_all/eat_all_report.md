...
**Run ID**: eat_all_1786700310
**Finished**: 2026-08-14T09:38:30.885909+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 16.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=8770 |
| PHASE_1_REBOARD | ran | 19.2s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 7.7s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 25.4s | exit_code=0; events=4516 |
| PHASE_6_DOWNLOADS | ran | 19.5s | exit_code=0; files_mined=278 |
| PHASE_7_PORTAL | ran | 15.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 14.2s | deck_cards=55; kb_entries=8770; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 8.1s | clans_routed=0; swarm_id=owem-clans-1786700236 |
| PHASE_9C_OWEM_CLUSTER | ran | 5.4s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 4.5s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 4.2s | data_sources_routed=0 |
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 4.6s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 4.0s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 16.2s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 22.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 9 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8777 → 8777 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 8777 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 7.2s | iwm_records=0; kb_entries_added=0; exit_code=0 |
