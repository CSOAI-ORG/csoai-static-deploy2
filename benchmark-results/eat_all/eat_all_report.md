...
**Run ID**: eat_all_1786623657
**Finished**: 2026-08-13T12:20:57.446638+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7759 |
| PHASE_1_REBOARD | ran | 4.8s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 3.1s | exit_code=0; events=4076 |
| PHASE_6_DOWNLOADS | failed | 7.8s | (no error message) |
| PHASE_7_PORTAL | ran | 8.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 5.0s | deck_cards=55; kb_entries=7759; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 3.2s | clans_routed=0; swarm_id=owem-clans-1786623639 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 5.6s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 3.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7766 → 7766 entries (+0 new, dedup by normalized question)
