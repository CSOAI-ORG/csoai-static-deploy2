...
**Run ID**: eat_all_1786296011
**Finished**: 2026-08-09T17:20:11.784649+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.7s | souls=184; ollama_models=2; kb_entries=1179 |
...
| PHASE_5_HONEY | ran | 1.5s | exit_code=0; events=1353 |
| PHASE_6_DOWNLOADS | ran | 2.0s | exit_code=0; files_mined=168 |
| PHASE_7_PORTAL | ran | 0.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.1s | deck_cards=54; kb_entries=1179; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786296010 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 1186 → 1186 entries (+0 new, dedup by normalized question)
