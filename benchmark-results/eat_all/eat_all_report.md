...
**Run ID**: eat_all_1786640142
**Finished**: 2026-08-13T16:55:42.782269+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7938 |
...
| PHASE_5_HONEY | ran | 1.2s | exit_code=0; events=4156 |
| PHASE_6_DOWNLOADS | ran | 1.1s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 2.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.9s | deck_cards=55; kb_entries=7938; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.6s | clans_routed=0; swarm_id=owem-clans-1786640111 |
...
| PHASE_9I_SOV_CAPTURE | ran | 13.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7945 → 7945 entries (+0 new, dedup by normalized question)
