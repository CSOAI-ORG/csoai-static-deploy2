...
**Run ID**: eat_all_1786705002
**Finished**: 2026-08-14T10:56:42.917478+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8890 |
...
| PHASE_5_HONEY | ran | 2.8s | exit_code=0; events=4556 |
| PHASE_6_DOWNLOADS | failed | 8.4s | (no error message) |
| PHASE_7_PORTAL | ran | 3.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 5.7s | deck_cards=55; kb_entries=8897; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.8s | clans_routed=0; swarm_id=owem-clans-1786704967 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 6.7s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 19.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 9 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8904 → 8904 entries (+0 new, dedup by normalized question)
