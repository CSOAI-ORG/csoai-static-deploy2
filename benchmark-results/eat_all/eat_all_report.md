...
**Run ID**: eat_all_1786401309
**Finished**: 2026-08-10T22:35:09.312606+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=2996 |
...
| PHASE_9_ARTIFACTS | ran | 0.1s | deck_cards=54; kb_entries=2996; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786401307 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 3003 → 3003 entries (+0 new, dedup by normalized question)
