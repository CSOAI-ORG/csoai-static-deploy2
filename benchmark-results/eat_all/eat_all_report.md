...
**Run ID**: eat_all_1786523139
**Finished**: 2026-08-12T08:25:39.483924+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5173 |
| PHASE_1_REBOARD | ran | 3.5s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 1.9s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 3.9s | exit_code=0; events=3033 |
| PHASE_6_DOWNLOADS | ran | 4.2s | exit_code=0; files_mined=226 |
| PHASE_7_PORTAL | ran | 5.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.1s | deck_cards=54; kb_entries=5173; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.5s | clans_routed=0; swarm_id=owem-clans-1786523130 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5180 → 5180 entries (+0 new, dedup by normalized question)
