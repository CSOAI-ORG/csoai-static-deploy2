...
**Run ID**: eat_all_1786403408
**Finished**: 2026-08-10T23:10:08.818263+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=3052 |
...
| PHASE_5_HONEY | ran | 0.2s | exit_code=0; events=2133 |
| PHASE_6_DOWNLOADS | failed | 5.7s | (no error message) |
| PHASE_7_PORTAL | ran | 0.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.1s | deck_cards=54; kb_entries=3052; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786403407 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 3059 → 3059 entries (+0 new, dedup by normalized question)
