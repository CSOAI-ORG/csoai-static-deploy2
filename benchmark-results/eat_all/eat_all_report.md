...
**Run ID**: eat_all_1786595115
**Finished**: 2026-08-13T04:25:15.205302+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7017 |
...
| PHASE_6_DOWNLOADS | ran | 3.2s | exit_code=0; files_mined=249 |
| PHASE_7_PORTAL | ran | 1.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.6s | deck_cards=55; kb_entries=7017; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786595108 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7024 → 7024 entries (+0 new, dedup by normalized question)
