...
**Run ID**: eat_all_1786191410
**Finished**: 2026-08-08T12:16:50.152598+00:00
**Phase summary**: {'ran': 16, 'failed': 3, 'skipped': 0}

## Phases

| Phase | Status | Duration | Notes |
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2 |
...
| PHASE_5_HONEY | failed | 0.3s | (no error message) |
| PHASE_6_DOWNLOADS | ran | 0.3s | exit_code=0; files_mined=153 |
| PHASE_7_PORTAL | failed | 0.3s | (no error message) |
| PHASE_9_ARTIFACTS | ran | 0.0s |  |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786191402 |
...
| PHASE_9I_SOV_CAPTURE | ran | 7.3s | events_processed=256; skills_extracted=1; refine_output=KB Refinery — processing today's capture events...
  terminal: 5 events
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 0 → 5 entries (+5 new)
