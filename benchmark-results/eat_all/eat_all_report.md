...
**Run ID**: eat_all_1786519828
**Finished**: 2026-08-12T07:30:28.795315+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.6s | sov_local_status=unreachable: timed out; ollama_models=2; kb_entries=5085 |
...
| PHASE_5_HONEY | ran | 3.6s | exit_code=0; events=3013 |
| PHASE_6_DOWNLOADS | ran | 4.5s | exit_code=0; files_mined=224 |
| PHASE_7_PORTAL | ran | 2.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.8s | deck_cards=54; kb_entries=5085; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786519821 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5092 → 5092 entries (+0 new, dedup by normalized question)
