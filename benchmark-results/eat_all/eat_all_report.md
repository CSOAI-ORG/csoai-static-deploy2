...
**Run ID**: eat_all_1786260608
**Finished**: 2026-08-09T07:30:08.861854+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | souls=0; ollama_models=1; kb_entries=346 |
...
| PHASE_5_HONEY | ran | 0.3s | exit_code=0; events=992 |
...
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786260608 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 353 → 353 entries (+0 new, dedup by normalized question)
