...
**Run ID**: eat_all_1786408509
**Finished**: 2026-08-11T00:35:09.496875+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=3188 |
...
| PHASE_5_HONEY | ran | 0.3s | exit_code=0; events=2193 |
| PHASE_6_DOWNLOADS | failed | 5.2s | (no error message) |
| PHASE_7_PORTAL | ran | 0.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.1s | deck_cards=54; kb_entries=3188; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786408508 |
