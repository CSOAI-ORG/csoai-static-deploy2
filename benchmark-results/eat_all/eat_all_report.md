...
**Run ID**: eat_all_1786454423
**Finished**: 2026-08-11T13:20:23.299167+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: HTTP Error 404: Not Found; ollama_models=2; kb_entries=4396 |
...
| PHASE_5_HONEY | ran | 0.6s | exit_code=0; events=2713 |
| PHASE_6_DOWNLOADS | failed | 6.1s | (no error message) |
| PHASE_7_PORTAL | ran | 1.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=54; kb_entries=4396; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786454412 |
