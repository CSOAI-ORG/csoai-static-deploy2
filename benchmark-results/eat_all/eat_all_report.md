...
**Run ID**: eat_all_1786265402
**Finished**: 2026-08-09T08:50:02.772317+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.3s | souls=0; ollama_models=2; kb_entries=482 |
...
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786265401 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 489 → 489 entries (+0 new, dedup by normalized question)
