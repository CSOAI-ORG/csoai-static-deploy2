...
**Run ID**: eat_all_1786648541
**Finished**: 2026-08-13T19:15:41.491196+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8138 |
...
| PHASE_5_HONEY | ran | 6.1s | exit_code=0; events=4236 |
| PHASE_6_DOWNLOADS | ran | 2.9s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 1.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.3s | deck_cards=55; kb_entries=8138; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786648529 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.9s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8145 → 8145 entries (+0 new, dedup by normalized question)
