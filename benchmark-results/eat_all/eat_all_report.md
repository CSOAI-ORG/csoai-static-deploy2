...
**Run ID**: eat_all_1786601178
**Finished**: 2026-08-13T06:06:18.896540+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 7.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7177 |
| PHASE_1_REBOARD | ran | 7.5s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 2.0s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 13.0s | exit_code=0; events=3856 |
| PHASE_6_DOWNLOADS | ran | 6.6s | exit_code=0; files_mined=258 |
| PHASE_7_PORTAL | ran | 9.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 4.9s | deck_cards=55; kb_entries=7177; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.9s | clans_routed=0; swarm_id=owem-clans-1786601160 |
| PHASE_9C_OWEM_CLUSTER | ran | 3.7s | clusters_routed=0 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 5.1s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 3.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7184 → 7184 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7184 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 0.3s | iwm_records=0; kb_entries_added=0; exit_code=0 |
| PHASE_10B_MODEL_ROUTING | ran | 0.2s | models_routed=0; specs_routed=1 |
