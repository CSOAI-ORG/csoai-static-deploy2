...
**Run ID**: eat_all_1786418745
**Finished**: 2026-08-11T03:25:45.087281+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.5s | sov_local_status=unreachable: HTTP Error 404: Not Found; ollama_models=2; kb_entries=3460 |
...
| PHASE_5_HONEY | ran | 0.5s | exit_code=0; events=2313 |
| PHASE_6_DOWNLOADS | failed | 17.3s | (no error message) |
| PHASE_7_PORTAL | ran | 10.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.8s | deck_cards=54; kb_entries=3460; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.3s | clans_routed=0; swarm_id=owem-clans-1786418739 |
