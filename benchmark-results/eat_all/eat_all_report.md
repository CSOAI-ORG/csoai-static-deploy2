...
**Run ID**: eat_all_1786464361
**Finished**: 2026-08-11T16:06:01.070704+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4604 |
| PHASE_1_REBOARD | ran | 4.4s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 5.7s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 13.2s | exit_code=0; events=2813 |
| PHASE_6_DOWNLOADS | failed | 10.6s | (no error message) |
| PHASE_7_PORTAL | ran | 5.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.2s | deck_cards=54; kb_entries=4604; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.3s | clans_routed=0; swarm_id=owem-clans-1786464349 |
