...
**Run ID**: eat_all_1786255208
**Finished**: 2026-08-09T06:00:08.429627+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.1s | souls=0; ollama_models=4; kb_entries=194 |
...
| PHASE_9_ARTIFACTS | ran | 0.4s |  |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786255207 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 201 → 201 entries (+0 new, dedup by normalized question)
