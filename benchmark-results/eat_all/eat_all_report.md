...
**Run ID**: eat_all_1786683684
**Finished**: 2026-08-14T05:01:24.516986+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 9.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8368 |
...
| PHASE_5_HONEY | ran | 7.8s | exit_code=0; events=4316 |
| PHASE_6_DOWNLOADS | failed | 7.4s | (no error message) |
| PHASE_7_PORTAL | ran | 5.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 6.8s | deck_cards=55; kb_entries=8368; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.8s | clans_routed=0; swarm_id=owem-clans-1786683649 |
| PHASE_9C_OWEM_CLUSTER | ran | 3.1s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 2.3s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 3.5s | data_sources_routed=0 |
...
| PHASE_9I_SOV_CAPTURE | ran | 9.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 6 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8375 → 8375 entries (+0 new, dedup by normalized question)
