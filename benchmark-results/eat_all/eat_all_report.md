...
**Run ID**: eat_all_1786630883
**Finished**: 2026-08-13T14:21:23.754741+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7864 |
| PHASE_1_REBOARD | ran | 0.4s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 0.6s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 1.0s | exit_code=0; events=4116 |
| PHASE_6_DOWNLOADS | ran | 8.1s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 1.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.4s | deck_cards=55; kb_entries=7864; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786630819 |
| PHASE_9C_OWEM_CLUSTER | ran | 1.1s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 1.2s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 5.2s | data_sources_routed=0 |
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 2.9s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 0.7s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 16.1s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 28.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7871 → 7871 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7871 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 8.1s | iwm_records=0; kb_entries_added=0; exit_code=0 |
