...
**Run ID**: eat_all_1786549827
**Finished**: 2026-08-12T15:50:27.289574+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5808 |
...
| PHASE_5_HONEY | ran | 0.8s | exit_code=0; events=3276 |
| PHASE_6_DOWNLOADS | ran | 3.7s | exit_code=0; files_mined=239 |
| PHASE_7_PORTAL | ran | 1.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.5s | deck_cards=55; kb_entries=5808; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 3.4s | clans_routed=0; swarm_id=owem-clans-1786549818 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5815 → 5815 entries (+0 new, dedup by normalized question)
