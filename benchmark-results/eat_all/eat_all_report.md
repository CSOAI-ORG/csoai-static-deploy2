...
**Run ID**: eat_all_1786590921
**Finished**: 2026-08-13T03:15:21.313630+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6905 |
...
| PHASE_5_HONEY | ran | 1.4s | exit_code=0; events=3736 |
| PHASE_6_DOWNLOADS | ran | 3.3s | exit_code=0; files_mined=243 |
| PHASE_7_PORTAL | ran | 1.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.3s | deck_cards=55; kb_entries=6905; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.9s | clans_routed=0; swarm_id=owem-clans-1786590911 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 6912 → 6912 entries (+0 new, dedup by normalized question)
