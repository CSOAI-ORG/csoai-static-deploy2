...
**Run ID**: eat_all_1786705431
**Finished**: 2026-08-14T11:03:51.978479+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 10.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8905 |
| PHASE_1_REBOARD | ran | 5.3s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 18.2s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 24.8s | exit_code=0; events=4556 |
| PHASE_6_DOWNLOADS | failed | 32.1s | (no error message) |
| PHASE_7_PORTAL | ran | 33.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 11.7s | deck_cards=55; kb_entries=8905; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 6.0s | clans_routed=0; swarm_id=owem-clans-1786705349 |
| PHASE_9C_OWEM_CLUSTER | ran | 5.4s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 5.8s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 4.9s | data_sources_routed=0 |
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 4.0s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 5.6s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 31.7s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 22.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 9 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8912 → 8912 entries (+0 new, dedup by normalized question)
