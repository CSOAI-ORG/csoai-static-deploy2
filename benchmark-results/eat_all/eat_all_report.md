...
**Run ID**: eat_all_1786594539
**Finished**: 2026-08-13T04:15:39.663058+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7001 |
...
| PHASE_5_HONEY | ran | 7.0s | exit_code=0; events=3796 |
| PHASE_6_DOWNLOADS | failed | 5.7s | (no error message) |
| PHASE_7_PORTAL | ran | 2.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.8s | deck_cards=55; kb_entries=7001; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786594524 |
...
| PHASE_9I_SOV_CAPTURE | ran | 6.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7008 → 7008 entries (+0 new, dedup by normalized question)
