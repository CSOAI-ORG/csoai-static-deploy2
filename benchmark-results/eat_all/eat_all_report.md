...
**Run ID**: eat_all_1786404909
**Finished**: 2026-08-10T23:35:09.126326+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=3092 |
...
| PHASE_9_ARTIFACTS | ran | 0.1s | deck_cards=54; kb_entries=3092; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786404907 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 3099 → 3099 entries (+0 new, dedup by normalized question)
