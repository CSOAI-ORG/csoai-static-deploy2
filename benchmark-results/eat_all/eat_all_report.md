...
**Run ID**: eat_all_1786520128
**Finished**: 2026-08-12T07:35:28.791176+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5093 |
...
| PHASE_5_HONEY | ran | 2.9s | exit_code=0; events=3013 |
| PHASE_6_DOWNLOADS | ran | 2.8s | exit_code=0; files_mined=224 |
| PHASE_7_PORTAL | ran | 2.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.4s | deck_cards=54; kb_entries=5093; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786520118 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5100 → 5100 entries (+0 new, dedup by normalized question)
