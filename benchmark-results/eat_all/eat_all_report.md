...
**Run ID**: eat_all_1786200150
**Finished**: 2026-08-08T14:42:30.157313+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.4s | sov_local_status=unreachable: timed out; ollama_models=3; kb_entries=3398 |
...
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786200011 |
...
| PHASE_9I_SOV_CAPTURE | ran | 137.4s | events_processed=0; skills_extracted=1; refine_output=KB Refinery — processing today's capture events...
  terminal: 500 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 3405 → 3905 entries (+500 new)
