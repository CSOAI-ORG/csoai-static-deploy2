...
**Run ID**: eat_all_1786623029
**Finished**: 2026-08-13T12:10:29.992949+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7743 |
...
| PHASE_6_DOWNLOADS | ran | 2.7s | exit_code=0; files_mined=268 |
| PHASE_7_PORTAL | ran | 1.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.0s | deck_cards=55; kb_entries=7743; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786623021 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7750 → 7750 entries (+0 new, dedup by normalized question)
