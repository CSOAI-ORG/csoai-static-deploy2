...
**Run ID**: eat_all_1786458942
**Finished**: 2026-08-11T14:35:42.894787+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.6s | sov_local_status=unreachable: HTTP Error 404: Not Found; ollama_models=2; kb_entries=4508 |
...
| PHASE_5_HONEY | ran | 3.9s | exit_code=0; events=2753 |
| PHASE_6_DOWNLOADS | failed | 8.4s | (no error message) |
| PHASE_7_PORTAL | ran | 4.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.9s | deck_cards=54; kb_entries=4508; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.1s | clans_routed=0; swarm_id=owem-clans-1786458926 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 3.3s | kb_entries_added=7; exit_code=0 |
