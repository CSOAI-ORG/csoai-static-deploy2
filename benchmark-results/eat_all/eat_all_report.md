...
**Run ID**: eat_all_1786707630
**Finished**: 2026-08-14T11:40:30.447257+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8969 |
...
| PHASE_5_HONEY | ran | 2.7s | exit_code=0; events=4576 |
| PHASE_6_DOWNLOADS | ran | 2.8s | exit_code=0; files_mined=288 |
| PHASE_7_PORTAL | ran | 1.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.7s | deck_cards=55; kb_entries=8969; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786707620 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8976 → 8976 entries (+0 new, dedup by normalized question)
