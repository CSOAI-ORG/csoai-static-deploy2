...
**Run ID**: eat_all_1786608340
**Finished**: 2026-08-13T08:05:40.078845+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 8.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7361 |
| PHASE_1_REBOARD | ran | 4.3s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 5.7s | exit_code=0; events=3936 |
| PHASE_6_DOWNLOADS | ran | 0.9s | exit_code=0; files_mined=265 |
| PHASE_7_PORTAL | ran | 0.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.8s | deck_cards=55; kb_entries=7361; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786608333 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7368 → 7368 entries (+0 new, dedup by normalized question)
