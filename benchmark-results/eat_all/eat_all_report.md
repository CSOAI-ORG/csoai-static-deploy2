...
**Run ID**: eat_all_1786513863
**Finished**: 2026-08-12T05:51:03.301826+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4933 |
...
| PHASE_5_HONEY | ran | 0.6s | exit_code=0; events=2933 |
| PHASE_6_DOWNLOADS | failed | 5.5s | (no error message) |
| PHASE_7_PORTAL | ran | 2.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.7s | deck_cards=54; kb_entries=4933; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.2s | clans_routed=0; swarm_id=owem-clans-1786513815 |
...
| PHASE_9I_SOV_CAPTURE | ran | 23.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 4940 → 4940 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 4940 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 11.2s | iwm_records=0; kb_entries_added=0; exit_code=0 |
