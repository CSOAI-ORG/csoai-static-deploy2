...
**Run ID**: eat_all_1786539046
**Finished**: 2026-08-12T12:50:46.501897+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5600 |
...
| PHASE_5_HONEY | ran | 1.7s | exit_code=0; events=3193 |
| PHASE_6_DOWNLOADS | ran | 5.4s | exit_code=0; files_mined=233 |
| PHASE_7_PORTAL | ran | 2.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.3s | deck_cards=55; kb_entries=5600; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786539019 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 8.0s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 9.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5607 → 5607 entries (+0 new, dedup by normalized question)
