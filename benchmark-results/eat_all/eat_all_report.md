...
**Run ID**: eat_all_1786600237
**Finished**: 2026-08-13T05:50:37.738570+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7153 |
...
| PHASE_5_HONEY | ran | 4.7s | exit_code=0; events=3836 |
| PHASE_6_DOWNLOADS | ran | 1.5s | exit_code=0; files_mined=255 |
| PHASE_7_PORTAL | ran | 3.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=55; kb_entries=7153; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786600227 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7160 → 7160 entries (+0 new, dedup by normalized question)
