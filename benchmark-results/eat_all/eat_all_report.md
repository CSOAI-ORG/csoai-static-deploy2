...
**Run ID**: eat_all_1786465815
**Finished**: 2026-08-11T16:30:15.134240+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4628 |
...
| PHASE_6_DOWNLOADS | ran | 3.1s | exit_code=0; files_mined=217 |
| PHASE_7_PORTAL | ran | 0.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.7s | deck_cards=54; kb_entries=4628; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786465809 |
