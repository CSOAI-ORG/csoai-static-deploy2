...
**Run ID**: eat_all_1786362008
**Finished**: 2026-08-10T11:40:08.667761+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=1965 |
...
| PHASE_5_HONEY | ran | 0.2s | exit_code=0; events=1693 |
| PHASE_6_DOWNLOADS | failed | 5.6s | (no error message) |
| PHASE_7_PORTAL | ran | 0.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.1s | deck_cards=54; kb_entries=1965; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786362007 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 1972 → 1972 entries (+0 new, dedup by normalized question)
