...
**Run ID**: eat_all_1786531535
**Finished**: 2026-08-12T10:45:35.208844+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5397 |
...
| PHASE_5_HONEY | ran | 4.4s | exit_code=0; events=3133 |
| PHASE_6_DOWNLOADS | ran | 2.9s | exit_code=0; files_mined=228 |
| PHASE_7_PORTAL | ran | 3.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 4.3s | deck_cards=54; kb_entries=5397; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.3s | clans_routed=0; swarm_id=owem-clans-1786531524 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 5.2s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 2.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5404 → 5404 entries (+0 new, dedup by normalized question)
