...
**Run ID**: eat_all_1786543819
**Finished**: 2026-08-12T14:10:19.996504+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5720 |
...
| PHASE_6_DOWNLOADS | ran | 1.3s | exit_code=0; files_mined=237 |
| PHASE_7_PORTAL | ran | 1.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.5s | deck_cards=55; kb_entries=5720; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786543810 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5727 → 5727 entries (+0 new, dedup by normalized question)
