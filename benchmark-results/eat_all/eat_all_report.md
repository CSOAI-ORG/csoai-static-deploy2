...
**Run ID**: eat_all_1786692944
**Finished**: 2026-08-14T07:35:44.029011+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8592 |
...
| PHASE_5_HONEY | ran | 1.3s | exit_code=0; events=4416 |
| PHASE_6_DOWNLOADS | failed | 6.4s | (no error message) |
| PHASE_7_PORTAL | ran | 3.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.6s | deck_cards=55; kb_entries=8592; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786692920 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8599 → 8599 entries (+0 new, dedup by normalized question)
