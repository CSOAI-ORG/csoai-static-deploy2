...
**Run ID**: eat_all_1786513222
**Finished**: 2026-08-12T05:40:22.049865+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4917 |
...
| PHASE_9_ARTIFACTS | ran | 1.9s | deck_cards=54; kb_entries=4917; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.9s | clans_routed=0; swarm_id=owem-clans-1786513216 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 4924 → 4924 entries (+0 new, dedup by normalized question)
