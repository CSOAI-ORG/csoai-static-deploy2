...
**Run ID**: eat_all_1786642827
**Finished**: 2026-08-13T17:40:27.938780+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7994 |
...
| PHASE_5_HONEY | ran | 1.3s | exit_code=0; events=4176 |
| PHASE_6_DOWNLOADS | ran | 2.1s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 2.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.0s | deck_cards=55; kb_entries=7994; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786642812 |
...
| PHASE_9I_SOV_CAPTURE | ran | 6.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8001 → 8001 entries (+0 new, dedup by normalized question)
