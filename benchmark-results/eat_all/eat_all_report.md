...
**Run ID**: eat_all_1786598142
**Finished**: 2026-08-13T05:15:42.885093+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 7.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7097 |
...
| PHASE_5_HONEY | ran | 4.1s | exit_code=0; events=3816 |
| PHASE_6_DOWNLOADS | failed | 6.8s | (no error message) |
| PHASE_7_PORTAL | ran | 2.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.3s | deck_cards=55; kb_entries=7097; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786598133 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7104 → 7104 entries (+0 new, dedup by normalized question)
