...
**Run ID**: eat_all_1786549561
**Finished**: 2026-08-12T15:46:01.142958+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5800 |
...
| PHASE_5_HONEY | ran | 1.4s | exit_code=0; events=3276 |
| PHASE_6_DOWNLOADS | ran | 4.8s | exit_code=0; files_mined=239 |
| PHASE_7_PORTAL | ran | 1.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.7s | deck_cards=55; kb_entries=5800; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786549511 |
...
| PHASE_9I_SOV_CAPTURE | ran | 38.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 6 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5807 → 5807 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 5807 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 6.0s | iwm_records=0; kb_entries_added=0; exit_code=0 |
