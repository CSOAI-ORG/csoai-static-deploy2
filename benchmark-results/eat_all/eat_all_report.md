...
**Run ID**: eat_all_1786602395
**Finished**: 2026-08-13T06:26:35.252913+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7209 |
...
| PHASE_5_HONEY | ran | 10.9s | exit_code=0; events=3856 |
| PHASE_6_DOWNLOADS | ran | 10.5s | exit_code=0; files_mined=261 |
| PHASE_7_PORTAL | ran | 16.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 6.9s | deck_cards=55; kb_entries=7209; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.1s | clans_routed=0; swarm_id=owem-clans-1786602365 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 6.4s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 18.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7216 → 7216 entries (+0 new, dedup by normalized question)
