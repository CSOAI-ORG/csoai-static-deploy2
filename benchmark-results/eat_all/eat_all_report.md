...
**Run ID**: eat_all_1786619507
**Finished**: 2026-08-13T11:11:47.188025+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 16.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7645 |
| PHASE_1_REBOARD | ran | 7.6s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 4.1s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 11.1s | exit_code=0; events=4036 |
| PHASE_6_DOWNLOADS | ran | 9.8s | exit_code=0; files_mined=266 |
| PHASE_7_PORTAL | ran | 8.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 4.9s | deck_cards=55; kb_entries=7645; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.7s | clans_routed=0; swarm_id=owem-clans-1786619472 |
| PHASE_9C_OWEM_CLUSTER | ran | 2.1s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 1.3s | benchmarks_routed=0 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 8.1s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 6.9s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7652 → 7655 entries (+3 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7655 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 3.2s | iwm_records=0; kb_entries_added=0; exit_code=0 |
| PHASE_10B_MODEL_ROUTING | ran | 4.2s | models_routed=0; specs_routed=1 |
