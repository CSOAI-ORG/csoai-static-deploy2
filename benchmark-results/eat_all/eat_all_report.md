...
**Run ID**: eat_all_1786451413
**Finished**: 2026-08-11T12:30:13.904264+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | sov_local_status=unreachable: HTTP Error 404: Not Found; ollama_models=2; kb_entries=4316 |
...
| PHASE_5_HONEY | ran | 0.6s | exit_code=0; events=2693 |
| PHASE_6_DOWNLOADS | failed | 5.8s | (no error message) |
| PHASE_7_PORTAL | ran | 2.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.2s | deck_cards=54; kb_entries=4316; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786451411 |
