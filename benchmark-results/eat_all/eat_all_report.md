...
**Run ID**: eat_all_1786268704
**Finished**: 2026-08-09T09:45:04.850048+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.2s | souls=0; ollama_models=2; kb_entries=570 |
...
| PHASE_5_HONEY | ran | 0.2s | exit_code=0; events=1152 |
| PHASE_6_DOWNLOADS | ran | 0.1s | exit_code=0; files_mined=164 |
| PHASE_7_PORTAL | ran | 0.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.5s | deck_cards=54 |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786268704 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 4 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 577 → 577 entries (+0 new, dedup by normalized question)
