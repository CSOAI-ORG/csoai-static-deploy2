...
**Run ID**: eat_all_1786521340
**Finished**: 2026-08-12T07:55:40.012856+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5125 |
...
| PHASE_5_HONEY | ran | 4.5s | exit_code=0; events=3013 |
| PHASE_6_DOWNLOADS | ran | 6.0s | exit_code=0; files_mined=226 |
| PHASE_7_PORTAL | ran | 3.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.0s | deck_cards=54; kb_entries=5125; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786521322 |
...
| PHASE_9I_SOV_CAPTURE | ran | 8.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5132 → 5132 entries (+0 new, dedup by normalized question)
