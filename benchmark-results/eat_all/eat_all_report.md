...
**Run ID**: eat_all_1786366209
**Finished**: 2026-08-10T12:50:09.811778+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=2068 |
...
| PHASE_9_ARTIFACTS | ran | 0.1s | deck_cards=54; kb_entries=2068; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786366207 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 2075 → 2075 entries (+0 new, dedup by normalized question)
