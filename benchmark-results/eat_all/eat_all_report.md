...
**Run ID**: eat_all_1786680316
**Finished**: 2026-08-14T04:05:16.650151+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8275 |
...
| PHASE_5_HONEY | ran | 1.7s | exit_code=0; events=4296 |
| PHASE_6_DOWNLOADS | ran | 2.6s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 1.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.6s | deck_cards=55; kb_entries=8275; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786680310 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8282 → 8282 entries (+0 new, dedup by normalized question)
