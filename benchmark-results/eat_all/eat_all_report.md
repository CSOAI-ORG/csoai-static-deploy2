...
**Run ID**: eat_all_1786616706
**Finished**: 2026-08-13T10:25:06.975636+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7572 |
...
| PHASE_9_ARTIFACTS | ran | 0.4s | deck_cards=55; kb_entries=7572; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786616703 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 0.5s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 1.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7579 → 7579 entries (+0 new, dedup by normalized question)
