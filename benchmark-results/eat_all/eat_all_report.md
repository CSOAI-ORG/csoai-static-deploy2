...
**Run ID**: eat_all_1786272002
**Finished**: 2026-08-09T10:40:02.381939+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.1s | souls=184; ollama_models=2; kb_entries=475 |
...
| PHASE_5_HONEY | ran | 0.2s | exit_code=0; events=1073 |
| PHASE_6_DOWNLOADS | ran | 0.1s | exit_code=0; files_mined=164 |
| PHASE_7_PORTAL | ran | 0.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.0s | deck_cards=54; kb_entries=475; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786272001 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 482 → 482 entries (+0 new, dedup by normalized question)
