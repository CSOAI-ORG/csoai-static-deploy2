...
**Run ID**: eat_all_1786599032
**Finished**: 2026-08-13T05:30:32.919842+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7121 |
...
| PHASE_5_HONEY | ran | 3.6s | exit_code=0; events=3836 |
| PHASE_6_DOWNLOADS | failed | 8.7s | (no error message) |
| PHASE_7_PORTAL | ran | 1.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.1s | deck_cards=55; kb_entries=7121; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.1s | clans_routed=0; swarm_id=owem-clans-1786599024 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7128 → 7128 entries (+0 new, dedup by normalized question)
