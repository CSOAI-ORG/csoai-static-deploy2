...
**Run ID**: eat_all_1786609517
**Finished**: 2026-08-13T08:25:17.422014+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7393 |
...
| PHASE_5_HONEY | ran | 1.8s | exit_code=0; events=3936 |
| PHASE_6_DOWNLOADS | ran | 0.8s | exit_code=0; files_mined=266 |
| PHASE_7_PORTAL | ran | 1.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.9s | deck_cards=55; kb_entries=7393; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786609511 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7400 → 7400 entries (+0 new, dedup by normalized question)
