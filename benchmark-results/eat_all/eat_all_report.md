...
**Run ID**: eat_all_1786766144
**Finished**: 2026-08-15T03:55:44.124076+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=9329 |
...
| PHASE_5_HONEY | ran | 2.9s | exit_code=0; events=4896 |
| PHASE_6_DOWNLOADS | ran | 0.7s | exit_code=0; files_mined=298 |
| PHASE_7_PORTAL | ran | 0.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.4s | deck_cards=55; kb_entries=9329; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.0s | clans_routed=0; swarm_id=owem-clans-1786766114 |
| PHASE_9C_OWEM_CLUSTER | ran | 0.8s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 0.9s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 3.7s | data_sources_routed=0 |
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 7.4s | stages_routed=0 |
