...
**Run ID**: eat_all_1786376108
**Finished**: 2026-08-10T15:35:08.752565+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=2332 |
...
| PHASE_9_ARTIFACTS | ran | 0.1s | deck_cards=54; kb_entries=2332; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786376107 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 2339 → 2339 entries (+0 new, dedup by normalized question)
