...
**Run ID**: eat_all_1786733618
**Finished**: 2026-08-14T18:53:38.684595+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | failed | 10.4s | JSONDecodeError: Extra data: line 298535 column 2 (char 12816009) |
| PHASE_1_REBOARD | ran | 4.3s | exit_code=0 |
| PHASE_2_KB_GROW | failed | 3.3s | ts-to-kb.py", line 196, in main
...
| PHASE_5_HONEY | ran | 4.6s | exit_code=0; events=4776 |
| PHASE_6_DOWNLOADS | failed | 6.2s | (no error message) |
| PHASE_7_PORTAL | ran | 3.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 97.5s | deck_cards=0 |
| PHASE_9B_EXTERNAL_HARNESS | failed | 0.3s | Extra data: line 298535 column 2 (char 12816009) |
| PHASE_9C_OWEM_CLUSTER | failed | 0.6s | Extra data: line 298535 column 2 (char 12816009) |
| PHASE_9D_BENCHMARKS_HARNESS | failed | 1.2s | Extra data: line 298535 column 2 (char 12816009) |
| PHASE_9E_TRAINING_DATA_HARNESS | failed | 0.3s | Extra data: line 298535 column 2 (char 12816009) |
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | failed | 0.4s | Extra data: line 298535 column 2 (char 12816009) |
...
| PHASE_9J_IWM_BOOTSTRAP | ran | 0.8s | iwm_records=0; kb_entries_added=0; exit_code=1 |
| PHASE_10B_MODEL_ROUTING | failed | 2.0s | Extra data: line 298535 column 2 (char 12816009) |
