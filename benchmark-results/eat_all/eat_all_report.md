...
**Run ID**: eat_all_1786619169
**Finished**: 2026-08-13T11:06:09.464957+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7636 |
...
| PHASE_5_HONEY | ran | 7.7s | exit_code=0; events=4036 |
| PHASE_6_DOWNLOADS | ran | 4.6s | exit_code=0; files_mined=266 |
| PHASE_7_PORTAL | ran | 3.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 5.5s | deck_cards=55; kb_entries=7636; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.2s | clans_routed=0; swarm_id=owem-clans-1786619138 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 7.8s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 8.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7643 → 7644 entries (+1 new, dedup by normalized question)
