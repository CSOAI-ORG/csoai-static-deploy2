...
**Run ID**: eat_all_1786621345
**Finished**: 2026-08-13T11:42:25.832759+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 19.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7695 |
| PHASE_1_REBOARD | ran | 14.0s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 6.0s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 17.0s | exit_code=0; events=4056 |
| PHASE_6_DOWNLOADS | ran | 10.7s | exit_code=0; files_mined=268 |
| PHASE_7_PORTAL | ran | 8.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.9s | deck_cards=55; kb_entries=7695; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.6s | clans_routed=0; swarm_id=owem-clans-1786621293 |
| PHASE_9C_OWEM_CLUSTER | ran | 2.5s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 3.0s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 4.6s | data_sources_routed=0 |
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 2.8s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 4.3s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 12.4s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 16.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7702 → 7702 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7702 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 3.8s | iwm_records=0; kb_entries_added=0; exit_code=0 |
