...
**Run ID**: eat_all_1786696237
**Finished**: 2026-08-14T08:30:37.219905+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8682 |
...
| PHASE_5_HONEY | ran | 2.6s | exit_code=0; events=4456 |
| PHASE_6_DOWNLOADS | ran | 3.8s | exit_code=0; files_mined=274 |
| PHASE_7_PORTAL | ran | 5.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.4s | deck_cards=55; kb_entries=8682; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.6s | clans_routed=0; swarm_id=owem-clans-1786696223 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8689 → 8689 entries (+0 new, dedup by normalized question)
