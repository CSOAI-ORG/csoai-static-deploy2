...
**Run ID**: eat_all_1786598726
**Finished**: 2026-08-13T05:25:26.292856+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7113 |
...
| PHASE_5_HONEY | ran | 0.7s | exit_code=0; events=3836 |
| PHASE_6_DOWNLOADS | failed | 6.0s | (no error message) |
| PHASE_7_PORTAL | ran | 1.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=55; kb_entries=7113; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786598713 |
...
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 1.0s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 0.5s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 2.9s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 2.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7120 → 7120 entries (+0 new, dedup by normalized question)
