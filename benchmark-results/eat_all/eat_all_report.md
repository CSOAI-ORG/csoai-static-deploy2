...
**Run ID**: eat_all_1786695930
**Finished**: 2026-08-14T08:25:30.423529+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 5.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8674 |
...
| PHASE_5_HONEY | ran | 2.3s | exit_code=0; events=4456 |
| PHASE_6_DOWNLOADS | ran | 1.5s | exit_code=0; files_mined=274 |
| PHASE_7_PORTAL | ran | 0.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.4s | deck_cards=55; kb_entries=8674; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786695917 |
| PHASE_9C_OWEM_CLUSTER | ran | 0.7s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 0.5s | benchmarks_routed=0 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 9 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8681 → 8681 entries (+0 new, dedup by normalized question)
