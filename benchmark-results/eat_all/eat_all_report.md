...
**Run ID**: eat_all_1786629449
**Finished**: 2026-08-13T13:57:29.985384+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 21.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7839 |
| PHASE_1_REBOARD | ran | 2.2s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 0.7s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 2.8s | exit_code=0; events=4096 |
| PHASE_6_DOWNLOADS | ran | 15.8s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 11.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 5.9s | deck_cards=55; kb_entries=7839; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.1s | clans_routed=0; swarm_id=owem-clans-1786629369 |
...
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 10.2s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 3.2s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 23.3s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 23.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7846 → 7846 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7846 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 3.6s | iwm_records=0; kb_entries_added=0; exit_code=0 |
| PHASE_10B_MODEL_ROUTING | ran | 8.6s | models_routed=0; specs_routed=1 |
