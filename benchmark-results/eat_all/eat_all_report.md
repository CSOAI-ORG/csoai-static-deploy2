...
**Run ID**: eat_all_1786727114
**Finished**: 2026-08-14T17:05:14.802157+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | failed | 1.7s | JSONDecodeError: Extra data: line 298535 column 2 (char 12816009) |
| PHASE_1_REBOARD | ran | 0.4s | exit_code=0 |
| PHASE_2_KB_GROW | failed | 1.1s | ts-to-kb.py", line 196, in main
...
| PHASE_5_HONEY | ran | 1.1s | exit_code=0; events=4716 |
| PHASE_6_DOWNLOADS | ran | 0.6s | exit_code=0; files_mined=294 |
| PHASE_7_PORTAL | ran | 0.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.1s | deck_cards=0 |
...
| PHASE_9G_AUDIENCE_HARNESS | failed | 0.6s | Extra data: line 298535 column 2 (char 12816009) |
| PHASE_9H_SOV_HIVE_HARNESS | failed | 0.3s | Extra data: line 298535 column 2 (char 12816009) |
| PHASE_9I_SOV_CAPTURE | ran | 3.1s | events_processed=0; skills_extracted=0 |
