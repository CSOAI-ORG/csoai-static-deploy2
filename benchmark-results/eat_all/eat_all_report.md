...
**Run ID**: eat_all_1786342214
**Finished**: 2026-08-10T06:10:14.977067+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=1435 |
...
| PHASE_6_DOWNLOADS | ran | 1.7s | exit_code=0; files_mined=169 |
| PHASE_7_PORTAL | ran | 0.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.1s | deck_cards=54; kb_entries=1435; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786342213 |
