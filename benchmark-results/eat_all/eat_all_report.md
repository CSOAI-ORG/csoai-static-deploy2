...
**Run ID**: eat_all_1786516823
**Finished**: 2026-08-12T06:40:23.101364+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5013 |
...
| PHASE_5_HONEY | ran | 0.8s | exit_code=0; events=2973 |
| PHASE_6_DOWNLOADS | failed | 6.0s | (no error message) |
| PHASE_7_PORTAL | ran | 1.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.8s | deck_cards=54; kb_entries=5013; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.3s | clans_routed=0; swarm_id=owem-clans-1786516817 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5020 → 5020 entries (+0 new, dedup by normalized question)
