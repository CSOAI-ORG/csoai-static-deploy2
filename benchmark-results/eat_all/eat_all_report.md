...
**Run ID**: eat_all_1786468219
**Finished**: 2026-08-11T17:10:19.024298+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4692 |
...
| PHASE_5_HONEY | ran | 0.8s | exit_code=0; events=2853 |
| PHASE_6_DOWNLOADS | ran | 1.6s | exit_code=0; files_mined=218 |
| PHASE_7_PORTAL | ran | 1.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.5s | deck_cards=54; kb_entries=4692; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786468209 |
