...
**Run ID**: eat_all_1786544766
**Finished**: 2026-08-12T14:26:06.843075+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5744 |
| PHASE_1_REBOARD | ran | 6.5s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 3.6s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 8.2s | exit_code=0; events=3256 |
| PHASE_6_DOWNLOADS | failed | 12.7s | (no error message) |
| PHASE_7_PORTAL | ran | 13.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.8s | deck_cards=55; kb_entries=5744; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.2s | clans_routed=0; swarm_id=owem-clans-1786544752 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 6 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5751 → 5751 entries (+0 new, dedup by normalized question)
