...
**Run ID**: eat_all_1786538467
**Finished**: 2026-08-12T12:41:07.688451+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5584 |
...
| PHASE_5_HONEY | ran | 7.1s | exit_code=0; events=3193 |
| PHASE_6_DOWNLOADS | ran | 9.1s | exit_code=0; files_mined=233 |
| PHASE_7_PORTAL | ran | 6.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 4.7s | deck_cards=55; kb_entries=5584; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.6s | clans_routed=0; swarm_id=owem-clans-1786538440 |
...
| PHASE_9I_SOV_CAPTURE | ran | 6.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 5 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5591 → 5591 entries (+0 new, dedup by normalized question)
