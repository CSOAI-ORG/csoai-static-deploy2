...
**Run ID**: eat_all_1786275636
**Finished**: 2026-08-09T11:40:36.280149+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.6s | souls=184; ollama_models=2; kb_entries=571 |
...
| PHASE_5_HONEY | ran | 1.8s | exit_code=0; events=1113 |
| PHASE_6_DOWNLOADS | ran | 2.6s | exit_code=0; files_mined=165 |
| PHASE_7_PORTAL | ran | 3.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.1s | deck_cards=54; kb_entries=571; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786275617 |
...
| PHASE_9I_SOV_CAPTURE | ran | 8.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 578 → 578 entries (+0 new, dedup by normalized question)
