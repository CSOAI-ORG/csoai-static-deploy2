...
**Run ID**: eat_all_1786539933
**Finished**: 2026-08-12T13:05:33.584181+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5624 |
| PHASE_1_REBOARD | ran | 2.3s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 2.4s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 2.9s | exit_code=0; events=3213 |
| PHASE_6_DOWNLOADS | ran | 1.9s | exit_code=0; files_mined=233 |
| PHASE_7_PORTAL | ran | 2.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.7s | deck_cards=55; kb_entries=5624; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.1s | clans_routed=0; swarm_id=owem-clans-1786539918 |
...
| PHASE_9I_SOV_CAPTURE | ran | 6.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5631 → 5631 entries (+0 new, dedup by normalized question)
