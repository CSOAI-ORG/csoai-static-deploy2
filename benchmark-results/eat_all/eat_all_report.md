...
**Run ID**: eat_all_1786551828
**Finished**: 2026-08-12T16:23:48.555270+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 31.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=5848 |
| PHASE_1_REBOARD | ran | 9.8s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 42.4s | exit_code=0; events=3296 |
| PHASE_6_DOWNLOADS | ran | 12.7s | exit_code=0; files_mined=240 |
| PHASE_7_PORTAL | ran | 10.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 7.2s | deck_cards=55; kb_entries=5856; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.1s | clans_routed=0; swarm_id=owem-clans-1786551782 |
| PHASE_9C_OWEM_CLUSTER | ran | 1.9s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 3.3s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 2.6s | data_sources_routed=0 |
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 3.9s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 3.9s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 9.3s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 15.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 6 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5863 → 5863 entries (+0 new, dedup by normalized question)
