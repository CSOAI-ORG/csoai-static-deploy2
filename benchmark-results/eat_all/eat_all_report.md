...
**Run ID**: eat_all_1786526415
**Finished**: 2026-08-12T09:20:15.689348+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5261 |
...
| PHASE_5_HONEY | ran | 0.7s | exit_code=0; events=3073 |
| PHASE_6_DOWNLOADS | ran | 1.0s | exit_code=0; files_mined=226 |
| PHASE_7_PORTAL | ran | 0.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.7s | deck_cards=54; kb_entries=5261; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786526406 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5268 → 5268 entries (+0 new, dedup by normalized question)
