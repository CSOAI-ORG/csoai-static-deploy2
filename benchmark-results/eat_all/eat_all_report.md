...
**Run ID**: eat_all_1786422907
**Finished**: 2026-08-11T04:35:07.379524+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=3564 |
...
| PHASE_5_HONEY | ran | 0.9s | exit_code=0; events=2353 |
| PHASE_6_DOWNLOADS | ran | 0.9s | exit_code=0; files_mined=189 |
| PHASE_7_PORTAL | ran | 1.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.3s | deck_cards=54; kb_entries=3564; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786422905 |
