...
**Run ID**: eat_all_1786606281
**Finished**: 2026-08-13T07:31:21.767007+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 9.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7313 |
| PHASE_1_REBOARD | ran | 8.7s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 6.8s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 10.8s | exit_code=0; events=3896 |
| PHASE_6_DOWNLOADS | failed | 8.6s | (no error message) |
| PHASE_7_PORTAL | ran | 1.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.3s | deck_cards=55; kb_entries=7313; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786606266 |
| PHASE_9C_OWEM_CLUSTER | ran | 0.8s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 5.3s | benchmarks_routed=0 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7320 → 7320 entries (+0 new, dedup by normalized question)
