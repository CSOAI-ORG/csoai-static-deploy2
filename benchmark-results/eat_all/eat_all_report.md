...
**Run ID**: eat_all_1786602925
**Finished**: 2026-08-13T06:35:25.022222+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7225 |
...
| PHASE_6_DOWNLOADS | ran | 3.8s | exit_code=0; files_mined=261 |
| PHASE_7_PORTAL | ran | 3.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.3s | deck_cards=55; kb_entries=7225; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.5s | clans_routed=0; swarm_id=owem-clans-1786602918 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 1.5s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 2.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7232 → 7232 entries (+0 new, dedup by normalized question)
