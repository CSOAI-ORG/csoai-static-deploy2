...
**Run ID**: eat_all_1786535274
**Finished**: 2026-08-12T11:47:54.630996+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 29.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=5494 |
| PHASE_1_REBOARD | ran | 27.2s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 25.8s | exit_code=0; events=3153 |
| PHASE_6_DOWNLOADS | failed | 10.0s | (no error message) |
| PHASE_7_PORTAL | ran | 21.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 4.0s | deck_cards=55; kb_entries=5494; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786535242 |
...
| PHASE_9I_SOV_CAPTURE | ran | 11.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5501 → 5501 entries (+0 new, dedup by normalized question)
