...
**Run ID**: eat_all_1786702820
**Finished**: 2026-08-14T10:20:20.072502+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8842 |
...
| PHASE_5_HONEY | ran | 0.5s | exit_code=0; events=4536 |
| PHASE_6_DOWNLOADS | ran | 4.8s | exit_code=0; files_mined=284 |
| PHASE_7_PORTAL | ran | 1.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.0s | deck_cards=55; kb_entries=8842; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786702811 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 2.1s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 3.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 9 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8849 → 8849 entries (+0 new, dedup by normalized question)
