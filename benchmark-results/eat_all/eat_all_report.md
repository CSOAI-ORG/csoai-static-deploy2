...
**Run ID**: eat_all_1786521614
**Finished**: 2026-08-12T08:00:14.316267+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5133 |
...
| PHASE_5_HONEY | ran | 1.0s | exit_code=0; events=3033 |
| PHASE_6_DOWNLOADS | ran | 0.4s | exit_code=0; files_mined=226 |
| PHASE_7_PORTAL | ran | 0.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.5s | deck_cards=54; kb_entries=5133; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786521608 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5140 → 5140 entries (+0 new, dedup by normalized question)
