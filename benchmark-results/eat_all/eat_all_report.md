...
**Run ID**: eat_all_1786277103
**Finished**: 2026-08-09T12:05:03.426643+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.9s | souls=184; ollama_models=2; kb_entries=611 |
...
| PHASE_6_DOWNLOADS | ran | 0.2s | exit_code=0; files_mined=167 |
| PHASE_7_PORTAL | ran | 0.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.0s | deck_cards=54; kb_entries=611; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786277102 |
