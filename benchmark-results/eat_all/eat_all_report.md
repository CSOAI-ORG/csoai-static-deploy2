...
**Run ID**: eat_all_1786550147
**Finished**: 2026-08-12T15:55:47.173058+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5816 |
...
| PHASE_5_HONEY | ran | 0.5s | exit_code=0; events=3276 |
| PHASE_6_DOWNLOADS | ran | 9.4s | exit_code=0; files_mined=239 |
| PHASE_7_PORTAL | ran | 4.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 8.7s | deck_cards=55; kb_entries=5816; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 4.7s | clans_routed=0; swarm_id=owem-clans-1786550132 |
| PHASE_9C_OWEM_CLUSTER | ran | 3.5s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 2.6s | benchmarks_routed=0 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5823 → 5823 entries (+0 new, dedup by normalized question)
