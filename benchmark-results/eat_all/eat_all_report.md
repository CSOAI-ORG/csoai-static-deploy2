...
**Run ID**: eat_all_1786701406
**Finished**: 2026-08-14T09:56:46.583429+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8802 |
| PHASE_1_REBOARD | ran | 6.1s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 11.9s | exit_code=0; events=4516 |
| PHASE_6_DOWNLOADS | ran | 11.5s | exit_code=0; files_mined=281 |
| PHASE_7_PORTAL | ran | 10.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 4.7s | deck_cards=55; kb_entries=8802; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 4.7s | clans_routed=0; swarm_id=owem-clans-1786701366 |
| PHASE_9C_OWEM_CLUSTER | ran | 3.9s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 5.0s | benchmarks_routed=0 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 8.7s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 8.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8809 → 8809 entries (+0 new, dedup by normalized question)
