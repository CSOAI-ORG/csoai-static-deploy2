...
**Run ID**: eat_all_1786466413
**Finished**: 2026-08-11T16:40:13.058047+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4644 |
...
| PHASE_5_HONEY | ran | 0.4s | exit_code=0; events=2833 |
| PHASE_6_DOWNLOADS | ran | 4.4s | exit_code=0; files_mined=217 |
| PHASE_7_PORTAL | ran | 0.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.6s | deck_cards=54; kb_entries=4644; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786466408 |
