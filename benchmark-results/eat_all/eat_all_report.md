...
**Run ID**: eat_all_1786271702
**Finished**: 2026-08-09T10:35:02.996748+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.1s | souls=184; ollama_models=2; kb_entries=467 |
...
| PHASE_9_ARTIFACTS | ran | 0.0s | deck_cards=54; kb_entries=467; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786271702 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 474 → 474 entries (+0 new, dedup by normalized question)
