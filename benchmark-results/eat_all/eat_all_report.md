...
**Run ID**: eat_all_1786461655
**Finished**: 2026-08-11T15:20:55.117474+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4532 |
...
| PHASE_5_HONEY | ran | 7.1s | exit_code=0; events=2773 |
| PHASE_6_DOWNLOADS | ran | 1.5s | exit_code=0; files_mined=209 |
| PHASE_7_PORTAL | ran | 2.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.3s | deck_cards=54; kb_entries=4532; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.2s | clans_routed=0; swarm_id=owem-clans-1786461651 |
