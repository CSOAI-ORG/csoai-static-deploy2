...
**Run ID**: eat_all_1786384568
**Finished**: 2026-08-10T17:56:08.375186+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 9.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=2548 |
...
| PHASE_5_HONEY | ran | 8.5s | exit_code=0; events=1913 |
| PHASE_6_DOWNLOADS | failed | 10.2s | (no error message) |
| PHASE_7_PORTAL | ran | 4.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.5s | deck_cards=54; kb_entries=2548; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.6s | clans_routed=0; swarm_id=owem-clans-1786384557 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 2555 → 2555 entries (+0 new, dedup by normalized question)
