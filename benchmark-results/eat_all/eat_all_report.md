...
**Run ID**: eat_all_1786457414
**Finished**: 2026-08-11T14:10:14.375317+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.9s | sov_local_status=unreachable: HTTP Error 404: Not Found; ollama_models=2; kb_entries=4468 |
...
| PHASE_5_HONEY | ran | 0.5s | exit_code=0; events=2753 |
| PHASE_6_DOWNLOADS | ran | 3.7s | exit_code=0; files_mined=205 |
| PHASE_7_PORTAL | ran | 1.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.7s | deck_cards=54; kb_entries=4468; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786457408 |
