...
**Run ID**: eat_all_1786532107
**Finished**: 2026-08-12T10:55:07.185153+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5413 |
...
| PHASE_5_HONEY | ran | 0.5s | exit_code=0; events=3133 |
| PHASE_6_DOWNLOADS | ran | 0.3s | exit_code=0; files_mined=228 |
| PHASE_7_PORTAL | ran | 0.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.3s | deck_cards=54; kb_entries=5413; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786532104 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5420 → 5420 entries (+0 new, dedup by normalized question)
