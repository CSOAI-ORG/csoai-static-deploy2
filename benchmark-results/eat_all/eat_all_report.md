...
**Run ID**: eat_all_1786430714
**Finished**: 2026-08-11T06:45:14.354630+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.3s | sov_local_status=unreachable: timed out; ollama_models=2; kb_entries=3772 |
...
| PHASE_5_HONEY | ran | 0.4s | exit_code=0; events=2433 |
| PHASE_6_DOWNLOADS | failed | 5.5s | (no error message) |
| PHASE_7_PORTAL | ran | 0.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.3s | deck_cards=54; kb_entries=3772; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786430712 |
