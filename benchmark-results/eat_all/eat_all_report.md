...
**Run ID**: eat_all_1786467461
**Finished**: 2026-08-11T16:57:41.684014+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 30.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=4668 |
| PHASE_1_REBOARD | ran | 38.2s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 22.7s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 19.9s | exit_code=0; events=2833 |
| PHASE_6_DOWNLOADS | failed | 15.4s | (no error message) |
| PHASE_7_PORTAL | ran | 10.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.8s | deck_cards=54; kb_entries=4668; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786467453 |
