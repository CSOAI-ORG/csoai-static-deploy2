...
**Run ID**: eat_all_1786252511
**Finished**: 2026-08-09T05:15:11.432691+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.2s | souls=0; ollama_models=4; kb_entries=118 |
...
| PHASE_5_HONEY | ran | 0.3s | exit_code=0; events=664 |
| PHASE_6_DOWNLOADS | ran | 6.1s | exit_code=1; files_mined=158 |
| PHASE_7_PORTAL | ran | 0.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.0s |  |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786252510 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.5s | events_processed=256; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 0 events
  browser: 0 events
  files: 0 events
  chat: 0 events
