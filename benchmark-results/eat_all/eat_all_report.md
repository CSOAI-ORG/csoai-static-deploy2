...
**Run ID**: eat_all_1786544123
**Finished**: 2026-08-12T14:15:23.270824+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5728 |
...
| PHASE_5_HONEY | ran | 1.4s | exit_code=0; events=3236 |
| PHASE_6_DOWNLOADS | ran | 4.1s | exit_code=0; files_mined=237 |
| PHASE_7_PORTAL | ran | 0.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.6s | deck_cards=55; kb_entries=5728; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786544112 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5735 → 5735 entries (+0 new, dedup by normalized question)
