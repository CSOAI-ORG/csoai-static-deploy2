...
**Run ID**: eat_all_1786605012
**Finished**: 2026-08-13T07:10:12.153312+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7281 |
...
| PHASE_6_DOWNLOADS | ran | 0.7s | exit_code=0; files_mined=261 |
| PHASE_7_PORTAL | ran | 0.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.9s | deck_cards=55; kb_entries=7281; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786605004 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7288 → 7288 entries (+0 new, dedup by normalized question)
