...
**Run ID**: eat_all_1786620730
**Finished**: 2026-08-13T11:32:10.998195+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7679 |
...
| PHASE_5_HONEY | ran | 6.3s | exit_code=0; events=4056 |
| PHASE_6_DOWNLOADS | ran | 7.8s | exit_code=0; files_mined=267 |
| PHASE_7_PORTAL | ran | 7.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 17.1s | deck_cards=55; kb_entries=7679; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 17.7s | clans_routed=0; swarm_id=owem-clans-1786620683 |
| PHASE_9C_OWEM_CLUSTER | ran | 4.8s | clusters_routed=0 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 18.7s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 12.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7686 → 7686 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7686 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 2.3s | iwm_records=0; kb_entries_added=0; exit_code=0 |
