...
**Run ID**: eat_all_1786538824
**Finished**: 2026-08-12T12:47:04.643681+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5592 |
| PHASE_1_REBOARD | ran | 3.7s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 3.2s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 13.2s | exit_code=0; events=3193 |
| PHASE_6_DOWNLOADS | ran | 8.2s | exit_code=0; files_mined=233 |
| PHASE_7_PORTAL | ran | 14.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 4.1s | deck_cards=55; kb_entries=5592; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.0s | clans_routed=0; swarm_id=owem-clans-1786538756 |
| PHASE_9C_OWEM_CLUSTER | ran | 1.5s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 0.6s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 1.1s | data_sources_routed=0 |
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 1.5s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 4.2s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 28.0s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 23.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 6 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5599 → 5599 entries (+0 new, dedup by normalized question)
