...
**Run ID**: eat_all_1786690220
**Finished**: 2026-08-14T06:50:20.924350+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8536 |
...
| PHASE_5_HONEY | ran | 0.6s | exit_code=0; events=4396 |
| PHASE_6_DOWNLOADS | failed | 5.9s | (no error message) |
| PHASE_7_PORTAL | ran | 0.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.1s | deck_cards=55; kb_entries=8536; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.9s | clans_routed=0; swarm_id=owem-clans-1786690212 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8543 → 8543 entries (+0 new, dedup by normalized question)
