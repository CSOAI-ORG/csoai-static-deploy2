...
**Run ID**: eat_all_1786696830
**Finished**: 2026-08-14T08:40:30.248753+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8698 |
...
| PHASE_5_HONEY | ran | 3.5s | exit_code=0; events=4456 |
| PHASE_6_DOWNLOADS | ran | 5.0s | exit_code=0; files_mined=275 |
| PHASE_7_PORTAL | ran | 1.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.8s | deck_cards=55; kb_entries=8698; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786696818 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8705 → 8705 entries (+0 new, dedup by normalized question)
