...
**Run ID**: eat_all_1786192523
**Finished**: 2026-08-08T12:35:23.771598+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=65 |
| PHASE_1_REBOARD | ran | 0.2s | exit_code=0 |
| PHASE_2_KB_GROW | failed | 0.1s | (no error message) |
...
| PHASE_5_HONEY | ran | 0.3s | exit_code=0; events=6 |
| PHASE_6_DOWNLOADS | ran | 0.2s | exit_code=0; files_mined=153 |
| PHASE_7_PORTAL | failed | 0.2s | (no error message) |
| PHASE_9_ARTIFACTS | ran | 0.0s |  |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786192516 |
...
| PHASE_9I_SOV_CAPTURE | ran | 6.8s | events_processed=256; skills_extracted=1; refine_output=KB Refinery — processing today's capture events...
  terminal: 20 events
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 65 → 85 entries (+20 new)
