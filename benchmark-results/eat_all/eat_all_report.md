...
**Run ID**: eat_all_1786560632
**Finished**: 2026-08-12T18:50:32.816009+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6096 |
...
| PHASE_5_HONEY | ran | 3.7s | exit_code=0; events=3376 |
| PHASE_6_DOWNLOADS | ran | 2.6s | exit_code=0; files_mined=240 |
| PHASE_7_PORTAL | ran | 3.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.8s | deck_cards=55; kb_entries=6096; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.2s | clans_routed=0; swarm_id=owem-clans-1786560620 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 6103 → 6103 entries (+0 new, dedup by normalized question)
