...
**Run ID**: eat_all_1786598487
**Finished**: 2026-08-13T05:21:27.418685+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 16.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7105 |
...
| PHASE_5_HONEY | ran | 13.5s | exit_code=0; events=3816 |
| PHASE_6_DOWNLOADS | failed | 10.7s | (no error message) |
| PHASE_7_PORTAL | ran | 7.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 8.8s | deck_cards=55; kb_entries=7105; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.3s | clans_routed=0; swarm_id=owem-clans-1786598477 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7112 → 7112 entries (+0 new, dedup by normalized question)
