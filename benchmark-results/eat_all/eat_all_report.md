...
**Run ID**: eat_all_1786760723
**Finished**: 2026-08-15T02:25:23.502833+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | failed | 2.4s | JSONDecodeError: Extra data: line 298535 column 2 (char 12816009) |
...
| PHASE_5_HONEY | ran | 2.9s | exit_code=0; events=4836 |
| PHASE_6_DOWNLOADS | ran | 0.7s | exit_code=0; files_mined=297 |
...
| PHASE_9G_AUDIENCE_HARNESS | failed | 0.7s | Extra data: line 298535 column 2 (char 12816009) |
