...
**Run ID**: eat_all_1786594825
**Finished**: 2026-08-13T04:20:25.216942+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7009 |
...
| PHASE_5_HONEY | ran | 0.6s | exit_code=0; events=3796 |
| PHASE_6_DOWNLOADS | failed | 6.4s | (no error message) |
| PHASE_7_PORTAL | ran | 1.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.4s | deck_cards=55; kb_entries=7009; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.0s | clans_routed=0; swarm_id=owem-clans-1786594819 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 0.9s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 2.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7016 → 7016 entries (+0 new, dedup by normalized question)
