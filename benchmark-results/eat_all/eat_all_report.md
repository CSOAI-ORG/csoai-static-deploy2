...
**Run ID**: eat_all_1786199722
**Finished**: 2026-08-08T14:35:22.360081+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.7s | sov_local_status=unreachable: timed out; ollama_models=3; kb_entries=881 |
...
| PHASE_5_HONEY | ran | 1.0s | exit_code=0; events=169 |
| PHASE_6_DOWNLOADS | ran | 5.8s | exit_code=1; files_mined=158 |
| PHASE_7_PORTAL | ran | 0.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.2s |  |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786199418 |
...
| PHASE_9I_SOV_CAPTURE | failed | 301.8s | Command '['python3', '/Users/nicholas/clawd/csoai-static-deploy2/sov_capture.py', '--gnn-extract']'  |
