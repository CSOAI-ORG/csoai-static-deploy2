...
**Run ID**: eat_all_1786543548
**Finished**: 2026-08-12T14:05:48.523284+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5712 |
...
| PHASE_5_HONEY | ran | 3.5s | exit_code=0; events=3236 |
| PHASE_6_DOWNLOADS | ran | 2.7s | exit_code=0; files_mined=237 |
| PHASE_7_PORTAL | ran | 4.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.0s | deck_cards=55; kb_entries=5712; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.8s | clans_routed=0; swarm_id=owem-clans-1786543523 |
...
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 1.9s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 1.8s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 7.2s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 7.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 6 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5719 → 5719 entries (+0 new, dedup by normalized question)
