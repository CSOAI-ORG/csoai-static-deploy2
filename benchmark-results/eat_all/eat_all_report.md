...
**Run ID**: eat_all_1786468017
**Finished**: 2026-08-11T17:06:57.705849+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 77.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=4684 |
| PHASE_1_REBOARD | ran | 2.8s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 1.7s | exit_code=0 |
| PHASE_3_PROBES | ran | 1.3s | chatml=1; bloodline=1 |
| PHASE_4_TRAINING | ran | 0.0s | training_scripts_available=['sov_groq_distill.py', 'sov_grpo_train.py', 'sov_minimal_train.py'] |
| PHASE_5_HONEY | ran | 4.0s | exit_code=0; events=2853 |
| PHASE_6_DOWNLOADS | ran | 2.5s | exit_code=0; files_mined=218 |
| PHASE_7_PORTAL | ran | 1.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.3s | deck_cards=54; kb_entries=4684; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786468010 |
