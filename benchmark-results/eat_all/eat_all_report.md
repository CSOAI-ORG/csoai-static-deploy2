...
**Run ID**: eat_all_1786447257
**Finished**: 2026-08-11T11:20:57.297595+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 10.0s | sov_local_status=unreachable: timed out; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=4204 |
| PHASE_1_REBOARD | ran | 10.2s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 10.8s | exit_code=0; events=2613 |
| PHASE_6_DOWNLOADS | ran | 6.2s | exit_code=0; files_mined=194 |
| PHASE_7_PORTAL | ran | 2.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.4s | deck_cards=54; kb_entries=4204; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786447251 |
