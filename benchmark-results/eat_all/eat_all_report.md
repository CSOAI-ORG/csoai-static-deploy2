...
**Run ID**: eat_all_1786249534
**Finished**: 2026-08-09T04:25:34.438835+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.7s | souls=199; ollama_models=4; kb_entries=1498 |
...
| PHASE_5_HONEY | ran | 0.3s | exit_code=0; events=567 |
| PHASE_6_DOWNLOADS | ran | 5.9s | exit_code=1; files_mined=158 |
| PHASE_7_PORTAL | ran | 5.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.8s |  |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786249529 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.2s | events_processed=256; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 0 events
  browser: 0 events
  files: 0 events
  chat: 0 events
