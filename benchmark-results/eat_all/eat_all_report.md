...
**Run ID**: eat_all_1786416047
**Finished**: 2026-08-11T02:40:47.945814+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 8.8s | sov_local_status=unreachable: timed out; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=3388 |
...
| PHASE_5_HONEY | ran | 6.3s | exit_code=0; events=2293 |
| PHASE_6_DOWNLOADS | ran | 5.3s | exit_code=0; files_mined=182 |
| PHASE_7_PORTAL | ran | 5.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.7s | deck_cards=54; kb_entries=3388; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786416037 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 3.6s | kb_entries_added=7; exit_code=0 |
