...
**Run ID**: eat_all_1786200013
**Finished**: 2026-08-08T14:40:13.025249+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=3; kb_entries=2889 |
...
| PHASE_6_DOWNLOADS | ran | 6.2s | exit_code=1; files_mined=158 |
| PHASE_7_PORTAL | ran | 0.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.1s |  |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786199710 |
...
| PHASE_9I_SOV_CAPTURE | failed | 300.8s | Command '['python3', '/Users/nicholas/clawd/csoai-static-deploy2/sov_capture.py', '--gnn-extract']'  |
