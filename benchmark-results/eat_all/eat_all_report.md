...
**Run ID**: eat_all_1786261106
**Finished**: 2026-08-09T07:38:26.743427+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.1s | souls=0; ollama_models=2; kb_entries=362 |
...
| PHASE_5_HONEY | ran | 0.1s | exit_code=0; events=1012 |
| PHASE_6_DOWNLOADS | ran | 5.3s | exit_code=1; files_mined=158 |
| PHASE_7_PORTAL | ran | 0.1s | exit_code=0 |
| PHASE_8_DEPLOY | ran | 75.0s | deploy_exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.0s | deck_cards=54 |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786261106 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 369 → 369 entries (+0 new, dedup by normalized question)
