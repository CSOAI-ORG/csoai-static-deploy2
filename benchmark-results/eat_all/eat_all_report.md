...
**Run ID**: eat_all_1786627226
**Finished**: 2026-08-13T13:20:26.790394+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 5.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7790 |
...
| PHASE_5_HONEY | ran | 2.2s | exit_code=0; events=4076 |
| PHASE_6_DOWNLOADS | ran | 0.6s | exit_code=0; files_mined=268 |
| PHASE_7_PORTAL | ran | 2.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.3s | deck_cards=55; kb_entries=7790; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786627217 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7797 → 7797 entries (+0 new, dedup by normalized question)
