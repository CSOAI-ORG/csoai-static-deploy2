...
**Run ID**: eat_all_1786452610
**Finished**: 2026-08-11T12:50:10.653845+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.2s | sov_local_status=unreachable: HTTP Error 404: Not Found; ollama_models=2; kb_entries=4348 |
...
| PHASE_5_HONEY | ran | 0.3s | exit_code=0; events=2693 |
| PHASE_6_DOWNLOADS | failed | 5.6s | (no error message) |
| PHASE_7_PORTAL | ran | 0.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.2s | deck_cards=54; kb_entries=4348; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786452608 |
