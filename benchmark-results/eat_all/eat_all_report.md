...
**Run ID**: eat_all_1786417519
**Finished**: 2026-08-11T03:05:19.429115+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.0s | sov_local_status=unreachable: HTTP Error 404: Not Found; ollama_models=2; kb_entries=3428 |
...
| PHASE_6_DOWNLOADS | ran | 0.4s | exit_code=0; files_mined=182 |
| PHASE_7_PORTAL | ran | 1.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.9s | deck_cards=54; kb_entries=3428; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786417511 |
