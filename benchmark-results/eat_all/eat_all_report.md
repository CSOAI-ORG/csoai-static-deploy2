...
**Run ID**: eat_all_1786702228
**Finished**: 2026-08-14T10:10:28.446184+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8826 |
...
| PHASE_6_DOWNLOADS | ran | 2.3s | exit_code=0; files_mined=283 |
| PHASE_7_PORTAL | ran | 2.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.5s | deck_cards=55; kb_entries=8826; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786702219 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8833 → 8833 entries (+0 new, dedup by normalized question)
