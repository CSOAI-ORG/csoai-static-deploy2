...
**Run ID**: eat_all_1786638692
**Finished**: 2026-08-13T16:31:32.307858+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7898 |
...
| PHASE_5_HONEY | ran | 0.9s | exit_code=0; events=4136 |
| PHASE_6_DOWNLOADS | ran | 0.3s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 1.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.8s | deck_cards=55; kb_entries=7898; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786638606 |
...
| PHASE_9I_SOV_CAPTURE | ran | 72.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7905 → 7905 entries (+0 new, dedup by normalized question)
