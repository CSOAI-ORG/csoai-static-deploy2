...
**Run ID**: eat_all_1786466115
**Finished**: 2026-08-11T16:35:15.653680+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4636 |
...
| PHASE_5_HONEY | ran | 0.6s | exit_code=0; events=2833 |
| PHASE_6_DOWNLOADS | ran | 2.6s | exit_code=0; files_mined=217 |
| PHASE_7_PORTAL | ran | 2.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.9s | deck_cards=54; kb_entries=4636; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786466109 |
