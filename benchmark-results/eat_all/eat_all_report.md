...
**Run ID**: eat_all_1786676719
**Finished**: 2026-08-14T03:05:19.903004+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8178 |
...
| PHASE_5_HONEY | ran | 1.8s | exit_code=0; events=4256 |
| PHASE_6_DOWNLOADS | ran | 5.0s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 2.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.7s | deck_cards=55; kb_entries=8178; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786676715 |
