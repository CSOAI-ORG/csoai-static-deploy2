...
**Run ID**: eat_all_1786506309
**Finished**: 2026-08-12T03:45:09.450092+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4732 |
...
| PHASE_5_HONEY | ran | 0.6s | exit_code=0; events=2873 |
| PHASE_6_DOWNLOADS | ran | 0.4s | exit_code=0; files_mined=218 |
| PHASE_7_PORTAL | ran | 1.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.5s | deck_cards=54; kb_entries=4732; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786506306 |
