...
**Run ID**: eat_all_1786684218
**Finished**: 2026-08-14T05:10:18.175419+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8384 |
...
| PHASE_5_HONEY | ran | 0.7s | exit_code=0; events=4336 |
| PHASE_6_DOWNLOADS | failed | 5.3s | (no error message) |
| PHASE_7_PORTAL | ran | 0.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.7s | deck_cards=55; kb_entries=8384; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.3s | clans_routed=0; swarm_id=owem-clans-1786684213 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8391 → 8391 entries (+0 new, dedup by normalized question)
