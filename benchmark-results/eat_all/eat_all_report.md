...
**Run ID**: eat_all_1786528512
**Finished**: 2026-08-12T09:55:12.138533+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5317 |
...
| PHASE_6_DOWNLOADS | ran | 3.5s | exit_code=0; files_mined=228 |
| PHASE_7_PORTAL | ran | 0.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.4s | deck_cards=54; kb_entries=5317; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786528506 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5324 → 5324 entries (+0 new, dedup by normalized question)
