...
**Run ID**: eat_all_1786259407
**Finished**: 2026-08-09T07:10:07.172037+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.1s | souls=0; ollama_models=4; kb_entries=314 |
...
| PHASE_6_DOWNLOADS | ran | 5.6s | exit_code=1; files_mined=158 |
| PHASE_7_PORTAL | ran | 0.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.0s | deck_cards=54 |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786259406 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 321 → 321 entries (+0 new, dedup by normalized question)
