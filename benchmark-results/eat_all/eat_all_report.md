...
**Run ID**: eat_all_1786423221
**Finished**: 2026-08-11T04:40:21.992516+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=3572 |
| PHASE_1_REBOARD | ran | 2.6s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 1.8s | exit_code=0; events=2353 |
| PHASE_6_DOWNLOADS | ran | 0.2s | exit_code=0; files_mined=189 |
| PHASE_7_PORTAL | ran | 2.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.9s | deck_cards=54; kb_entries=3572; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.0s | clans_routed=0; swarm_id=owem-clans-1786423218 |
