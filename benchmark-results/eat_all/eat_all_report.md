...
**Run ID**: eat_all_1786609824
**Finished**: 2026-08-13T08:30:24.723610+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7401 |
...
| PHASE_5_HONEY | ran | 5.0s | exit_code=0; events=3936 |
| PHASE_6_DOWNLOADS | ran | 0.5s | exit_code=0; files_mined=266 |
| PHASE_7_PORTAL | ran | 1.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=55; kb_entries=7401; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786609813 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7408 → 7408 entries (+0 new, dedup by normalized question)
