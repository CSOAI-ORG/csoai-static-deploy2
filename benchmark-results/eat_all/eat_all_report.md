...
**Run ID**: eat_all_1786611029
**Finished**: 2026-08-13T08:50:29.618933+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7435 |
...
| PHASE_5_HONEY | ran | 1.2s | exit_code=0; events=3956 |
| PHASE_6_DOWNLOADS | ran | 0.6s | exit_code=0; files_mined=266 |
| PHASE_7_PORTAL | ran | 1.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.3s | deck_cards=55; kb_entries=7435; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.2s | clans_routed=0; swarm_id=owem-clans-1786611011 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 5.0s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 3.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7442 → 7442 entries (+0 new, dedup by normalized question)
