...
**Run ID**: eat_all_1786552889
**Finished**: 2026-08-12T16:41:29.572978+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5888 |
...
| PHASE_5_HONEY | ran | 9.0s | exit_code=0; events=3296 |
| PHASE_6_DOWNLOADS | ran | 9.3s | exit_code=0; files_mined=240 |
| PHASE_7_PORTAL | ran | 5.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 4.1s | deck_cards=55; kb_entries=5888; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 3.0s | clans_routed=0; swarm_id=owem-clans-1786552838 |
| PHASE_9C_OWEM_CLUSTER | ran | 12.5s | clusters_routed=0 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 15.6s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 3.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5895 → 5895 entries (+0 new, dedup by normalized question)
