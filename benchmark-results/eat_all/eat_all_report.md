...
**Run ID**: eat_all_1786643481
**Finished**: 2026-08-13T17:51:21.766292+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8010 |
| PHASE_1_REBOARD | ran | 3.4s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 4.5s | exit_code=0; events=4196 |
| PHASE_6_DOWNLOADS | ran | 6.0s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 2.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 4.4s | deck_cards=55; kb_entries=8010; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.8s | clans_routed=0; swarm_id=owem-clans-1786643460 |
...
| PHASE_9I_SOV_CAPTURE | ran | 5.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8017 → 8017 entries (+0 new, dedup by normalized question)
