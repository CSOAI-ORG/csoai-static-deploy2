...
**Run ID**: eat_all_1786447870
**Finished**: 2026-08-11T11:31:10.094408+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 10.1s | sov_local_status=unreachable: timed out; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=4220 |
| PHASE_1_REBOARD | ran | 36.1s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 3.9s | exit_code=0; events=2633 |
| PHASE_6_DOWNLOADS | failed | 7.1s | (no error message) |
| PHASE_7_PORTAL | ran | 2.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.8s | deck_cards=54; kb_entries=4220; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786447865 |
