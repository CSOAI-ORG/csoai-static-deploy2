...
**Run ID**: eat_all_1786695328
**Finished**: 2026-08-14T08:15:28.449628+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8658 |
...
| PHASE_5_HONEY | ran | 2.7s | exit_code=0; events=4456 |
| PHASE_6_DOWNLOADS | ran | 2.7s | exit_code=0; files_mined=273 |
| PHASE_7_PORTAL | ran | 3.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.0s | deck_cards=55; kb_entries=8658; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.0s | clans_routed=0; swarm_id=owem-clans-1786695316 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8665 → 8665 entries (+0 new, dedup by normalized question)
