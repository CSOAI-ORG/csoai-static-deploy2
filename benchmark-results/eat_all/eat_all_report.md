...
**Run ID**: eat_all_1786597835
**Finished**: 2026-08-13T05:10:35.365640+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7089 |
...
| PHASE_5_HONEY | ran | 2.4s | exit_code=0; events=3816 |
| PHASE_6_DOWNLOADS | failed | 7.0s | (no error message) |
| PHASE_7_PORTAL | ran | 2.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.5s | deck_cards=55; kb_entries=7089; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.3s | clans_routed=0; swarm_id=owem-clans-1786597827 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7096 → 7096 entries (+0 new, dedup by normalized question)
