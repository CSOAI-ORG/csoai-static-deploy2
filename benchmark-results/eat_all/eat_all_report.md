...
**Run ID**: eat_all_1786600526
**Finished**: 2026-08-13T05:55:26.435953+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7161 |
...
| PHASE_5_HONEY | ran | 0.4s | exit_code=0; events=3856 |
| PHASE_6_DOWNLOADS | ran | 3.1s | exit_code=0; files_mined=255 |
| PHASE_7_PORTAL | ran | 1.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=55; kb_entries=7161; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786600514 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 3.1s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 4.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7168 → 7168 entries (+0 new, dedup by normalized question)
