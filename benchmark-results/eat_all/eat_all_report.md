...
**Run ID**: eat_all_1786548648
**Finished**: 2026-08-12T15:30:48.295349+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5776 |
...
| PHASE_5_HONEY | ran | 2.7s | exit_code=0; events=3256 |
| PHASE_6_DOWNLOADS | ran | 2.9s | exit_code=0; files_mined=239 |
| PHASE_7_PORTAL | ran | 3.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.7s | deck_cards=55; kb_entries=5776; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.4s | clans_routed=0; swarm_id=owem-clans-1786548621 |
...
| PHASE_9I_SOV_CAPTURE | ran | 10.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5783 → 5783 entries (+0 new, dedup by normalized question)
