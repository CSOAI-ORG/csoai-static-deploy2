...
**Run ID**: eat_all_1786466720
**Finished**: 2026-08-11T16:45:20.706178+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4652 |
...
| PHASE_5_HONEY | ran | 0.5s | exit_code=0; events=2833 |
| PHASE_6_DOWNLOADS | failed | 5.7s | (no error message) |
| PHASE_7_PORTAL | ran | 1.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.0s | deck_cards=54; kb_entries=4652; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786466710 |
