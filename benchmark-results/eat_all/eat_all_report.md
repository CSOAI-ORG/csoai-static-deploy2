...
**Run ID**: eat_all_1786701661
**Finished**: 2026-08-14T10:01:01.432834+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8810 |
| PHASE_1_REBOARD | ran | 1.3s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 1.2s | exit_code=0; events=4516 |
| PHASE_6_DOWNLOADS | ran | 3.2s | exit_code=0; files_mined=283 |
| PHASE_7_PORTAL | ran | 5.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 4.6s | deck_cards=55; kb_entries=8810; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.7s | clans_routed=0; swarm_id=owem-clans-1786701622 |
...
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 4.5s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 3.8s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 7.9s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 9.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 9 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8817 → 8817 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 8817 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 4.9s | iwm_records=0; kb_entries_added=0; exit_code=0 |
