...
**Run ID**: eat_all_1786463765
**Finished**: 2026-08-11T15:56:05.718482+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4588 |
| PHASE_1_REBOARD | ran | 1.1s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 1.8s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 3.2s | exit_code=0; events=2813 |
| PHASE_6_DOWNLOADS | failed | 6.1s | (no error message) |
| PHASE_7_PORTAL | ran | 3.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 6.8s | deck_cards=54; kb_entries=4588; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.0s | clans_routed=0; swarm_id=owem-clans-1786463739 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 11.0s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 7.9s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 0 events
  browser: 0 events
  files: 0 events
  chat: 0 events
