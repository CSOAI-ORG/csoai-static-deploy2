...
**Run ID**: eat_all_1786680617
**Finished**: 2026-08-14T04:10:17.249077+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8283 |
...
| PHASE_5_HONEY | ran | 1.4s | exit_code=0; events=4296 |
| PHASE_6_DOWNLOADS | ran | 0.3s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 2.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.3s | deck_cards=55; kb_entries=8283; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786680610 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8290 → 8290 entries (+0 new, dedup by normalized question)
