...
**Run ID**: eat_all_1786643726
**Finished**: 2026-08-13T17:55:26.599327+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8018 |
...
| PHASE_5_HONEY | ran | 1.4s | exit_code=0; events=4196 |
| PHASE_6_DOWNLOADS | ran | 2.9s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 2.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.0s | deck_cards=55; kb_entries=8018; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786643715 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8025 → 8025 entries (+0 new, dedup by normalized question)
