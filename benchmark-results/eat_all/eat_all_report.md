...
**Run ID**: eat_all_1786542625
**Finished**: 2026-08-12T13:50:25.514348+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 21.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=5680 |
...
| PHASE_5_HONEY | ran | 9.5s | exit_code=0; events=3236 |
| PHASE_6_DOWNLOADS | ran | 13.3s | exit_code=0; files_mined=237 |
| PHASE_7_PORTAL | ran | 17.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 13.9s | deck_cards=55; kb_entries=5680; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.5s | clans_routed=0; swarm_id=owem-clans-1786542509 |
...
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 4.2s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 8.5s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 70.2s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 20.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5687 → 5687 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 5687 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 1.7s | iwm_records=0; kb_entries_added=0; exit_code=0 |
