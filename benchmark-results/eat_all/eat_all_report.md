...
**Run ID**: eat_all_1786534526
**Finished**: 2026-08-12T11:35:26.664218+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5478 |
...
| PHASE_5_HONEY | ran | 0.8s | exit_code=0; events=3153 |
| PHASE_6_DOWNLOADS | failed | 6.1s | (no error message) |
| PHASE_7_PORTAL | ran | 1.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.3s | deck_cards=55; kb_entries=5478; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.9s | clans_routed=0; swarm_id=owem-clans-1786534514 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5485 → 5485 entries (+0 new, dedup by normalized question)
