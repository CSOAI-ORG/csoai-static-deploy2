...
**Run ID**: eat_all_1786200314
**Finished**: 2026-08-08T14:45:14.741608+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.1s | sov_local_status=unreachable: timed out; ollama_models=3; kb_entries=3408 |
...
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786200311 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.1s | events_processed=256; skills_extracted=1; refine_output=KB Refinery — processing today's capture events...
  terminal: 500 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 3917 → 4417 entries (+500 new)
