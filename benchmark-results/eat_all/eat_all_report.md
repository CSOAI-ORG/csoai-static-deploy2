...
**Run ID**: eat_all_1786681222
**Finished**: 2026-08-14T04:20:22.050211+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8299 |
...
| PHASE_5_HONEY | ran | 0.9s | exit_code=0; events=4296 |
| PHASE_6_DOWNLOADS | ran | 1.0s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 1.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.5s | deck_cards=55; kb_entries=8299; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.2s | clans_routed=0; swarm_id=owem-clans-1786681210 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8306 → 8308 entries (+2 new, dedup by normalized question)
