...
**Run ID**: eat_all_1786542918
**Finished**: 2026-08-12T13:55:18.341037+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5696 |
...
| PHASE_5_HONEY | ran | 1.1s | exit_code=0; events=3236 |
| PHASE_6_DOWNLOADS | ran | 1.1s | exit_code=0; files_mined=237 |
| PHASE_7_PORTAL | ran | 1.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.1s | deck_cards=55; kb_entries=5696; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786542908 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 6 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5703 → 5703 entries (+0 new, dedup by normalized question)
