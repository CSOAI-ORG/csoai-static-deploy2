...
**Run ID**: eat_all_1786630307
**Finished**: 2026-08-13T14:11:47.855665+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7848 |
...
| PHASE_5_HONEY | ran | 18.7s | exit_code=0; events=4116 |
| PHASE_6_DOWNLOADS | ran | 11.9s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 13.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 13.2s | deck_cards=55; kb_entries=7848; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.0s | clans_routed=0; swarm_id=owem-clans-1786630276 |
...
| PHASE_9I_SOV_CAPTURE | ran | 15.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7855 → 7855 entries (+0 new, dedup by normalized question)
