...
**Run ID**: eat_all_1786535469
**Finished**: 2026-08-12T11:51:09.382019+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 7.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=5502 |
...
| PHASE_5_HONEY | ran | 7.8s | exit_code=0; events=3173 |
| PHASE_6_DOWNLOADS | failed | 7.7s | (no error message) |
| PHASE_7_PORTAL | ran | 6.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.6s | deck_cards=55; kb_entries=5502; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.5s | clans_routed=0; swarm_id=owem-clans-1786535450 |
...
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 0.8s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 0.7s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 9.5s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 1.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 3 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5509 → 5509 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 5509 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 0.6s | iwm_records=0; kb_entries_added=0; exit_code=0 |
