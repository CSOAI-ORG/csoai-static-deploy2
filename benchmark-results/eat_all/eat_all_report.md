...
**Run ID**: eat_all_1786539437
**Finished**: 2026-08-12T12:57:17.164788+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 38.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=5608 |
...
| PHASE_5_HONEY | ran | 7.7s | exit_code=0; events=3213 |
| PHASE_6_DOWNLOADS | ran | 3.1s | exit_code=0; files_mined=233 |
| PHASE_7_PORTAL | ran | 0.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.8s | deck_cards=55; kb_entries=5608; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786539432 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5615 → 5615 entries (+0 new, dedup by normalized question)
