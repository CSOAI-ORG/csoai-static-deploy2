...
**Run ID**: eat_all_1786620951
**Finished**: 2026-08-13T11:35:51.043820+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7687 |
...
| PHASE_5_HONEY | ran | 1.4s | exit_code=0; events=4056 |
| PHASE_6_DOWNLOADS | ran | 11.2s | exit_code=0; files_mined=268 |
| PHASE_7_PORTAL | ran | 8.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.5s | deck_cards=55; kb_entries=7687; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786620928 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 5.5s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 7.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7694 → 7694 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7694 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 3.3s | iwm_records=0; kb_entries_added=0; exit_code=0 |
