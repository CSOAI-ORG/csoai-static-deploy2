...
**Run ID**: eat_all_1786446911
**Finished**: 2026-08-11T11:15:11.961972+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4196 |
...
| PHASE_5_HONEY | ran | 2.0s | exit_code=0; events=2613 |
| PHASE_6_DOWNLOADS | ran | 0.5s | exit_code=0; files_mined=194 |
| PHASE_7_PORTAL | ran | 3.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.0s | deck_cards=54; kb_entries=4196; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786446910 |
