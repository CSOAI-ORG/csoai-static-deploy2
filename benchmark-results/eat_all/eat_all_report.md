...
**Run ID**: eat_all_1786424147
**Finished**: 2026-08-11T04:55:47.373380+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 11.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=3596 |
| PHASE_1_REBOARD | ran | 8.2s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 13.7s | exit_code=0; events=2373 |
| PHASE_6_DOWNLOADS | ran | 1.4s | exit_code=0; files_mined=191 |
| PHASE_7_PORTAL | ran | 0.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.3s | deck_cards=54; kb_entries=3596; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786424144 |
