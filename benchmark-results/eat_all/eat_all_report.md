...
**Run ID**: eat_all_1786639821
**Finished**: 2026-08-13T16:50:21.185283+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7930 |
...
| PHASE_5_HONEY | ran | 1.6s | exit_code=0; events=4156 |
| PHASE_6_DOWNLOADS | ran | 0.8s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 1.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=55; kb_entries=7930; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786639808 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7937 → 7937 entries (+0 new, dedup by normalized question)
