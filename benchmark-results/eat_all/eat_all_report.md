...
**Run ID**: eat_all_1786537818
**Finished**: 2026-08-12T12:30:18.846583+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5568 |
...
| PHASE_5_HONEY | ran | 1.6s | exit_code=0; events=3193 |
| PHASE_6_DOWNLOADS | ran | 2.8s | exit_code=0; files_mined=233 |
| PHASE_7_PORTAL | ran | 1.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.4s | deck_cards=55; kb_entries=5568; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786537812 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5575 → 5575 entries (+0 new, dedup by normalized question)
