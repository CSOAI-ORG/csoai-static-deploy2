...
**Run ID**: eat_all_1786610129
**Finished**: 2026-08-13T08:35:29.740154+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7409 |
...
| PHASE_5_HONEY | ran | 2.7s | exit_code=0; events=3936 |
| PHASE_6_DOWNLOADS | ran | 4.2s | exit_code=0; files_mined=266 |
| PHASE_7_PORTAL | ran | 2.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.0s | deck_cards=55; kb_entries=7409; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786610118 |
...
| PHASE_9I_SOV_CAPTURE | ran | 5.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7416 → 7416 entries (+0 new, dedup by normalized question)
