...
**Run ID**: eat_all_1786691427
**Finished**: 2026-08-14T07:10:27.014823+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8568 |
...
| PHASE_5_HONEY | ran | 0.5s | exit_code=0; events=4396 |
| PHASE_6_DOWNLOADS | failed | 5.9s | (no error message) |
| PHASE_7_PORTAL | ran | 5.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.8s | deck_cards=55; kb_entries=8568; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786691418 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8575 → 8575 entries (+0 new, dedup by normalized question)
