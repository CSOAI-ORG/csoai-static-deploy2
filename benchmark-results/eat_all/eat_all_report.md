...
**Run ID**: eat_all_1786617612
**Finished**: 2026-08-13T10:40:12.885785+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7596 |
...
| PHASE_5_HONEY | ran | 0.6s | exit_code=0; events=4016 |
| PHASE_6_DOWNLOADS | ran | 0.3s | exit_code=0; files_mined=266 |
| PHASE_7_PORTAL | ran | 0.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.8s | deck_cards=55; kb_entries=7596; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.3s | clans_routed=0; swarm_id=owem-clans-1786617605 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7603 → 7603 entries (+0 new, dedup by normalized question)
