...
**Run ID**: eat_all_1786443009
**Finished**: 2026-08-11T10:10:09.172817+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4092 |
...
| PHASE_5_HONEY | ran | 0.2s | exit_code=0; events=2553 |
| PHASE_6_DOWNLOADS | failed | 6.0s | (no error message) |
| PHASE_7_PORTAL | ran | 0.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.2s | deck_cards=54; kb_entries=4092; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786443007 |
