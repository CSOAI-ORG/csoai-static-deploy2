...
**Run ID**: eat_all_1786592732
**Finished**: 2026-08-13T03:45:32.309267+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6953 |
...
| PHASE_5_HONEY | ran | 2.3s | exit_code=0; events=3776 |
| PHASE_6_DOWNLOADS | ran | 2.5s | exit_code=0; files_mined=246 |
| PHASE_7_PORTAL | ran | 2.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.5s | deck_cards=55; kb_entries=6953; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786592714 |
...
| PHASE_9I_SOV_CAPTURE | ran | 7.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 6960 → 6960 entries (+0 new, dedup by normalized question)
