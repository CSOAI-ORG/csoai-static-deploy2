...
**Run ID**: eat_all_1786526131
**Finished**: 2026-08-12T09:15:31.362302+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5253 |
...
| PHASE_5_HONEY | ran | 0.6s | exit_code=0; events=3073 |
| PHASE_6_DOWNLOADS | ran | 2.1s | exit_code=0; files_mined=226 |
| PHASE_7_PORTAL | ran | 2.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.0s | deck_cards=54; kb_entries=5253; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786526113 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 4.1s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 6.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5260 → 5260 entries (+0 new, dedup by normalized question)
