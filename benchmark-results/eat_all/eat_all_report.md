...
**Run ID**: eat_all_1786644033
**Finished**: 2026-08-13T18:00:33.218654+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8026 |
...
| PHASE_5_HONEY | ran | 1.7s | exit_code=0; events=4196 |
| PHASE_6_DOWNLOADS | ran | 6.2s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 1.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.9s | deck_cards=55; kb_entries=8026; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.1s | clans_routed=0; swarm_id=owem-clans-1786644018 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8033 → 8033 entries (+0 new, dedup by normalized question)
