...
**Run ID**: eat_all_1786430422
**Finished**: 2026-08-11T06:40:22.727587+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.2s | sov_local_status=unreachable: timed out; ollama_models=2; kb_entries=3764 |
...
| PHASE_5_HONEY | ran | 1.3s | exit_code=0; events=2433 |
| PHASE_6_DOWNLOADS | failed | 5.8s | (no error message) |
| PHASE_7_PORTAL | ran | 1.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.5s | deck_cards=54; kb_entries=3764; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786430418 |
