...
**Run ID**: eat_all_1786731335
**Finished**: 2026-08-14T18:15:35.897859+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | failed | 1.2s | JSONDecodeError: Extra data: line 298535 column 2 (char 12816009) |
| PHASE_1_REBOARD | ran | 0.8s | exit_code=0 |
| PHASE_2_KB_GROW | failed | 0.9s | ts-to-kb.py", line 196, in main
...
| PHASE_5_HONEY | ran | 1.3s | exit_code=0; events=4736 |
| PHASE_6_DOWNLOADS | failed | 6.4s | (no error message) |
| PHASE_7_PORTAL | ran | 4.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.4s | deck_cards=0 |
| PHASE_9B_EXTERNAL_HARNESS | failed | 0.5s | Extra data: line 298535 column 2 (char 12816009) |
