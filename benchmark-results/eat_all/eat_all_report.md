...
**Run ID**: eat_all_1786456810
**Finished**: 2026-08-11T14:00:10.859601+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: HTTP Error 404: Not Found; ollama_models=2; kb_entries=4452 |
...
| PHASE_5_HONEY | ran | 0.3s | exit_code=0; events=2733 |
| PHASE_6_DOWNLOADS | failed | 5.9s | (no error message) |
| PHASE_7_PORTAL | ran | 0.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.2s | deck_cards=54; kb_entries=4452; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786456808 |
