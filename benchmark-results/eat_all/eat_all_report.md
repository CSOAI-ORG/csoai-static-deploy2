...
**Run ID**: eat_all_1786549066
**Finished**: 2026-08-12T15:37:46.148988+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5784 |
| PHASE_1_REBOARD | ran | 0.9s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 7.8s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 31.7s | exit_code=0; events=3276 |
| PHASE_6_DOWNLOADS | ran | 24.6s | exit_code=0; files_mined=239 |
| PHASE_7_PORTAL | ran | 10.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.1s | deck_cards=55; kb_entries=5784; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.0s | clans_routed=0; swarm_id=owem-clans-1786549032 |
...
| PHASE_9I_SOV_CAPTURE | ran | 15.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 6 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5791 → 5791 entries (+0 new, dedup by normalized question)
