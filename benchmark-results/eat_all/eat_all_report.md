...
**Run ID**: eat_all_1786619957
**Finished**: 2026-08-13T11:19:17.016420+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 11.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7656 |
| PHASE_1_REBOARD | ran | 23.2s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 6.3s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 16.9s | exit_code=0; events=4036 |
| PHASE_6_DOWNLOADS | ran | 16.8s | exit_code=0; files_mined=266 |
| PHASE_7_PORTAL | ran | 16.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 18.1s | deck_cards=55; kb_entries=7656; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 6.7s | clans_routed=0; swarm_id=owem-clans-1786619828 |
| PHASE_9C_OWEM_CLUSTER | ran | 3.9s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 6.8s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 6.3s | data_sources_routed=0 |
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 10.1s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 8.6s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 41.9s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 41.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7663 → 7663 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7663 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 5.0s | iwm_records=0; kb_entries_added=0; exit_code=0 |
| PHASE_10B_MODEL_ROUTING | ran | 3.4s | models_routed=0; specs_routed=1 |
