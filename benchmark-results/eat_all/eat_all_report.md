...
**Run ID**: eat_all_1786447595
**Finished**: 2026-08-11T11:26:35.152331+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.8s | sov_local_status=unreachable: timed out; ollama_models=2; kb_entries=4212 |
...
| PHASE_5_HONEY | ran | 1.8s | exit_code=0; events=2633 |
| PHASE_6_DOWNLOADS | ran | 4.3s | exit_code=0; files_mined=194 |
| PHASE_7_PORTAL | ran | 35.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 10.4s | deck_cards=54; kb_entries=4212; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 6.0s | clans_routed=0; swarm_id=owem-clans-1786447566 |
| PHASE_9C_OWEM_CLUSTER | ran | 5.5s | clusters_routed=0 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 9.4s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 4.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 0 events
  browser: 0 events
  files: 0 events
  chat: 0 events
