...
**Run ID**: eat_all_1786294810
**Finished**: 2026-08-09T17:00:10.421016+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.2s | souls=184; ollama_models=2; kb_entries=1155 |
...
| PHASE_5_HONEY | ran | 0.8s | exit_code=0; events=1333 |
| PHASE_6_DOWNLOADS | ran | 0.7s | exit_code=0; files_mined=168 |
| PHASE_7_PORTAL | ran | 0.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=54; kb_entries=1155; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.3s | clans_routed=0; swarm_id=owem-clans-1786294807 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 1162 → 1162 entries (+0 new, dedup by normalized question)
