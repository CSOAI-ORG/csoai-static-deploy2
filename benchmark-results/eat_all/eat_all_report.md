...
**Run ID**: eat_all_1786458027
**Finished**: 2026-08-11T14:20:27.784735+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: HTTP Error 404: Not Found; ollama_models=2; kb_entries=4484 |
...
| PHASE_5_HONEY | ran | 1.2s | exit_code=0; events=2753 |
| PHASE_6_DOWNLOADS | failed | 6.3s | (no error message) |
| PHASE_7_PORTAL | ran | 3.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.1s | deck_cards=54; kb_entries=4484; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.3s | clans_routed=0; swarm_id=owem-clans-1786458018 |
