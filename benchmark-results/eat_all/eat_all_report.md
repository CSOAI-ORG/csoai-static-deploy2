...
**Run ID**: eat_all_1786762220
**Finished**: 2026-08-15T02:50:20.186535+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=9225 |
...
| PHASE_5_HONEY | ran | 1.1s | exit_code=0; events=4836 |
| PHASE_6_DOWNLOADS | ran | 1.4s | exit_code=0; files_mined=298 |
| PHASE_7_PORTAL | ran | 0.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=55; kb_entries=9225; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786762209 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 0 events
  browser: 0 events
  files: 0 events
  chat: 0 events
