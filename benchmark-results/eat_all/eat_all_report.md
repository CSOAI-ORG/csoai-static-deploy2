...
**Run ID**: eat_all_1786294203
**Finished**: 2026-08-09T16:50:03.338840+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.3s | souls=184; ollama_models=2; kb_entries=1139 |
...
| PHASE_9_ARTIFACTS | ran | 0.1s | deck_cards=54; kb_entries=1139; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786294202 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 1146 → 1146 entries (+0 new, dedup by normalized question)
