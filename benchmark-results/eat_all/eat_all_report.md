...
**Run ID**: eat_all_1786591562
**Finished**: 2026-08-13T03:26:02.113475+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6921 |
| PHASE_1_REBOARD | ran | 3.3s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 3.1s | exit_code=0; events=3736 |
| PHASE_6_DOWNLOADS | failed | 13.0s | (no error message) |
| PHASE_7_PORTAL | ran | 19.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.6s | deck_cards=55; kb_entries=6921; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.3s | clans_routed=0; swarm_id=owem-clans-1786591549 |
...
| PHASE_9I_SOV_CAPTURE | ran | 6.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 6928 → 6928 entries (+0 new, dedup by normalized question)
