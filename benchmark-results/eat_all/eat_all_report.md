...
**Run ID**: eat_all_1786542097
**Finished**: 2026-08-12T13:41:37.767408+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5672 |
| PHASE_1_REBOARD | ran | 5.7s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 4.6s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 13.4s | exit_code=0; events=3216 |
| PHASE_6_DOWNLOADS | ran | 13.2s | exit_code=0; files_mined=237 |
| PHASE_7_PORTAL | ran | 14.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 7.0s | deck_cards=55; kb_entries=5672; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 4.7s | clans_routed=0; swarm_id=owem-clans-1786542069 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 8.2s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 12.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5679 → 5679 entries (+0 new, dedup by normalized question)
