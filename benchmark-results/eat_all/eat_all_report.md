...
**Run ID**: eat_all_1786537535
**Finished**: 2026-08-12T12:25:35.496846+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5560 |
...
| PHASE_5_HONEY | ran | 0.6s | exit_code=0; events=3193 |
| PHASE_6_DOWNLOADS | ran | 5.4s | exit_code=0; files_mined=233 |
| PHASE_7_PORTAL | ran | 4.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.6s | deck_cards=55; kb_entries=5560; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.3s | clans_routed=0; swarm_id=owem-clans-1786537519 |
...
| PHASE_9I_SOV_CAPTURE | ran | 6.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5567 → 5567 entries (+0 new, dedup by normalized question)
