...
**Run ID**: eat_all_1786516514
**Finished**: 2026-08-12T06:35:14.932084+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5005 |
...
| PHASE_5_HONEY | ran | 0.9s | exit_code=0; events=2973 |
| PHASE_6_DOWNLOADS | failed | 5.4s | (no error message) |
| PHASE_7_PORTAL | ran | 1.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.5s | deck_cards=54; kb_entries=5005; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786516511 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5012 → 5012 entries (+0 new, dedup by normalized question)
