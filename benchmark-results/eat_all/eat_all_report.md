...
**Run ID**: eat_all_1786527056
**Finished**: 2026-08-12T09:30:56.992964+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5277 |
...
| PHASE_5_HONEY | ran | 4.1s | exit_code=0; events=3073 |
| PHASE_6_DOWNLOADS | failed | 7.9s | (no error message) |
| PHASE_7_PORTAL | ran | 3.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.4s | deck_cards=54; kb_entries=5277; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.1s | clans_routed=0; swarm_id=owem-clans-1786527038 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 4.4s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 8.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 3 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5284 → 5284 entries (+0 new, dedup by normalized question)
