...
**Run ID**: eat_all_1786734326
**Finished**: 2026-08-14T19:05:26.030794+00:00
...
| PHASE_5_HONEY | ran | 0.4s | exit_code=0; events=4776 |
| PHASE_6_DOWNLOADS | failed | 5.3s | (no error message) |
| PHASE_7_PORTAL | ran | 9.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.4s | deck_cards=0 |
...
| PHASE_9H_SOV_HIVE_HARNESS | failed | 0.8s | Extra data: line 298535 column 2 (char 12816009) |
| PHASE_9I_SOV_CAPTURE | ran | 2.5s | events_processed=0; skills_extracted=0 |
