...
**Run ID**: eat_all_1786734924
**Finished**: 2026-08-14T19:15:24.171481+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | failed | 0.8s | JSONDecodeError: Extra data: line 298535 column 2 (char 12816009) |
| PHASE_1_REBOARD | ran | 0.4s | exit_code=0 |
| PHASE_2_KB_GROW | failed | 0.4s | ts-to-kb.py", line 196, in main
...
| PHASE_5_HONEY | ran | 0.6s | exit_code=0; events=4776 |
...
| PHASE_9C_OWEM_CLUSTER | failed | 2.0s | Extra data: line 298535 column 2 (char 12816009) |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.2s | events_processed=0; skills_extracted=0 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 0.7s | iwm_records=0; kb_entries_added=0; exit_code=1 |
