...
**Run ID**: eat_all_1786421717
**Finished**: 2026-08-11T04:15:17.278362+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.7s | sov_local_status=unreachable: timed out; ollama_models=2; kb_entries=3532 |
...
| PHASE_5_HONEY | ran | 1.5s | exit_code=0; events=2333 |
| PHASE_6_DOWNLOADS | ran | 0.7s | exit_code=0; files_mined=185 |
| PHASE_7_PORTAL | ran | 1.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.3s | deck_cards=54; kb_entries=3532; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786421713 |
