...
**Run ID**: eat_all_1786519234
**Finished**: 2026-08-12T07:20:34.086877+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=5069 |
...
| PHASE_5_HONEY | ran | 4.3s | exit_code=0; events=2993 |
| PHASE_6_DOWNLOADS | ran | 0.5s | exit_code=0; files_mined=224 |
| PHASE_7_PORTAL | ran | 1.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.1s | deck_cards=54; kb_entries=5069; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786519223 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5076 → 5076 entries (+0 new, dedup by normalized question)
