...
**Run ID**: eat_all_1786711807
**Finished**: 2026-08-14T12:50:07.745693+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=9081 |
...
| PHASE_9_ARTIFACTS | ran | 0.6s | deck_cards=55; kb_entries=9081; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.3s | clans_routed=0; swarm_id=owem-clans-1786711803 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 9088 → 9088 entries (+0 new, dedup by normalized question)
