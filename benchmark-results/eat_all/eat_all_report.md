...
**Run ID**: eat_all_1786418130
**Finished**: 2026-08-11T03:15:30.097931+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.2s | sov_local_status=unreachable: HTTP Error 404: Not Found; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=3444 |
...
| PHASE_5_HONEY | ran | 3.0s | exit_code=0; events=2313 |
| PHASE_6_DOWNLOADS | failed | 7.5s | (no error message) |
| PHASE_7_PORTAL | ran | 0.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.4s | deck_cards=54; kb_entries=3444; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.3s | clans_routed=0; swarm_id=owem-clans-1786418122 |
