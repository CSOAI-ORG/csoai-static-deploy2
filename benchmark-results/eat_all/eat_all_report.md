...
**Run ID**: eat_all_1786695051
**Finished**: 2026-08-14T08:10:51.496179+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=8648 |
| PHASE_1_REBOARD | ran | 6.7s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 1.7s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 9.4s | exit_code=0; events=4436 |
| PHASE_6_DOWNLOADS | ran | 2.9s | exit_code=0; files_mined=273 |
| PHASE_7_PORTAL | ran | 4.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.3s | deck_cards=55; kb_entries=8648; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.5s | clans_routed=0; swarm_id=owem-clans-1786695041 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 2.0s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 2.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 9 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8655 → 8657 entries (+2 new, dedup by normalized question)
