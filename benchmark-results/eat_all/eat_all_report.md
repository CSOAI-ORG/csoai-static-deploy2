...
**Run ID**: eat_all_1786607417
**Finished**: 2026-08-13T07:50:17.005645+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7345 |
...
| PHASE_6_DOWNLOADS | ran | 1.9s | exit_code=0; files_mined=265 |
| PHASE_7_PORTAL | ran | 0.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.5s | deck_cards=55; kb_entries=7345; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786607407 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7352 → 7352 entries (+0 new, dedup by normalized question)
