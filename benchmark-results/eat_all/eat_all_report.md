...
**Run ID**: eat_all_1786536620
**Finished**: 2026-08-12T12:10:20.643441+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5535 |
| PHASE_1_REBOARD | ran | 2.1s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 1.3s | exit_code=0; events=3173 |
| PHASE_6_DOWNLOADS | ran | 1.7s | exit_code=0; files_mined=233 |
| PHASE_7_PORTAL | ran | 2.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.6s | deck_cards=55; kb_entries=5535; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786536612 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5542 → 5543 entries (+1 new, dedup by normalized question)
