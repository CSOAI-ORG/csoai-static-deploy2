...
**Run ID**: eat_all_1786697747
**Finished**: 2026-08-14T08:55:47.857653+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8722 |
...
| PHASE_5_HONEY | ran | 0.7s | exit_code=0; events=4476 |
| PHASE_6_DOWNLOADS | failed | 6.0s | (no error message) |
| PHASE_7_PORTAL | ran | 3.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 4.4s | deck_cards=55; kb_entries=8722; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.6s | clans_routed=0; swarm_id=owem-clans-1786697719 |
| PHASE_9C_OWEM_CLUSTER | ran | 1.1s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 1.4s | benchmarks_routed=0 |
...
| PHASE_9G_AUDIENCE_HARNESS | ran | 2.3s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 7.4s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 7.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 9 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8729 → 8729 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 8729 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 2.6s | iwm_records=0; kb_entries_added=0; exit_code=0 |
| PHASE_10B_MODEL_ROUTING | ran | 1.6s | models_routed=0; specs_routed=1 |
