...
**Run ID**: eat_all_1786762519
**Finished**: 2026-08-15T02:55:19.208377+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=9241 |
...
| PHASE_5_HONEY | ran | 1.7s | exit_code=0; events=4856 |
| PHASE_6_DOWNLOADS | ran | 1.8s | exit_code=0; files_mined=298 |
| PHASE_7_PORTAL | ran | 0.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.6s | deck_cards=55; kb_entries=9241; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786762514 |
