...
**Run ID**: eat_all_1786415408
**Finished**: 2026-08-11T02:30:08.417695+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=3372 |
...
| PHASE_5_HONEY | ran | 0.2s | exit_code=0; events=2273 |
| PHASE_6_DOWNLOADS | failed | 5.1s | (no error message) |
| PHASE_7_PORTAL | ran | 0.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.1s | deck_cards=54; kb_entries=3372; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786415407 |
