...
**Run ID**: eat_all_1786705653
**Finished**: 2026-08-14T11:07:33.586069+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 5.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8913 |
| PHASE_1_REBOARD | ran | 5.4s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 13.3s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 20.8s | exit_code=0; events=4556 |
| PHASE_6_DOWNLOADS | ran | 15.1s | exit_code=0; files_mined=286 |
| PHASE_7_PORTAL | ran | 6.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 5.7s | deck_cards=55; kb_entries=8913; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.2s | clans_routed=0; swarm_id=owem-clans-1786705578 |
| PHASE_9C_OWEM_CLUSTER | ran | 2.6s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 6.1s | benchmarks_routed=0 |
...
| PHASE_9G_AUDIENCE_HARNESS | ran | 6.3s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 15.1s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 28.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 9 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8920 → 8920 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 8920 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 5.7s | iwm_records=0; kb_entries_added=0; exit_code=0 |
