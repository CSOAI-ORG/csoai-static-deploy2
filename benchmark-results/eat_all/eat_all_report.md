...
**Run ID**: eat_all_1786609256
**Finished**: 2026-08-13T08:20:56.048846+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7385 |
| PHASE_1_REBOARD | ran | 3.0s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 8.2s | exit_code=0; events=3936 |
| PHASE_6_DOWNLOADS | ran | 2.9s | exit_code=0; files_mined=266 |
| PHASE_7_PORTAL | ran | 4.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.9s | deck_cards=55; kb_entries=7385; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786609234 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 7.6s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 7.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7392 → 7392 entries (+0 new, dedup by normalized question)
