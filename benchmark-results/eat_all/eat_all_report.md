...
**Run ID**: eat_all_1786422316
**Finished**: 2026-08-11T04:25:16.361694+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=3548 |
...
| PHASE_5_HONEY | ran | 1.6s | exit_code=0; events=2353 |
| PHASE_6_DOWNLOADS | ran | 1.4s | exit_code=0; files_mined=188 |
| PHASE_7_PORTAL | ran | 1.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.6s | deck_cards=54; kb_entries=3548; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786422312 |
