...
**Run ID**: eat_all_1786607722
**Finished**: 2026-08-13T07:55:22.178027+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7353 |
...
| PHASE_5_HONEY | ran | 0.8s | exit_code=0; events=3916 |
| PHASE_6_DOWNLOADS | ran | 4.6s | exit_code=0; files_mined=265 |
| PHASE_7_PORTAL | ran | 0.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.9s | deck_cards=55; kb_entries=7353; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.0s | clans_routed=0; swarm_id=owem-clans-1786607710 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7360 → 7360 entries (+0 new, dedup by normalized question)
