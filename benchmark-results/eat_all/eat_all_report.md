...
**Run ID**: eat_all_1786564210
**Finished**: 2026-08-12T19:50:10.518119+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6192 |
...
| PHASE_5_HONEY | ran | 0.3s | exit_code=0; events=3416 |
| PHASE_6_DOWNLOADS | failed | 5.6s | (no error message) |
| PHASE_7_PORTAL | ran | 0.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.4s | deck_cards=55; kb_entries=6192; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786564208 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 6199 → 6199 entries (+0 new, dedup by normalized question)
