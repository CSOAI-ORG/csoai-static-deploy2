...
**Run ID**: eat_all_1786591860
**Finished**: 2026-08-13T03:31:00.357455+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6929 |
...
| PHASE_6_DOWNLOADS | failed | 6.6s | (no error message) |
| PHASE_7_PORTAL | ran | 2.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.4s | deck_cards=55; kb_entries=6929; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786591839 |
...
| PHASE_9I_SOV_CAPTURE | ran | 13.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 6936 → 6936 entries (+0 new, dedup by normalized question)
