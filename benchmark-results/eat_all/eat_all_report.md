...
**Run ID**: eat_all_1786596648
**Finished**: 2026-08-13T04:50:48.356685+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 8.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7057 |
| PHASE_1_REBOARD | ran | 6.4s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 8.6s | exit_code=0; events=3816 |
| PHASE_6_DOWNLOADS | ran | 2.9s | exit_code=0; files_mined=250 |
| PHASE_7_PORTAL | ran | 2.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=55; kb_entries=7057; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.3s | clans_routed=0; swarm_id=owem-clans-1786596636 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7064 → 7064 entries (+0 new, dedup by normalized question)
