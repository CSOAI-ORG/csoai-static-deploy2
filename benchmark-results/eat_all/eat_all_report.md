...
**Run ID**: eat_all_1786551307
**Finished**: 2026-08-12T16:15:07.517773+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5840 |
| PHASE_1_REBOARD | ran | 15.5s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 10.8s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 10.0s | exit_code=0; events=3276 |
| PHASE_6_DOWNLOADS | ran | 4.7s | exit_code=0; files_mined=240 |
| PHASE_7_PORTAL | ran | 4.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.4s | deck_cards=55; kb_entries=5840; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.9s | clans_routed=0; swarm_id=owem-clans-1786551285 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 3.7s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 6.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 6 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5847 → 5847 entries (+0 new, dedup by normalized question)
