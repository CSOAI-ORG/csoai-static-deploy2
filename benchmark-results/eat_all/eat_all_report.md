...
**Run ID**: eat_all_1786522212
**Finished**: 2026-08-12T08:10:12.167653+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5149 |
...
| PHASE_9_ARTIFACTS | ran | 0.5s | deck_cards=54; kb_entries=5149; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.5s | clans_routed=0; swarm_id=owem-clans-1786522207 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5156 → 5156 entries (+0 new, dedup by normalized question)
