...
**Run ID**: eat_all_1786707374
**Finished**: 2026-08-14T11:36:14.179929+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8961 |
| PHASE_1_REBOARD | ran | 3.1s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 6.0s | exit_code=0; events=4576 |
| PHASE_6_DOWNLOADS | ran | 7.1s | exit_code=0; files_mined=288 |
| PHASE_7_PORTAL | ran | 3.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 4.7s | deck_cards=55; kb_entries=8961; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.9s | clans_routed=0; swarm_id=owem-clans-1786707337 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 27.8s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 2.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8968 → 8968 entries (+0 new, dedup by normalized question)
