...
**Run ID**: eat_all_1786647323
**Finished**: 2026-08-13T18:55:23.368511+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8106 |
...
| PHASE_5_HONEY | ran | 0.9s | exit_code=0; events=4216 |
| PHASE_6_DOWNLOADS | failed | 5.4s | (no error message) |
| PHASE_7_PORTAL | ran | 1.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=55; kb_entries=8106; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786647312 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8113 → 8113 entries (+0 new, dedup by normalized question)
