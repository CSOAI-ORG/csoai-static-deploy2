...
**Run ID**: eat_all_1786511455
**Finished**: 2026-08-12T05:10:55.548815+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4868 |
| PHASE_1_REBOARD | ran | 12.2s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 15.0s | exit_code=0; events=2913 |
| PHASE_6_DOWNLOADS | ran | 10.6s | exit_code=0; files_mined=220 |
| PHASE_7_PORTAL | ran | 4.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=54; kb_entries=4868; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786511450 |
