...
**Run ID**: eat_all_1786697423
**Finished**: 2026-08-14T08:50:23.564526+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8714 |
...
| PHASE_5_HONEY | ran | 0.9s | exit_code=0; events=4476 |
| PHASE_6_DOWNLOADS | failed | 5.7s | (no error message) |
| PHASE_7_PORTAL | ran | 1.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.0s | deck_cards=55; kb_entries=8714; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.0s | clans_routed=0; swarm_id=owem-clans-1786697415 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8721 → 8721 entries (+0 new, dedup by normalized question)
