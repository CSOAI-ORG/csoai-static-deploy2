...
**Run ID**: eat_all_1786270355
**Finished**: 2026-08-09T10:12:35.389608+00:00
**Phase summary**: {'ran': 21, 'failed': 1, 'skipped': 0}

## Phases

| Phase | Status | Duration | Notes |
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.2s | souls=0; ollama_models=2; kb_entries=635 |
...
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786270354 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 642 → 642 entries (+0 new, dedup by normalized question)
...
| PHASE_10_REPORT | ran | 0.0s |  |
| PHASE_11_GIT_PUSH | failed | 13.0s | csoai-static-deploy2: -kv-refactor': is at 5785e6bd9874c4405a9197234f183abd7cd0b78a but expected a5b |
