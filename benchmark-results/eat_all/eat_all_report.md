...
**Run ID**: eat_all_1786553181
**Finished**: 2026-08-12T16:46:21.441949+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 7.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5896 |
| PHASE_1_REBOARD | ran | 17.1s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 11.2s | exit_code=0; events=3296 |
| PHASE_6_DOWNLOADS | ran | 7.0s | exit_code=0; files_mined=240 |
| PHASE_7_PORTAL | ran | 3.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.1s | deck_cards=55; kb_entries=5896; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.4s | clans_routed=0; swarm_id=owem-clans-1786553165 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 2.8s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 5.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 6 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5903 → 5903 entries (+0 new, dedup by normalized question)
