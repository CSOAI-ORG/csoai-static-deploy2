...
**Run ID**: eat_all_1786534891
**Finished**: 2026-08-12T11:41:31.297884+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5486 |
| PHASE_1_REBOARD | ran | 8.4s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 15.6s | exit_code=0; events=3153 |
| PHASE_6_DOWNLOADS | failed | 11.3s | (no error message) |
| PHASE_7_PORTAL | ran | 7.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.9s | deck_cards=55; kb_entries=5486; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.9s | clans_routed=0; swarm_id=owem-clans-1786534859 |
...
| PHASE_9I_SOV_CAPTURE | ran | 16.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 3 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5493 → 5493 entries (+0 new, dedup by normalized question)
