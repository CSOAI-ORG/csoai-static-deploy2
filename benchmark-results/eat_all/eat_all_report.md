...
**Run ID**: eat_all_1786603815
**Finished**: 2026-08-13T06:50:15.441387+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7249 |
...
| PHASE_5_HONEY | ran | 1.9s | exit_code=0; events=3876 |
| PHASE_6_DOWNLOADS | ran | 2.1s | exit_code=0; files_mined=261 |
| PHASE_7_PORTAL | ran | 2.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.5s | deck_cards=55; kb_entries=7249; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.3s | clans_routed=0; swarm_id=owem-clans-1786603810 |
| PHASE_9C_OWEM_CLUSTER | ran | 0.2s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 0.2s | benchmarks_routed=0 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 0.7s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 1.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7256 → 7256 entries (+0 new, dedup by normalized question)
