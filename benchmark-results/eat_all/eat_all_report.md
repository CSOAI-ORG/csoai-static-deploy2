...
**Run ID**: eat_all_1786643133
**Finished**: 2026-08-13T17:45:33.983144+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8002 |
...
| PHASE_5_HONEY | ran | 1.6s | exit_code=0; events=4176 |
| PHASE_6_DOWNLOADS | ran | 1.3s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 1.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.8s | deck_cards=55; kb_entries=8002; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.3s | clans_routed=0; swarm_id=owem-clans-1786643114 |
...
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 1.2s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 1.6s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 5.9s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 5.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8009 → 8009 entries (+0 new, dedup by normalized question)
