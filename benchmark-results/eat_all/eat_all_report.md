...
**Run ID**: eat_all_1786617930
**Finished**: 2026-08-13T10:45:30.004649+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7604 |
...
| PHASE_5_HONEY | ran | 1.1s | exit_code=0; events=4016 |
| PHASE_6_DOWNLOADS | ran | 1.1s | exit_code=0; files_mined=266 |
| PHASE_7_PORTAL | ran | 1.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.4s | deck_cards=55; kb_entries=7604; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786617909 |
...
| PHASE_9G_AUDIENCE_HARNESS | ran | 1.3s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 3.9s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 6.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 5 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7611 → 7611 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7611 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 2.9s | iwm_records=0; kb_entries_added=0; exit_code=0 |
