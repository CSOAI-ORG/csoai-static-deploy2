...
**Run ID**: eat_all_1786540232
**Finished**: 2026-08-12T13:10:32.698890+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5632 |
...
| PHASE_5_HONEY | ran | 1.4s | exit_code=0; events=3213 |
| PHASE_6_DOWNLOADS | ran | 6.0s | exit_code=0; files_mined=233 |
| PHASE_7_PORTAL | ran | 2.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=55; kb_entries=5632; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786540215 |
...
| PHASE_9I_SOV_CAPTURE | ran | 7.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5639 → 5639 entries (+0 new, dedup by normalized question)
