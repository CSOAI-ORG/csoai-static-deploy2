...
**Run ID**: eat_all_1786597247
**Finished**: 2026-08-13T05:00:47.889692+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7073 |
...
| PHASE_5_HONEY | ran | 2.0s | exit_code=0; events=3816 |
| PHASE_6_DOWNLOADS | ran | 3.9s | exit_code=0; files_mined=251 |
| PHASE_7_PORTAL | ran | 3.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.6s | deck_cards=55; kb_entries=7073; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.9s | clans_routed=0; swarm_id=owem-clans-1786597220 |
...
| PHASE_9I_SOV_CAPTURE | ran | 13.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7080 → 7080 entries (+0 new, dedup by normalized question)
