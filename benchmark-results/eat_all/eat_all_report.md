...
**Run ID**: eat_all_1786589122
**Finished**: 2026-08-13T02:45:22.409542+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6856 |
...
| PHASE_5_HONEY | ran | 2.3s | exit_code=0; events=3716 |
| PHASE_6_DOWNLOADS | ran | 1.2s | exit_code=0; files_mined=240 |
| PHASE_7_PORTAL | ran | 2.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.8s | deck_cards=55; kb_entries=6856; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786589114 |
| PHASE_9C_OWEM_CLUSTER | ran | 0.5s | clusters_routed=0 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 2.6s | kb_entries_added=7; exit_code=0 |
