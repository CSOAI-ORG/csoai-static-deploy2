...
**Run ID**: eat_all_1786601707
**Finished**: 2026-08-13T06:15:07.691837+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7193 |
...
| PHASE_6_DOWNLOADS | ran | 0.2s | exit_code=0; files_mined=260 |
| PHASE_7_PORTAL | ran | 0.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.4s | deck_cards=55; kb_entries=7193; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786601704 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7200 → 7200 entries (+0 new, dedup by normalized question)
