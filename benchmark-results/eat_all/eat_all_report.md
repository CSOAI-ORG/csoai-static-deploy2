...
**Run ID**: eat_all_1786698011
**Finished**: 2026-08-14T09:00:11.340145+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8730 |
...
| PHASE_5_HONEY | ran | 0.6s | exit_code=0; events=4476 |
| PHASE_6_DOWNLOADS | ran | 1.7s | exit_code=0; files_mined=276 |
| PHASE_7_PORTAL | ran | 0.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.8s | deck_cards=55; kb_entries=8730; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786698006 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8737 → 8737 entries (+0 new, dedup by normalized question)
