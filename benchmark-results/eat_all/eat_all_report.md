...
**Run ID**: eat_all_1786602015
**Finished**: 2026-08-13T06:20:15.468760+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7201 |
...
| PHASE_9_ARTIFACTS | ran | 0.4s | deck_cards=55; kb_entries=7201; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786602010 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7208 → 7208 entries (+0 new, dedup by normalized question)
