...
**Run ID**: eat_all_1786626913
**Finished**: 2026-08-13T13:15:13.657910+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7782 |
...
| PHASE_5_HONEY | ran | 1.2s | exit_code=0; events=4076 |
| PHASE_6_DOWNLOADS | ran | 0.6s | exit_code=0; files_mined=268 |
| PHASE_7_PORTAL | ran | 1.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.9s | deck_cards=55; kb_entries=7782; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786626908 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7789 → 7789 entries (+0 new, dedup by normalized question)
