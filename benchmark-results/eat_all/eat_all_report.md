...
**Run ID**: eat_all_1786532719
**Finished**: 2026-08-12T11:05:19.645805+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5430 |
...
| PHASE_9_ARTIFACTS | ran | 0.8s | deck_cards=55; kb_entries=5430; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.9s | clans_routed=0; swarm_id=owem-clans-1786532714 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5437 → 5437 entries (+0 new, dedup by normalized question)
