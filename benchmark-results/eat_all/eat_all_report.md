...
**Run ID**: eat_all_1786542655
**Finished**: 2026-08-12T13:50:55.534054+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 5.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5687 |
...
| PHASE_5_HONEY | ran | 2.1s | exit_code=0; events=3236 |
| PHASE_6_DOWNLOADS | ran | 2.9s | exit_code=0; files_mined=237 |
| PHASE_7_PORTAL | ran | 3.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.0s | deck_cards=55; kb_entries=5688; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786542634 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 4.6s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 8.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 6 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5695 → 5695 entries (+0 new, dedup by normalized question)
