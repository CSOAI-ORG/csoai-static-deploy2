...
**Run ID**: eat_all_1786620549
**Finished**: 2026-08-13T11:29:09.714242+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 9.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7664 |
| PHASE_1_REBOARD | ran | 5.9s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 7.6s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 80.3s | exit_code=0; events=4036 |
| PHASE_6_DOWNLOADS | ran | 169.6s | exit_code=0; files_mined=267 |
| PHASE_7_PORTAL | skipped | 72.1s |  |
| PHASE_9_ARTIFACTS | ran | 71.3s | deck_cards=55; kb_entries=7664; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 28.0s | clans_routed=0; swarm_id=owem-clans-1786620473 |
| PHASE_9C_OWEM_CLUSTER | ran | 3.0s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 3.3s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 5.3s | data_sources_routed=0 |
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 5.9s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 9.2s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 14.9s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 26.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7671 → 7671 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7671 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 5.2s | iwm_records=0; kb_entries_added=0; exit_code=0 |
