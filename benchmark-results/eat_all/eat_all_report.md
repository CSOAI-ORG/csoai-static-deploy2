...
**Run ID**: eat_all_1786596330
**Finished**: 2026-08-13T04:45:30.965624+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7049 |
...
| PHASE_5_HONEY | ran | 1.0s | exit_code=0; events=3796 |
| PHASE_6_DOWNLOADS | ran | 0.5s | exit_code=0; files_mined=250 |
| PHASE_7_PORTAL | ran | 1.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.9s | deck_cards=55; kb_entries=7049; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 6.2s | clans_routed=0; swarm_id=owem-clans-1786596314 |
| PHASE_9C_OWEM_CLUSTER | ran | 4.7s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 0.8s | benchmarks_routed=0 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.9s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7056 → 7056 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7056 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 0.9s | iwm_records=0; kb_entries_added=0; exit_code=0 |
