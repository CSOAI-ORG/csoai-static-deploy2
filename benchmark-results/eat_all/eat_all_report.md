...
**Run ID**: eat_all_1786647624
**Finished**: 2026-08-13T19:00:24.227334+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8114 |
...
| PHASE_5_HONEY | ran | 1.8s | exit_code=0; events=4216 |
| PHASE_6_DOWNLOADS | ran | 3.1s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 1.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.8s | deck_cards=55; kb_entries=8114; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786647613 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8121 → 8121 entries (+0 new, dedup by normalized question)
