...
**Run ID**: eat_all_1786726541
**Finished**: 2026-08-14T16:55:41.201047+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | failed | 9.7s | JSONDecodeError: Extra data: line 298535 column 2 (char 12816009) |
...
| PHASE_5_HONEY | ran | 11.8s | exit_code=0; events=4696 |
| PHASE_6_DOWNLOADS | ran | 1.1s | exit_code=0; files_mined=290 |
| PHASE_7_PORTAL | ran | 4.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.5s | deck_cards=0 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.8s | events_processed=0; skills_extracted=0 |
