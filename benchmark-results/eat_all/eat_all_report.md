...
**Run ID**: eat_all_1786589745
**Finished**: 2026-08-13T02:55:45.324722+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=6872 |
...
| PHASE_5_HONEY | ran | 2.5s | exit_code=0; events=3716 |
| PHASE_6_DOWNLOADS | ran | 4.9s | exit_code=0; files_mined=243 |
| PHASE_7_PORTAL | ran | 6.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.8s | deck_cards=55; kb_entries=6872; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.0s | clans_routed=0; swarm_id=owem-clans-1786589732 |
