...
**Run ID**: eat_all_1786196465
**Finished**: 2026-08-08T13:41:05.731825+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=3; kb_entries=10337 |
| PHASE_1_REBOARD | ran | 17.9s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 1.3s | exit_code=0; events=85 |
| PHASE_6_DOWNLOADS | ran | 4.9s | exit_code=0; files_mined=158 |
| PHASE_7_PORTAL | ran | 2.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.3s |  |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786196437 |
...
| PHASE_9I_SOV_CAPTURE | failed | 16.4s | Command '['python3', '/Users/nicholas/clawd/csoai-static-deploy2/sov_capture.py', '--status']' timed |
| PHASE_9J_IWM_BOOTSTRAP | ran | 4.5s | iwm_records=0; kb_entries_added=0; exit_code=0 |
