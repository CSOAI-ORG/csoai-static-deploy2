...
**Run ID**: eat_all_1786706752
**Finished**: 2026-08-14T11:25:52.532387+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8945 |
...
| PHASE_5_HONEY | ran | 2.9s | exit_code=0; events=4576 |
| PHASE_6_DOWNLOADS | ran | 4.6s | exit_code=0; files_mined=288 |
| PHASE_7_PORTAL | ran | 2.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.7s | deck_cards=55; kb_entries=8945; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.4s | clans_routed=0; swarm_id=owem-clans-1786706724 |
...
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 1.3s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 2.3s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 6.6s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 8.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8952 → 8952 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 8952 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 3.5s | iwm_records=0; kb_entries_added=0; exit_code=0 |
| PHASE_10B_MODEL_ROUTING | ran | 1.4s | models_routed=0; specs_routed=1 |
