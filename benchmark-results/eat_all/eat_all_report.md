...
**Run ID**: eat_all_1786594214
**Finished**: 2026-08-13T04:10:14.363184+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6993 |
...
| PHASE_5_HONEY | ran | 0.5s | exit_code=0; events=3776 |
| PHASE_6_DOWNLOADS | ran | 4.4s | exit_code=0; files_mined=249 |
| PHASE_7_PORTAL | ran | 0.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.1s | deck_cards=55; kb_entries=6993; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786594209 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7000 → 7000 entries (+0 new, dedup by normalized question)
