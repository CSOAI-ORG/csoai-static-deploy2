...
**Run ID**: eat_all_1786597527
**Finished**: 2026-08-13T05:05:27.691006+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7081 |
...
| PHASE_5_HONEY | ran | 0.7s | exit_code=0; events=3816 |
| PHASE_6_DOWNLOADS | ran | 3.2s | exit_code=0; files_mined=251 |
| PHASE_7_PORTAL | ran | 1.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.4s | deck_cards=55; kb_entries=7081; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786597510 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.9s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7088 → 7088 entries (+0 new, dedup by normalized question)
