...
**Run ID**: eat_all_1786511127
**Finished**: 2026-08-12T05:05:27.569125+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4860 |
...
| PHASE_5_HONEY | ran | 1.5s | exit_code=0; events=2913 |
| PHASE_6_DOWNLOADS | ran | 6.7s | exit_code=0; files_mined=220 |
| PHASE_7_PORTAL | ran | 2.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.0s | deck_cards=54; kb_entries=4860; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786511117 |
