...
**Run ID**: eat_all_1786531229
**Finished**: 2026-08-12T10:40:29.133231+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 5.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5389 |
...
| PHASE_5_HONEY | ran | 1.0s | exit_code=0; events=3133 |
| PHASE_6_DOWNLOADS | ran | 1.0s | exit_code=0; files_mined=228 |
| PHASE_7_PORTAL | ran | 0.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.6s | deck_cards=54; kb_entries=5389; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.3s | clans_routed=0; swarm_id=owem-clans-1786531223 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5396 → 5396 entries (+0 new, dedup by normalized question)
