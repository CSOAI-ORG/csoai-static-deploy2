...
**Run ID**: eat_all_1786544678
**Finished**: 2026-08-12T14:24:38.380166+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 86.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=5736 |
| PHASE_1_REBOARD | ran | 59.7s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 32.4s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 14.4s | exit_code=0; events=3256 |
| PHASE_6_DOWNLOADS | failed | 6.3s | (no error message) |
| PHASE_7_PORTAL | ran | 3.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.6s | deck_cards=55; kb_entries=5736; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786544671 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5743 → 5743 entries (+0 new, dedup by normalized question)
