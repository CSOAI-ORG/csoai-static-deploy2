...
**Run ID**: eat_all_1786338920
**Finished**: 2026-08-10T05:15:20.319391+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=1347 |
...
| PHASE_5_HONEY | ran | 1.4s | exit_code=0; events=1413 |
| PHASE_6_DOWNLOADS | ran | 1.4s | exit_code=0; files_mined=169 |
| PHASE_7_PORTAL | ran | 1.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.5s | deck_cards=54; kb_entries=1347; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786338916 |
