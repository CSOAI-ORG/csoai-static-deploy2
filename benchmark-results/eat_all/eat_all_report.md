...
**Run ID**: eat_all_1786521042
**Finished**: 2026-08-12T07:50:42.209253+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5117 |
...
| PHASE_5_HONEY | ran | 1.0s | exit_code=0; events=3013 |
| PHASE_6_DOWNLOADS | ran | 8.9s | exit_code=0; files_mined=225 |
| PHASE_7_PORTAL | ran | 2.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.1s | deck_cards=54; kb_entries=5117; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786521026 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5124 → 5124 entries (+0 new, dedup by normalized question)
