...
**Run ID**: eat_all_1786509933
**Finished**: 2026-08-12T04:45:33.834691+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4828 |
...
| PHASE_5_HONEY | ran | 1.5s | exit_code=0; events=2893 |
| PHASE_6_DOWNLOADS | ran | 6.4s | exit_code=0; files_mined=220 |
| PHASE_7_PORTAL | ran | 9.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.0s | deck_cards=54; kb_entries=4828; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.7s | clans_routed=0; swarm_id=owem-clans-1786509926 |
