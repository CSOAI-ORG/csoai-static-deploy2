...
**Run ID**: eat_all_1786267503
**Finished**: 2026-08-09T09:25:03.088603+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.1s | souls=0; ollama_models=2; kb_entries=538 |
...
| PHASE_5_HONEY | ran | 0.2s | exit_code=0; events=1132 |
| PHASE_6_DOWNLOADS | ran | 0.1s | exit_code=0; files_mined=163 |
| PHASE_7_PORTAL | ran | 0.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.1s | deck_cards=54 |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786267502 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 545 → 545 entries (+0 new, dedup by normalized question)
