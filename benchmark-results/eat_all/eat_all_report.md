...
**Run ID**: eat_all_1786688712
**Finished**: 2026-08-14T06:25:12.038634+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8496 |
...
| PHASE_9_ARTIFACTS | ran | 1.0s | deck_cards=55; kb_entries=8496; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786688706 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.9s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8503 → 8503 entries (+0 new, dedup by normalized question)
