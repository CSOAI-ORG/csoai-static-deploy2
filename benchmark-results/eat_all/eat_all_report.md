...
**Run ID**: eat_all_1786600864
**Finished**: 2026-08-13T06:01:04.780911+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7169 |
...
| PHASE_5_HONEY | ran | 2.9s | exit_code=0; events=3856 |
| PHASE_6_DOWNLOADS | ran | 3.2s | exit_code=0; files_mined=255 |
| PHASE_7_PORTAL | ran | 8.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 5.6s | deck_cards=55; kb_entries=7169; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.1s | clans_routed=0; swarm_id=owem-clans-1786600836 |
| PHASE_9C_OWEM_CLUSTER | ran | 1.0s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 7.1s | benchmarks_routed=0 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 1.3s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 10.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7176 → 7176 entries (+0 new, dedup by normalized question)
