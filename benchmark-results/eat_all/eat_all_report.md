...
**Run ID**: eat_all_1786196246
**Finished**: 2026-08-08T13:37:26.317897+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=3; kb_entries=5204 |
...
| PHASE_5_HONEY | ran | 0.4s | exit_code=0; events=67 |
| PHASE_6_DOWNLOADS | ran | 0.4s | exit_code=0; files_mined=158 |
| PHASE_7_PORTAL | ran | 0.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.0s |  |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786196234 |
...
| PHASE_9I_SOV_CAPTURE | ran | 9.9s | events_processed=256; skills_extracted=1; refine_output=KB Refinery — processing today's capture events...
  terminal: 5124 events
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5211 → 10335 entries (+5124 new)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 10336 entries total
 |
