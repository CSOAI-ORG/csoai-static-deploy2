...
**Run ID**: eat_all_1786639247
**Finished**: 2026-08-13T16:40:47.302189+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7914 |
...
| PHASE_5_HONEY | ran | 3.9s | exit_code=0; events=4156 |
| PHASE_6_DOWNLOADS | ran | 2.0s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 3.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.7s | deck_cards=55; kb_entries=7914; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.7s | clans_routed=0; swarm_id=owem-clans-1786639225 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 8.5s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 4.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7921 → 7921 entries (+0 new, dedup by normalized question)
