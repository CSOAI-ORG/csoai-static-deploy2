...
**Run ID**: eat_all_1786624253
**Finished**: 2026-08-13T12:30:53.141335+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7767 |
...
| PHASE_5_HONEY | ran | 1.5s | exit_code=0; events=4076 |
| PHASE_6_DOWNLOADS | failed | 5.9s | (no error message) |
| PHASE_7_PORTAL | ran | 2.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.6s | deck_cards=55; kb_entries=7774; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786624238 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7781 → 7781 entries (+0 new, dedup by normalized question)
