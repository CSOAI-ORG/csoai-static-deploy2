...
**Run ID**: eat_all_1786602654
**Finished**: 2026-08-13T06:30:54.151453+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7217 |
...
| PHASE_5_HONEY | ran | 1.8s | exit_code=0; events=3876 |
| PHASE_6_DOWNLOADS | ran | 8.7s | exit_code=0; files_mined=261 |
| PHASE_7_PORTAL | ran | 2.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.7s | deck_cards=55; kb_entries=7217; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.9s | clans_routed=0; swarm_id=owem-clans-1786602624 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 12.2s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 8.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 1 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7224 → 7224 entries (+0 new, dedup by normalized question)
