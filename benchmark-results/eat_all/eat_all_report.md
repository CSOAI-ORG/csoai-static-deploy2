...
**Run ID**: eat_all_1786593321
**Finished**: 2026-08-13T03:55:21.620879+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6969 |
...
| PHASE_5_HONEY | ran | 0.7s | exit_code=0; events=3776 |
| PHASE_6_DOWNLOADS | ran | 1.7s | exit_code=0; files_mined=246 |
| PHASE_7_PORTAL | ran | 1.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.3s | deck_cards=55; kb_entries=6969; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786593310 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 6976 → 6976 entries (+0 new, dedup by normalized question)
