...
**Run ID**: eat_all_1786763207
**Finished**: 2026-08-15T03:06:47.055606+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 7.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=9265 |
| PHASE_1_REBOARD | ran | 4.2s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 6.5s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 19.0s | exit_code=0; events=4856 |
| PHASE_6_DOWNLOADS | ran | 8.4s | exit_code=0; files_mined=298 |
| PHASE_7_PORTAL | ran | 2.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.1s | deck_cards=55; kb_entries=9265; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 3.0s | clans_routed=0; swarm_id=owem-clans-1786763169 |
| PHASE_9C_OWEM_CLUSTER | ran | 3.9s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 4.0s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 2.7s | data_sources_routed=0 |
