...
**Run ID**: eat_all_1786527343
**Finished**: 2026-08-12T09:35:43.659351+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 5.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5285 |
...
| PHASE_5_HONEY | ran | 2.5s | exit_code=0; events=3073 |
| PHASE_6_DOWNLOADS | failed | 6.3s | (no error message) |
| PHASE_7_PORTAL | ran | 1.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.8s | deck_cards=54; kb_entries=5285; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786527335 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5292 → 5292 entries (+0 new, dedup by normalized question)
