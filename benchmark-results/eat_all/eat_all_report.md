...
**Run ID**: eat_all_1786415756
**Finished**: 2026-08-11T02:35:56.943073+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.5s | sov_local_status=unreachable: [Errno 54] Connection reset by peer; ollama_models=2; kb_entries=3380 |
...
| PHASE_5_HONEY | ran | 1.2s | exit_code=0; events=2293 |
| PHASE_6_DOWNLOADS | ran | 41.0s | exit_code=0; files_mined=182 |
| PHASE_7_PORTAL | ran | 3.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.3s | deck_cards=54; kb_entries=3380; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786415753 |
