...
**Run ID**: eat_all_1786533320
**Finished**: 2026-08-12T11:15:20.813510+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5446 |
...
| PHASE_5_HONEY | ran | 1.0s | exit_code=0; events=3153 |
| PHASE_6_DOWNLOADS | failed | 6.3s | (no error message) |
| PHASE_7_PORTAL | ran | 0.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.4s | deck_cards=55; kb_entries=5446; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786533315 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5453 → 5453 entries (+0 new, dedup by normalized question)
