...
**Run ID**: eat_all_1786572909
**Finished**: 2026-08-12T22:15:09.585477+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6424 |
...
| PHASE_9_ARTIFACTS | ran | 0.3s | deck_cards=55; kb_entries=6424; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786572907 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 6431 → 6431 entries (+0 new, dedup by normalized question)
