...
**Run ID**: eat_all_1786624242
**Finished**: 2026-08-13T12:30:42.087528+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 116.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7767 |
...
| PHASE_5_HONEY | ran | 32.2s | exit_code=0; events=4076 |
| PHASE_6_DOWNLOADS | failed | 37.5s | (no error message) |
| PHASE_7_PORTAL | ran | 9.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.9s | deck_cards=55; kb_entries=7767; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786624227 |
...
| PHASE_9I_SOV_CAPTURE | ran | 5.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7774 → 7774 entries (+0 new, dedup by normalized question)
