...
**Run ID**: eat_all_1786453224
**Finished**: 2026-08-11T13:00:24.168935+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: HTTP Error 404: Not Found; ollama_models=2; kb_entries=4364 |
...
| PHASE_5_HONEY | ran | 1.3s | exit_code=0; events=2713 |
| PHASE_6_DOWNLOADS | failed | 8.3s | (no error message) |
| PHASE_7_PORTAL | ran | 7.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.1s | deck_cards=54; kb_entries=4364; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786453220 |
