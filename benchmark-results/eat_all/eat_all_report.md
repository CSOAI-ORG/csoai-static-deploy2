...
**Run ID**: eat_all_1786642365
**Finished**: 2026-08-13T17:32:45.232685+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 43.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7969 |
| PHASE_1_REBOARD | ran | 3.2s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 6.1s | exit_code=0; events=4176 |
| PHASE_6_DOWNLOADS | failed | 7.8s | (no error message) |
| PHASE_7_PORTAL | ran | 6.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 12.7s | deck_cards=55; kb_entries=7977; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 3.2s | clans_routed=0; swarm_id=owem-clans-1786642313 |
| PHASE_9C_OWEM_CLUSTER | ran | 3.3s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 3.5s | benchmarks_routed=0 |
...
| PHASE_9G_AUDIENCE_HARNESS | ran | 3.9s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 14.3s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 16.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7985 → 7985 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7985 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 2.2s | iwm_records=0; kb_entries_added=0; exit_code=0 |
| PHASE_10B_MODEL_ROUTING | ran | 2.8s | models_routed=0; specs_routed=1 |
