...
**Run ID**: eat_all_1786593033
**Finished**: 2026-08-13T03:50:33.890344+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6961 |
...
| PHASE_5_HONEY | ran | 3.9s | exit_code=0; events=3776 |
| PHASE_6_DOWNLOADS | ran | 2.9s | exit_code=0; files_mined=246 |
| PHASE_7_PORTAL | ran | 1.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.1s | deck_cards=55; kb_entries=6961; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.0s | clans_routed=0; swarm_id=owem-clans-1786593020 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 6968 → 6968 entries (+0 new, dedup by normalized question)
