...
**Run ID**: eat_all_1786715740
**Finished**: 2026-08-14T13:55:40.800189+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=9185 |
...
| PHASE_5_HONEY | ran | 1.4s | exit_code=0; events=4656 |
| PHASE_6_DOWNLOADS | failed | 6.5s | (no error message) |
| PHASE_7_PORTAL | ran | 2.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.2s | deck_cards=55; kb_entries=9185; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786715715 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 9.1s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 6.9s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 9192 → 9192 entries (+0 new, dedup by normalized question)
