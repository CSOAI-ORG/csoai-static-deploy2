...
**Run ID**: eat_all_1786677344
**Finished**: 2026-08-14T03:15:44.245579+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8194 |
...
| PHASE_5_HONEY | ran | 0.4s | exit_code=0; events=4256 |
| PHASE_6_DOWNLOADS | ran | 2.7s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 2.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.5s | deck_cards=55; kb_entries=8194; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 3.5s | clans_routed=0; swarm_id=owem-clans-1786677323 |
...
| PHASE_9G_AUDIENCE_HARNESS | ran | 2.6s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 8.8s | kb_entries_added=7; exit_code=0 |
