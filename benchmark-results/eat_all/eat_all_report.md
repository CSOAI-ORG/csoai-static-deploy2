...
**Run ID**: eat_all_1786510219
**Finished**: 2026-08-12T04:50:19.144822+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4836 |
...
| PHASE_5_HONEY | ran | 1.2s | exit_code=0; events=2913 |
| PHASE_6_DOWNLOADS | ran | 4.1s | exit_code=0; files_mined=220 |
| PHASE_7_PORTAL | ran | 3.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.4s | deck_cards=54; kb_entries=4836; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786510215 |
