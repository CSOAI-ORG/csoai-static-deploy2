...
**Run ID**: eat_all_1786680019
**Finished**: 2026-08-14T04:00:19.544604+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8267 |
...
| PHASE_5_HONEY | ran | 1.1s | exit_code=0; events=4296 |
| PHASE_6_DOWNLOADS | ran | 0.2s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 0.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=55; kb_entries=8267; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786680013 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8274 → 8274 entries (+0 new, dedup by normalized question)
