...
**Run ID**: eat_all_1786590025
**Finished**: 2026-08-13T03:00:25.461051+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=6880 |
...
| PHASE_5_HONEY | ran | 1.1s | exit_code=0; events=3716 |
| PHASE_6_DOWNLOADS | ran | 1.2s | exit_code=0; files_mined=243 |
| PHASE_7_PORTAL | ran | 2.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.5s | deck_cards=55; kb_entries=6880; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786590020 |
