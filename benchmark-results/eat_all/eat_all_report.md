...
**Run ID**: eat_all_1786681836
**Finished**: 2026-08-14T04:30:36.388991+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8317 |
...
| PHASE_5_HONEY | ran | 0.7s | exit_code=0; events=4316 |
| PHASE_6_DOWNLOADS | ran | 2.8s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 6.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.3s | deck_cards=55; kb_entries=8317; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786681818 |
...
| PHASE_9I_SOV_CAPTURE | ran | 6.9s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8324 → 8324 entries (+0 new, dedup by normalized question)
