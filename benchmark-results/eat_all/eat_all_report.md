...
**Run ID**: eat_all_1786707070
**Finished**: 2026-08-14T11:31:10.382150+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 14.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8953 |
| PHASE_1_REBOARD | ran | 15.5s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 7.4s | exit_code=0; events=4576 |
| PHASE_6_DOWNLOADS | ran | 5.8s | exit_code=0; files_mined=288 |
| PHASE_7_PORTAL | ran | 2.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.6s | deck_cards=55; kb_entries=8953; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.4s | clans_routed=0; swarm_id=owem-clans-1786707060 |
| PHASE_9C_OWEM_CLUSTER | ran | 1.2s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 1.2s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 0.5s | data_sources_routed=0 |
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 0.6s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 0.6s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 2.5s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 2.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 9 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8960 → 8960 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 8960 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 0.8s | iwm_records=0; kb_entries_added=0; exit_code=0 |
