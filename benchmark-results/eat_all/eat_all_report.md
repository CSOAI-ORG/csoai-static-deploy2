...
**Run ID**: eat_all_1786529128
**Finished**: 2026-08-12T10:05:28.723282+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 5.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5333 |
...
| PHASE_5_HONEY | ran | 0.9s | exit_code=0; events=3093 |
| PHASE_6_DOWNLOADS | failed | 5.7s | (no error message) |
| PHASE_7_PORTAL | ran | 3.4s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.0s | deck_cards=54; kb_entries=5333; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.9s | clans_routed=0; swarm_id=owem-clans-1786529124 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5340 → 5340 entries (+0 new, dedup by normalized question)
