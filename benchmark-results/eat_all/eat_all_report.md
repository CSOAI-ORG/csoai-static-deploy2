...
**Run ID**: eat_all_1786728628
**Finished**: 2026-08-14T17:30:28.496771+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | failed | 2.8s | JSONDecodeError: Extra data: line 298535 column 2 (char 12816009) |
| PHASE_1_REBOARD | ran | 0.9s | exit_code=0 |
| PHASE_2_KB_GROW | failed | 1.2s | ts-to-kb.py", line 196, in main
...
| PHASE_5_HONEY | ran | 1.6s | exit_code=0; events=4716 |
| PHASE_6_DOWNLOADS | ran | 2.8s | exit_code=0; files_mined=296 |
| PHASE_7_PORTAL | ran | 4.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.2s | deck_cards=0 |
...
| PHASE_9D_BENCHMARKS_HARNESS | failed | 0.7s | Extra data: line 298535 column 2 (char 12816009) |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.5s | events_processed=0; skills_extracted=0 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 2.1s | iwm_records=0; kb_entries_added=0; exit_code=1 |
