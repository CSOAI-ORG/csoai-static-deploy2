...
**Run ID**: eat_all_1786606843
**Finished**: 2026-08-13T07:40:43.579509+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7329 |
...
| PHASE_5_HONEY | ran | 1.6s | exit_code=0; events=3916 |
| PHASE_6_DOWNLOADS | failed | 5.8s | (no error message) |
| PHASE_7_PORTAL | ran | 4.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.5s | deck_cards=55; kb_entries=7329; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.2s | clans_routed=0; swarm_id=owem-clans-1786606819 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7336 → 7336 entries (+0 new, dedup by normalized question)
