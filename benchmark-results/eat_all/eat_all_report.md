...
**Run ID**: eat_all_1786610418
**Finished**: 2026-08-13T08:40:18.549329+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7417 |
...
| PHASE_5_HONEY | ran | 0.5s | exit_code=0; events=3956 |
| PHASE_6_DOWNLOADS | ran | 0.5s | exit_code=0; files_mined=266 |
| PHASE_7_PORTAL | ran | 0.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.7s | deck_cards=55; kb_entries=7417; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786610405 |
...
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 3.3s | stages_routed=0 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 2 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7424 → 7425 entries (+1 new, dedup by normalized question)
