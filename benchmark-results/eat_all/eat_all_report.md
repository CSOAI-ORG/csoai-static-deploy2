...
**Run ID**: eat_all_1786677615
**Finished**: 2026-08-14T03:20:15.477120+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8202 |
...
| PHASE_5_HONEY | ran | 1.3s | exit_code=0; events=4256 |
| PHASE_6_DOWNLOADS | ran | 0.4s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 1.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.1s | deck_cards=55; kb_entries=8202; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786677610 |
