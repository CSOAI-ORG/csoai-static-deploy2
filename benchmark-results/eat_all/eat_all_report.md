...
**Run ID**: eat_all_1786530382
**Finished**: 2026-08-12T10:26:22.672914+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5365 |
...
| PHASE_5_HONEY | ran | 7.7s | exit_code=0; events=3113 |
| PHASE_6_DOWNLOADS | ran | 5.7s | exit_code=0; files_mined=228 |
| PHASE_7_PORTAL | ran | 8.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 5.3s | deck_cards=54; kb_entries=5365; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 4.3s | clans_routed=0; swarm_id=owem-clans-1786530341 |
| PHASE_9C_OWEM_CLUSTER | ran | 2.0s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 2.2s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 4.0s | data_sources_routed=0 |
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 2.5s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 1.2s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 21.8s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 4.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5372 → 5372 entries (+0 new, dedup by normalized question)
