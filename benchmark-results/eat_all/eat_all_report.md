...
**Run ID**: eat_all_1786215909
**Finished**: 2026-08-08T19:05:09.115234+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.1s | souls=91; ollama_models=4; kb_entries=1006 |
...
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786215908 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.4s | events_processed=256; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 0 events
  browser: 0 events
  files: 0 events
  chat: 0 events
