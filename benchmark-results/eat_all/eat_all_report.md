...
**Run ID**: eat_all_1786596952
**Finished**: 2026-08-13T04:55:52.605061+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 8.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7065 |
| PHASE_1_REBOARD | ran | 7.2s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 7.2s | exit_code=0; events=3816 |
| PHASE_6_DOWNLOADS | ran | 6.5s | exit_code=0; files_mined=251 |
| PHASE_7_PORTAL | ran | 6.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=55; kb_entries=7065; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.6s | clans_routed=0; swarm_id=owem-clans-1786596943 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 2.2s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 2.9s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 7072 → 7072 entries (+0 new, dedup by normalized question)
