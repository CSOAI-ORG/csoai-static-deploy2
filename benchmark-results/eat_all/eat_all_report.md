...
**Run ID**: eat_all_1786462813
**Finished**: 2026-08-11T15:40:13.038926+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4564 |
...
| PHASE_5_HONEY | ran | 0.6s | exit_code=0; events=2793 |
| PHASE_6_DOWNLOADS | ran | 3.7s | exit_code=0; files_mined=213 |
| PHASE_7_PORTAL | ran | 0.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.5s | deck_cards=54; kb_entries=4564; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786462808 |
