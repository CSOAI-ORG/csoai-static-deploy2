...
**Run ID**: eat_all_1786679750
**Finished**: 2026-08-14T03:55:50.540224+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8258 |
...
| PHASE_5_HONEY | ran | 3.5s | exit_code=0; events=4276 |
| PHASE_6_DOWNLOADS | ran | 1.7s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 2.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.8s | deck_cards=55; kb_entries=8258; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.1s | clans_routed=0; swarm_id=owem-clans-1786679735 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8265 → 8266 entries (+1 new, dedup by normalized question)
