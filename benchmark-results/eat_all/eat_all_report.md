...
**Run ID**: eat_all_1786363253
**Finished**: 2026-08-10T12:00:53.834533+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=1997 |
| PHASE_1_REBOARD | ran | 5.8s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 7.4s | exit_code=0; events=1693 |
| PHASE_6_DOWNLOADS | failed | 7.9s | (no error message) |
| PHASE_7_PORTAL | ran | 7.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.0s | deck_cards=54; kb_entries=1997; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.3s | clans_routed=0; swarm_id=owem-clans-1786363236 |
...
| PHASE_9I_SOV_CAPTURE | ran | 11.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 3 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 2004 → 2004 entries (+0 new, dedup by normalized question)
