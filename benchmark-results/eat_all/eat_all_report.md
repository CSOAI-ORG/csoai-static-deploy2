...
**Run ID**: eat_all_1786560930
**Finished**: 2026-08-12T18:55:30.740244+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6104 |
| PHASE_1_REBOARD | ran | 0.8s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 1.2s | exit_code=0; events=3376 |
| PHASE_6_DOWNLOADS | ran | 1.9s | exit_code=0; files_mined=240 |
| PHASE_7_PORTAL | ran | 3.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.7s | deck_cards=55; kb_entries=6104; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.3s | clans_routed=0; swarm_id=owem-clans-1786560913 |
| PHASE_9C_OWEM_CLUSTER | ran | 0.3s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 0.4s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 0.4s | data_sources_routed=0 |
...
| PHASE_9I_SOV_CAPTURE | ran | 7.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 6 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 6111 → 6111 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 6111 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 3.6s | iwm_records=0; kb_entries_added=0; exit_code=0 |
| PHASE_10B_MODEL_ROUTING | ran | 2.1s | models_routed=0; specs_routed=1 |
