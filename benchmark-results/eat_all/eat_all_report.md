...
**Run ID**: eat_all_1786627882
**Finished**: 2026-08-13T13:31:22.529853+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7806 |
| PHASE_1_REBOARD | ran | 1.2s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 1.1s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 5.0s | exit_code=0; events=4096 |
| PHASE_6_DOWNLOADS | ran | 3.3s | exit_code=0; files_mined=270 |
| PHASE_7_PORTAL | ran | 4.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 5.4s | deck_cards=55; kb_entries=7806; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.0s | clans_routed=0; swarm_id=owem-clans-1786627829 |
| PHASE_9C_OWEM_CLUSTER | ran | 0.9s | clusters_routed=0 |
...
| PHASE_9G_AUDIENCE_HARNESS | ran | 1.8s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 9.2s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 28.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7813 → 7813 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 7813 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 3.9s | iwm_records=0; kb_entries_added=0; exit_code=0 |
