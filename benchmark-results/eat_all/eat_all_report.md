...
**Run ID**: eat_all_1786707957
**Finished**: 2026-08-14T11:45:57.696405+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 7.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=8977 |
| PHASE_1_REBOARD | ran | 5.2s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 1.6s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 18.4s | exit_code=0; events=4576 |
| PHASE_6_DOWNLOADS | ran | 4.4s | exit_code=0; files_mined=288 |
| PHASE_7_PORTAL | ran | 1.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.9s | deck_cards=55; kb_entries=8977; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.0s | clans_routed=0; swarm_id=owem-clans-1786707948 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 1.8s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 3.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8984 → 8984 entries (+0 new, dedup by normalized question)
