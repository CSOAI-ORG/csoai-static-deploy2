...
**Run ID**: eat_all_1786524929
**Finished**: 2026-08-12T08:55:29.563960+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5221 |
...
| PHASE_5_HONEY | ran | 2.7s | exit_code=0; events=3053 |
| PHASE_6_DOWNLOADS | ran | 4.4s | exit_code=0; files_mined=226 |
| PHASE_7_PORTAL | ran | 2.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.4s | deck_cards=54; kb_entries=5221; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786524919 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5228 → 5228 entries (+0 new, dedup by normalized question)
