...
**Run ID**: eat_all_1786525838
**Finished**: 2026-08-12T09:10:38.795121+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 7.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=5245 |
...
| PHASE_5_HONEY | ran | 1.2s | exit_code=0; events=3073 |
| PHASE_6_DOWNLOADS | ran | 9.5s | exit_code=0; files_mined=226 |
| PHASE_7_PORTAL | ran | 2.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.8s | deck_cards=54; kb_entries=5245; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786525832 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5252 → 5252 entries (+0 new, dedup by normalized question)
