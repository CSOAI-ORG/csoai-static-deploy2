...
**Run ID**: eat_all_1786764007
**Finished**: 2026-08-15T03:20:07.601781+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=9273 |
...
| PHASE_5_HONEY | ran | 0.4s | exit_code=0; events=4856 |
| PHASE_6_DOWNLOADS | ran | 0.1s | exit_code=0; files_mined=298 |
| PHASE_7_PORTAL | ran | 0.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.4s | deck_cards=55; kb_entries=9273; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786764003 |
