...
**Run ID**: eat_all_1786508708
**Finished**: 2026-08-12T04:25:08.337321+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=4796 |
...
| PHASE_5_HONEY | ran | 0.3s | exit_code=0; events=2893 |
| PHASE_6_DOWNLOADS | ran | 3.6s | exit_code=0; files_mined=220 |
| PHASE_7_PORTAL | ran | 0.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.2s | deck_cards=54; kb_entries=4796; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786508706 |
