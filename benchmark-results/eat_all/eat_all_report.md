...
**Run ID**: eat_all_1786454771
**Finished**: 2026-08-11T13:26:11.044379+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.1s | sov_local_status=unreachable: HTTP Error 404: Not Found; ollama_models=2; kb_entries=4404 |
...
| PHASE_5_HONEY | ran | 3.7s | exit_code=0; events=2713 |
| PHASE_6_DOWNLOADS | failed | 8.4s | (no error message) |
| PHASE_7_PORTAL | ran | 6.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.1s | deck_cards=54; kb_entries=4404; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.4s | clans_routed=0; swarm_id=owem-clans-1786454728 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 12.5s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 16.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 0 events
  browser: 0 events
  files: 0 events
  chat: 0 events
...
; extract_output=GNN Spine — extracting patterns from capture events...
 ...
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 5.3s | iwm_records=0; kb_entries_added=0; exit_code=0 |
