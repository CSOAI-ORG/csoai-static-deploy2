...
**Run ID**: eat_all_1786696553
**Finished**: 2026-08-14T08:35:53.896993+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8690 |
...
| PHASE_5_HONEY | ran | 2.2s | exit_code=0; events=4456 |
| PHASE_6_DOWNLOADS | failed | 7.5s | (no error message) |
| PHASE_7_PORTAL | ran | 5.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 5.9s | deck_cards=55; kb_entries=8690; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.5s | clans_routed=0; swarm_id=owem-clans-1786696529 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 7.2s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 5.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 9 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8697 → 8697 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 8697 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 1.8s | iwm_records=0; kb_entries_added=0; exit_code=0 |
| PHASE_10B_MODEL_ROUTING | ran | 1.5s | models_routed=0; specs_routed=1 |
