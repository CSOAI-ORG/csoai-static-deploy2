...
**Run ID**: eat_all_1786347611
**Finished**: 2026-08-10T07:40:11.053551+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=1579 |
...
| PHASE_5_HONEY | ran | 0.5s | exit_code=0; events=1513 |
| PHASE_6_DOWNLOADS | failed | 6.2s | (no error message) |
| PHASE_7_PORTAL | ran | 1.0s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.2s | deck_cards=54; kb_entries=1579; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786347609 |
