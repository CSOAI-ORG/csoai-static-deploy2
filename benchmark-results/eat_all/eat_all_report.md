...
**Run ID**: eat_all_1786519563
**Finished**: 2026-08-12T07:26:03.015452+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 10.1s | sov_local_status=unreachable: timed out; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=5077 |
...
| PHASE_5_HONEY | ran | 9.8s | exit_code=0; events=3013 |
| PHASE_6_DOWNLOADS | ran | 10.2s | exit_code=0; files_mined=224 |
| PHASE_7_PORTAL | ran | 4.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=54; kb_entries=5077; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 4.9s | clans_routed=0; swarm_id=owem-clans-1786519550 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5084 → 5084 entries (+0 new, dedup by normalized question)
