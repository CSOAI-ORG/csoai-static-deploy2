...
**Run ID**: eat_all_1786517124
**Finished**: 2026-08-12T06:45:24.054233+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5021 |
...
| PHASE_5_HONEY | ran | 1.2s | exit_code=0; events=2973 |
| PHASE_6_DOWNLOADS | failed | 5.5s | (no error message) |
| PHASE_7_PORTAL | ran | 1.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.3s | deck_cards=54; kb_entries=5021; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786517115 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5028 → 5028 entries (+0 new, dedup by normalized question)
