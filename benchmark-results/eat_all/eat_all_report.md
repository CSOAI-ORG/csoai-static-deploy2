...
**Run ID**: eat_all_1786702524
**Finished**: 2026-08-14T10:15:24.735316+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8834 |
...
| PHASE_5_HONEY | ran | 1.1s | exit_code=0; events=4536 |
| PHASE_6_DOWNLOADS | ran | 4.0s | exit_code=0; files_mined=284 |
| PHASE_7_PORTAL | ran | 2.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.6s | deck_cards=55; kb_entries=8834; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.0s | clans_routed=0; swarm_id=owem-clans-1786702513 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.6s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8841 → 8841 entries (+0 new, dedup by normalized question)
