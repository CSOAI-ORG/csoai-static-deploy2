...
**Run ID**: eat_all_1786762366
**Finished**: 2026-08-15T02:52:46.402510+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=9233 |
...
| PHASE_5_HONEY | ran | 0.4s | exit_code=0; events=4836 |
| PHASE_6_DOWNLOADS | ran | 0.2s | exit_code=0; files_mined=298 |
| PHASE_7_PORTAL | ran | 0.4s | exit_code=0 |
| PHASE_8_DEPLOY | ran | 29.8s | deploy_exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.8s | deck_cards=55; kb_entries=9233; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.4s | clans_routed=0; swarm_id=owem-clans-1786762362 |
