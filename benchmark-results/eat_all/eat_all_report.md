...
**Run ID**: eat_all_1786332928
**Finished**: 2026-08-10T03:35:28.713153+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.5s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: [Errno 2] No such file or directory: 'ollama'; kb_entries=1187 |
...
| PHASE_5_HONEY | ran | 10.5s | exit_code=0; events=1353 |
| PHASE_6_DOWNLOADS | ran | 0.5s | exit_code=0; files_mined=168 |
| PHASE_7_PORTAL | ran | 2.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.7s | deck_cards=54; kb_entries=1187; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786332927 |
