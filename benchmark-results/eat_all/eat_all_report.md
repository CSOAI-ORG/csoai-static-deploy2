...
**Run ID**: eat_all_1786767017
**Finished**: 2026-08-15T04:10:17.971083+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.9s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=9353 |
...
| PHASE_6_DOWNLOADS | ran | 2.4s | exit_code=0; files_mined=299 |
| PHASE_7_PORTAL | ran | 0.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.9s | deck_cards=55; kb_entries=9353; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.9s | clans_routed=0; swarm_id=owem-clans-1786767008 |
