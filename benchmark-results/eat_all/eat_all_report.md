...
**Run ID**: eat_all_1786704969
**Finished**: 2026-08-14T10:56:09.932198+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 34.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=8890 |
| PHASE_1_REBOARD | ran | 26.0s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 26.6s | exit_code=0 |
| PHASE_3_PROBES | ran | 0.7s | chatml=1; bloodline=1 |
| PHASE_4_TRAINING | ran | 0.0s | training_scripts_available=['sov_groq_distill.py', 'sov_grpo_train.py', 'sov_minimal_train.py'] |
| PHASE_5_HONEY | ran | 51.7s | exit_code=0; events=4556 |
| PHASE_6_DOWNLOADS | failed | 104.4s | (no error message) |
| PHASE_7_PORTAL | ran | 12.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.8s | deck_cards=55; kb_entries=8890; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.8s | clans_routed=0; swarm_id=owem-clans-1786704946 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 4.8s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 9.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 9 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8897 → 8897 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 8897 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 2.0s | iwm_records=0; kb_entries_added=0; exit_code=0 |
| PHASE_10B_MODEL_ROUTING | ran | 1.0s | models_routed=0; specs_routed=1 |
