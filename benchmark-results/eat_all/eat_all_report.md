...
**Run ID**: eat_all_1786384235
**Finished**: 2026-08-10T17:50:35.430072+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.8s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=2540 |
...
| PHASE_5_HONEY | ran | 0.7s | exit_code=0; events=1913 |
| PHASE_6_DOWNLOADS | failed | 5.7s | (no error message) |
| PHASE_7_PORTAL | ran | 4.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.0s | deck_cards=54; kb_entries=2540; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.7s | clans_routed=0; swarm_id=owem-clans-1786384222 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 3.0s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 1.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 5 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 2547 → 2547 entries (+0 new, dedup by normalized question)
