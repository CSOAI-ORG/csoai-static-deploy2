...
**Run ID**: eat_all_1786767638
**Finished**: 2026-08-15T04:20:38.352053+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.6s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=9369 |
...
| PHASE_5_HONEY | ran | 0.7s | exit_code=0; events=4896 |
| PHASE_6_DOWNLOADS | failed | 6.3s | (no error message) |
| PHASE_7_PORTAL | ran | 2.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.0s | deck_cards=55; kb_entries=9369; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 5.2s | clans_routed=0; swarm_id=owem-clans-1786767618 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 5.4s | kb_entries_added=7; exit_code=0 |
