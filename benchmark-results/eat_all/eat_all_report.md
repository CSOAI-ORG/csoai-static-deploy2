...
**Run ID**: eat_all_1786706378
**Finished**: 2026-08-14T11:19:38.283099+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 5.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8929 |
| PHASE_1_REBOARD | ran | 19.9s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 77.8s | exit_code=0 |
| PHASE_3_PROBES | ran | 10.8s | chatml=1; bloodline=1 |
| PHASE_4_TRAINING | ran | 0.0s | training_scripts_available=['sov_groq_distill.py', 'sov_grpo_train.py', 'sov_minimal_train.py'] |
| PHASE_5_HONEY | ran | 82.9s | exit_code=0; events=4556 |
| PHASE_6_DOWNLOADS | ran | 11.1s | exit_code=0; files_mined=286 |
| PHASE_7_PORTAL | ran | 12.8s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 5.8s | deck_cards=55; kb_entries=8929; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.2s | clans_routed=0; swarm_id=owem-clans-1786706333 |
...
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 5.5s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 0.9s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 6.9s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 18.1s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8936 → 8936 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  KB updated: 8936 entries total
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 5.9s | iwm_records=0; kb_entries_added=0; exit_code=0 |
