...
**Run ID**: eat_all_1786632983
**Finished**: 2026-08-13T14:56:23.219773+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=7896 |
...
| PHASE_5_HONEY | ran | 2.2s | exit_code=0; events=4116 |
| PHASE_6_DOWNLOADS | ran | 330.9s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | skipped | 175.8s |  |
| PHASE_9_ARTIFACTS | ran | 36.6s | deck_cards=55; kb_entries=7896; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 3.2s | clans_routed=0; swarm_id=owem-clans-1786632939 |
...
| PHASE_9F_SOVEREIGN_TRAINING_PIPELINE | ran | 1.7s | stages_routed=0 |
| PHASE_9G_AUDIENCE_HARNESS | ran | 2.3s | audiences_routed=0 |
| PHASE_9H_SOV_HIVE_HARNESS | ran | 5.6s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 15.0s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
...
; extract_output=GNN Spine — extracting patterns from capture events...
 ...
 |
| PHASE_9J_IWM_BOOTSTRAP | ran | 6.8s | iwm_records=0; kb_entries_added=0; exit_code=0 |
