...
**Run ID**: eat_all_1786530933
**Finished**: 2026-08-12T10:35:33.499668+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 6.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=5381 |
...
| PHASE_5_HONEY | ran | 1.8s | exit_code=0; events=3113 |
| PHASE_6_DOWNLOADS | ran | 0.6s | exit_code=0; files_mined=228 |
| PHASE_7_PORTAL | ran | 2.3s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.3s | deck_cards=54; kb_entries=5381; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786530920 |
...
| PHASE_9I_SOV_CAPTURE | ran | 4.9s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5388 → 5388 entries (+0 new, dedup by normalized question)
