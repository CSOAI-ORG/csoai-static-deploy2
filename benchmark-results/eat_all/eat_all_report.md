...
**Run ID**: eat_all_1786536055
**Finished**: 2026-08-12T12:00:55.905864+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 5.0s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5518 |
| PHASE_1_REBOARD | ran | 4.9s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 4.0s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 4.8s | exit_code=0; events=3173 |
| PHASE_6_DOWNLOADS | failed | 8.2s | (no error message) |
| PHASE_7_PORTAL | ran | 3.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.6s | deck_cards=55; kb_entries=5518; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.9s | clans_routed=0; swarm_id=owem-clans-1786536038 |
...
| PHASE_9I_SOV_CAPTURE | ran | 5.3s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 3 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 5525 → 5525 entries (+0 new, dedup by normalized question)
