...
**Run ID**: eat_all_1786691722
**Finished**: 2026-08-14T07:15:22.658731+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8576 |
...
| PHASE_5_HONEY | ran | 0.8s | exit_code=0; events=4396 |
| PHASE_6_DOWNLOADS | failed | 5.2s | (no error message) |
| PHASE_7_PORTAL | ran | 1.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.5s | deck_cards=55; kb_entries=8576; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.9s | clans_routed=0; swarm_id=owem-clans-1786691715 |
...
| PHASE_9I_SOV_CAPTURE | ran | 2.7s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 8583 → 8583 entries (+0 new, dedup by normalized question)
