...
**Run ID**: eat_all_1786534230
**Finished**: 2026-08-12T11:30:30.939333+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 1.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=5470 |
...
| PHASE_5_HONEY | ran | 1.2s | exit_code=0; events=3153 |
| PHASE_6_DOWNLOADS | failed | 6.3s | (no error message) |
| PHASE_7_PORTAL | ran | 1.7s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 3.3s | deck_cards=55; kb_entries=5470; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.5s | clans_routed=0; swarm_id=owem-clans-1786534218 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5477 → 5477 entries (+0 new, dedup by normalized question)
