...
**Run ID**: eat_all_1786267203
**Finished**: 2026-08-09T09:20:03.151940+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.1s | souls=0; ollama_models=2; kb_entries=530 |
...
| PHASE_5_HONEY | ran | 0.2s | exit_code=0; events=1112 |
...
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786267202 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 537 → 537 entries (+0 new, dedup by normalized question)
