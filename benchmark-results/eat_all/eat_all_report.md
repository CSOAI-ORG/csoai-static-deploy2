...
**Run ID**: eat_all_1786254907
**Finished**: 2026-08-09T05:55:07.466861+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.1s | souls=0; ollama_models=4; kb_entries=185 |
...
| PHASE_5_HONEY | ran | 0.7s | exit_code=0; events=927 |
| PHASE_6_DOWNLOADS | ran | 5.2s | exit_code=1; files_mined=158 |
| PHASE_7_PORTAL | ran | 0.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.0s |  |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786254906 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 192 → 193 entries (+1 new, dedup by normalized question)
