...
**Run ID**: eat_all_1786427715
**Finished**: 2026-08-11T05:55:15.115349+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.3s | sov_local_status=unreachable: timed out; ollama_models=2; kb_entries=3692 |
...
| PHASE_5_HONEY | ran | 0.3s | exit_code=0; events=2393 |
| PHASE_6_DOWNLOADS | failed | 6.4s | (no error message) |
| PHASE_7_PORTAL | ran | 1.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.4s | deck_cards=54; kb_entries=3692; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786427712 |
