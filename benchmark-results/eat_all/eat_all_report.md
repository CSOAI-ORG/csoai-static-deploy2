...
**Run ID**: eat_all_1786629243
**Finished**: 2026-08-13T13:54:03.072185+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 26.4s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=7830 |
| PHASE_1_REBOARD | ran | 7.0s | exit_code=0 |
| PHASE_2_KB_GROW | ran | 11.7s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 80.8s | exit_code=0; events=4096 |
| PHASE_6_DOWNLOADS | ran | 23.3s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 10.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 24.1s | deck_cards=55; kb_entries=7831; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 2.9s | clans_routed=0; swarm_id=owem-clans-1786629211 |
| PHASE_9C_OWEM_CLUSTER | ran | 5.7s | clusters_routed=0 |
| PHASE_9D_BENCHMARKS_HARNESS | ran | 4.4s | benchmarks_routed=0 |
| PHASE_9E_TRAINING_DATA_HARNESS | ran | 7.9s | data_sources_routed=0 |
...
| PHASE_9I_SOV_CAPTURE | ran | 7.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 10 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 7838 → 7838 entries (+0 new, dedup by normalized question)
