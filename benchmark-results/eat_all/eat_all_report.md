...
**Run ID**: eat_all_1786425612
**Finished**: 2026-08-11T05:20:12.097774+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.8s | sov_local_status=unreachable: HTTP Error 404: Not Found; ollama_models=2; kb_entries=3636 |
...
| PHASE_5_HONEY | ran | 0.4s | exit_code=0; events=2373 |
| PHASE_6_DOWNLOADS | failed | 5.7s | (no error message) |
| PHASE_7_PORTAL | ran | 0.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.3s | deck_cards=54; kb_entries=3636; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1786425609 |
