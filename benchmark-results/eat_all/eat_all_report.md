...
**Run ID**: eat_all_1786452311
**Finished**: 2026-08-11T12:45:11.533379+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.3s | sov_local_status=unreachable: HTTP Error 404: Not Found; ollama_models=2; kb_entries=4340 |
...
| PHASE_5_HONEY | ran | 0.4s | exit_code=0; events=2693 |
| PHASE_6_DOWNLOADS | failed | 6.0s | (no error message) |
| PHASE_7_PORTAL | ran | 0.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.3s | deck_cards=54; kb_entries=4340; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.1s | clans_routed=0; swarm_id=owem-clans-1786452309 |
