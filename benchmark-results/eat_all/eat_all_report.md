...
**Run ID**: eat_all_1786541593
**Finished**: 2026-08-12T13:33:13.063976+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 30.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_status=unreachable: Command '['ollama', 'list']' timed out after 5 seconds; kb_entries=5663 |
| PHASE_1_REBOARD | ran | 18.5s | exit_code=0 |
...
| PHASE_5_HONEY | ran | 31.9s | exit_code=0; events=3213 |
| PHASE_6_DOWNLOADS | failed | 24.6s | (no error message) |
| PHASE_7_PORTAL | ran | 16.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 5.9s | deck_cards=55; kb_entries=5664; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 1.9s | clans_routed=0; swarm_id=owem-clans-1786541581 |
...
| PHASE_9I_SOV_CAPTURE | ran | 3.5s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 5671 → 5671 entries (+0 new, dedup by normalized question)
