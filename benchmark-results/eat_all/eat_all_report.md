...
**Run ID**: eat_all_1786677910
**Finished**: 2026-08-14T03:25:10.980791+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.1s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8210 |
...
| PHASE_5_HONEY | ran | 0.7s | exit_code=0; events=4276 |
| PHASE_6_DOWNLOADS | ran | 0.4s | exit_code=0; files_mined=271 |
| PHASE_7_PORTAL | ran | 0.6s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.6s | deck_cards=55; kb_entries=8210; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.5s | clans_routed=0; swarm_id=owem-clans-1786677906 |
