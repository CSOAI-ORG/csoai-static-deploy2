...
**Run ID**: eat_all_1786559726
**Finished**: 2026-08-12T18:35:26.253252+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 3.3s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=6072 |
...
| PHASE_5_HONEY | ran | 1.5s | exit_code=0; events=3356 |
| PHASE_6_DOWNLOADS | ran | 0.9s | exit_code=0; files_mined=240 |
| PHASE_7_PORTAL | ran | 1.2s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.2s | deck_cards=55; kb_entries=6072; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.7s | clans_routed=0; swarm_id=owem-clans-1786559718 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 1.4s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 1.4s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 6079 → 6079 entries (+0 new, dedup by normalized question)
