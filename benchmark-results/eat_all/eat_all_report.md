...
**Run ID**: eat_all_1786213446
**Finished**: 2026-08-08T18:24:06.537733+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.1s | souls=346; ollama_models=4; kb_entries=678 |
...
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.0s | clans_routed=0; swarm_id=owem-clans-1786213446 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.2s | events_processed=256; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 0 events
  browser: 0 events
  files: 0 events
  chat: 0 events
