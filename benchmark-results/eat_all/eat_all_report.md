...
**Run ID**: eat_all_1786694748
**Finished**: 2026-08-14T08:05:48.516195+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 2.2s | sov_local_status=unreachable: <urlopen error [Errno 61] Connection refused>; ollama_models=2; kb_entries=8640 |
...
| PHASE_5_HONEY | ran | 5.1s | exit_code=0; events=4436 |
| PHASE_6_DOWNLOADS | ran | 3.4s | exit_code=0; files_mined=273 |
| PHASE_7_PORTAL | ran | 1.9s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 1.8s | deck_cards=55; kb_entries=8640; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.8s | clans_routed=0; swarm_id=owem-clans-1786694725 |
...
| PHASE_9H_SOV_HIVE_HARNESS | ran | 12.6s | kb_entries_added=7; exit_code=0 |
| PHASE_9I_SOV_CAPTURE | ran | 4.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  terminal: 7 events (refine window 500)
  browser: 0 events
  files: 0 events
  chat: 0 events
  KB: 8647 → 8647 entries (+0 new, dedup by normalized question)
