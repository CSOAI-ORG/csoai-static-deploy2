...
language: [en]
tags: [ai-governance, eu-ai-act, benchmark, csoai, gspc, openness]
size_categories: [n<1K]
---

# OSSBench — licence vs intended use

**Axis: openness** — one of the six axes of the CSOAI GSPC instrument.
By [CSOAI](https://csoai.org), the Council for the Safety of AI (UK).

Given a licence and an intended use, is it PERMITTED or RESTRICTED?
...
Best single-answer strategy: **7/13 = 54%**. The item set is deliberately
...
```bibtex
@misc{csoai_openness_2026,
  title  = {OSSBench — licence vs intended use},
