...
language: [en]
tags: [ai-governance, eu-ai-act, benchmark, csoai, gspc, conformance]
size_categories: [n<1K]
---

# MCPBench — 3-predicate tool conformance

**Axis: conformance** — one of the six axes of the CSOAI GSPC instrument.
...
Best single-answer strategy: **6/11 = 55%**. The item set is deliberately
...
11 items. This is a focused instrument, not a complete conformity assessment, and it does
