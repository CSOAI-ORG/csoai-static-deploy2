...
export const metadata: Metadata = {
  title: 'Enterprise',
  description: 'Enterprise procurement, fleet management and multi-site KoiKeeper.ai deployment.',
  alternates: { canonical: `${vertical.domain}/enterprise` },
};
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="md:flex md:gap-12">
        <div className="md:w-1/2">
          ...
          <h1 className="text-4xl md:text-5xl font-bold">KoiKeeper for Enterprise</h1>
          <p className="mt-6 text-lg text-muted-foreground">
            Koi farms, estates and show venues maintain water quality across dozens of ponds with SLAs.
          </p>
        ...
        <div className="md:w-1/2 mt-10 md:mt-0">
          <div className="rounded-2xl border border-border bg-card p-8">
            ...
            <form
              action="mailto:hello@meok.ai?subject=KoiKeeper%20Enterprise%20demo%20request"
              method="post"
              encType="text/plain"
              className="space-y-5"
            >
      ...
      <section className="max-w-4xl mx-auto py-16 text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
          <a href="/signup" className="gradient-brand text-white px-8 py-3 rounded-xl font-bold text-lg hover:opacity-90 transition-opacity">Get enterprise pricing</a>
          <a href="/partner" className="border border-border text-foreground px-8 py-3 rounded-xl font-semibold hover:border-brand-500/30 transition-colors">View partner program</a>
        </div>
      </section>
    </div>
  );
