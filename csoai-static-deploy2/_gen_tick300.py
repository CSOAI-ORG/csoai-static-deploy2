#!/usr/bin/env python3
"""Tick 300 generator: 3 genuinely-uncovered UK public-body deep-dive packs.
Invest Northern Ireland / National Highways / UK Space Agency.
Probe-verified 0 disk + 0 sitemap BEFORE build (tick-265 pitfall).
Builder: _gen_tick300.py | Data: _gen_tick300_packs.py"""
import json, os, hashlib
from _gen_tick300_packs import PACKS
...
sigil = {"tick": TICK, "date": TODAY, "packs": [], "total_bytes": 0, "phase": 267}
