#!/usr/bin/env python3
"""Remote benchmark script for Oracle ARM — cycle 2"""
...
out = {"cycle": 2, "scores": results, "average": avg, "timestamp": time.strftime("%Y-%m-%dT%H:%M:%SZ", time.gmtime())}
Path("result_c2.json").write_text(json.dumps(out, indent=2))
