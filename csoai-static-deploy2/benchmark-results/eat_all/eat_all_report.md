...
**Run ID**: eat_all_1787505920
**Finished**: 2026-08-23T17:25:20.723851+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 4.0s | sov_local_status=unreachable: timed out; ollama_models=14; kb_entries=9136 |
...
| PHASE_5_HONEY | ran | 6.8s | exit_code=0; events=94181 |
| PHASE_6_DOWNLOADS | ran | 0.6s | exit_code=0; files_mined=469 |
| PHASE_7_PORTAL | ran | 2.5s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 0.7s | deck_cards=55; kb_entries=9136; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.2s | clans_routed=0; swarm_id=owem-clans-1787505916 |
...
| PHASE_9I_SOV_CAPTURE | ran | 1.2s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 9143 → 9143 entries (+0 new, dedup by normalized question)
