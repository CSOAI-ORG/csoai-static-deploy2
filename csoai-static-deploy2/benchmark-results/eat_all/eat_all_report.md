...
**Run ID**: eat_all_1787541845
**Finished**: 2026-08-24T03:24:05.740771+00:00
...
|---|---|---|---|
| PHASE_0_HEALTH | ran | 0.7s | souls=284; ollama_models=139; kb_entries=10136 |
...
| PHASE_5_HONEY | ran | 7.4s | exit_code=0; events=94181 |
| PHASE_6_DOWNLOADS | ran | 0.3s | exit_code=0; files_mined=475 |
| PHASE_7_PORTAL | ran | 1.1s | exit_code=0 |
| PHASE_9_ARTIFACTS | ran | 2.2s | deck_cards=55; kb_entries=10136; kb_ok=True |
| PHASE_9B_EXTERNAL_HARNESS | ran | 0.3s | clans_routed=0; swarm_id=owem-clans-1787541842 |
...
| PHASE_9I_SOV_CAPTURE | ran | 0.8s | events_processed=0; skills_extracted=0; refine_output=KB Refinery — processing today's capture events...
  ...
  files: 0 events
  chat: 0 events
  KB: 10143 → 10143 entries (+0 new, dedup by normalized question)
...
; extract_output=GNN Spine — extracting patterns from capture events...
  ...
  Skills file: /Users/nicholas/.sov/iwm/skills_20260824.jsonl
  KB updated: 10143 entries total
 |
