#!/usr/bin/env python3
"""Tick 299 generator: 3 genuinely-uncovered UK public-body deep-dive packs.
Screen Scotland / Sport England / Trade Remedies Authority.
Probe-verified 0 disk + 0 sitemap BEFORE build (tick-265 pitfall).
Builder: _gen_tick299.py | Data: _gen_tick299_packs.py"""
import json, os, hashlib
from _gen_tick299_packs import PACKS
