...
| "33 Witness Council" (meok.ai) vs 33 ratified seats / 3 live processes vs councilof.ai's signed-agent claim (published 19; registry holds 7) | meok.ai, councilof.ai | Three council numbers | Canonical precision ruling stands: **33 ratified seats, 3 live processes**. meok.ai "33 Witness Council" → "33 ratified seats". councilof.ai's signed-agent count → correct to 7 (largest registry export). The site's own retraction ledger sets the standard — extend it. |
