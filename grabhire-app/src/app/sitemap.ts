...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/signup`, lastModified, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${baseUrl}/connect/mcp`, lastModified, changeFrequency: 'weekly', priority: 0.7 },
    ...
    { url: `${baseUrl}/tools`, lastModified, changeFrequency: 'weekly', priority: 0.7 },
