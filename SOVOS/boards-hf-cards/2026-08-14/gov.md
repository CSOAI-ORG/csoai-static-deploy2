---
license: apache-2.0
tags: [ai-governance, gov, measurement, eu-ai-act, gspc]
task_categories: [text-classification]
language: [en]
---
# Governance / GovBench — GSPC board (measurement, not certification)

Control-anchored GSPC measurement of a model fleet. **Measurement, not certification.**

- **Item set (bank_items):** 237 (the quotable per-item count)
- **Models measured:** 19
- **Board status:** MEASURED
- **Best model:** embodiment-v3-light
- **Signed board sha256 (leading 12):** `78cf468757e6`
