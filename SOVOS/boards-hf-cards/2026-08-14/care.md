---
license: apache-2.0
tags: [ai-governance, care, measurement, eu-ai-act, gspc]
task_categories: [text-classification]
language: [en]
---
# Care / CareBench — GSPC board (measurement, not certification)

Control-anchored GSPC measurement of a model fleet. **Measurement, not certification.**

- **Item set (bank_items):** 200 (the quotable per-item count)
- **Models measured:** 19
- **Board status:** MEASURED
- **Best model:** ethics-v3-light
- **Signed board sha256 (leading 12):** `d7c87834b10f`
