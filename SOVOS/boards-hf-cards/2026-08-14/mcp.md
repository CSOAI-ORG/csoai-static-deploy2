---
license: apache-2.0
tags: [ai-governance, mcp, measurement, eu-ai-act, gspc]
task_categories: [text-classification]
language: [en]
---
# Conformance / MCPBench — GSPC board (measurement, not certification)

Control-anchored GSPC measurement of a model fleet. **Measurement, not certification.**

- **Item set (bank_items):** 35 (the quotable per-item count)
- **Models measured:** 19
- **Board status:** MEASURED
- **Best model:** preservation-v3-light
- **Signed board sha256 (leading 12):** `e58062c8eb14`
