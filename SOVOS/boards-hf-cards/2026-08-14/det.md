---
license: apache-2.0
tags: [ai-governance, det, measurement, eu-ai-act, gspc]
task_categories: [text-classification]
language: [en]
---
# Detector-interop / DetBench — GSPC board (measurement, not certification)

Control-anchored GSPC measurement of a model fleet. **Measurement, not certification.**

- **Item set (bank_items):** 33 (the quotable per-item count)
- **Models measured:** 19
- **Board status:** MEASURED
- **Best model:** deepseek-r1:8b
- **Signed board sha256 (leading 12):** `384b28480f21`
