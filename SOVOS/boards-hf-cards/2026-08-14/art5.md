---
license: apache-2.0
tags: [ai-governance, art5, measurement, eu-ai-act, gspc]
task_categories: [text-classification]
language: [en]
---
# Art-5 / Art5Bench — GSPC board (measurement, not certification)

Control-anchored GSPC measurement of a model fleet. **Measurement, not certification.**

- **Item set (bank_items):** 36 (the quotable per-item count)
- **Models measured:** 19
- **Board status:** MEASURED
- **Best model:** relationality-v3-light
- **Signed board sha256 (leading 12):** `e7ddd52dfdc8`
