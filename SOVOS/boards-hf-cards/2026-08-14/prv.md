---
license: apache-2.0
tags: [ai-governance, prv, measurement, eu-ai-act, gspc]
task_categories: [text-classification]
language: [en]
---
# Provenance / ProvBench — GSPC board (measurement, not certification)
...
- **Best model:** aesthetics-v3-light
- **Signed board sha256 (leading 12):** `fd51e907876d`
